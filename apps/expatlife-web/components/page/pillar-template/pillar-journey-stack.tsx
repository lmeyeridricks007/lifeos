 ...
 */
export function PillarJourneyStack({ className, children, variant = "hub" }: PillarJourneyStackProps) {
  const stackClass = cn("flex flex-col gap-8 sm:gap-9 md:gap-10", movingNlShellStagesEssentialsClass, className);
  if (variant === "guide") {
