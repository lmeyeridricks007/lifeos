...
const nextConfig = {
  ...
  /** Canonical URLs have no trailing slash (except `/`); matches Vercel 200 URLs. */
  trailingSlash: false,
  swcMinify: true,
  ...
  async redirects() {
    ...
    return [
      ...
      // Low-priority typo / legacy slug (SEO opportunities 7 Sep 2026) — was 404 noindex.
      {
        source: "/netherlands/living/survival-guide-netherlands",
        destination: "/netherlands/living/survival-guide",
        permanent: true,
      },
      {
      ...
      // EC-20260907-006: bare Integration hub → live inburgering guide (no empty stub hub).
      {
        source: "/netherlands/integration",
        destination: "/netherlands/integration/inburgering",
        permanent: true,
      },
      {
      ...
      // Placeholder tools → live assets (do not invent KNM quiz / timeline planner this week).
      {
        source: "/netherlands/integration/tools/knm-knowledge-quiz",
        destination: "/netherlands/integration/tools/inburgering-exam-readiness-checker",
        permanent: true,
      },
      {
        source: "/netherlands/integration/tools/knm-knowledge-quiz/",
      ...
      {
        source: "/netherlands/integration/tools/inburgering-timeline-planner",
        destination: "/netherlands/integration/tools/integration-requirement-checker",
        permanent: true,
      },
      {
        source: "/netherlands/integration/tools/inburgering-timeline-planner/",
