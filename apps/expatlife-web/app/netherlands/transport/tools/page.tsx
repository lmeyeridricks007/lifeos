...
export const metadata = getCategoryHubMetadata("transport");

export default function TransportToolsHubPage() {
  const { category, liveTools, comingSoonTools, relatedGuides } = getCategoryHubData("transport");
  const { collectionPage, breadcrumb } = getCategoryHubJsonLd("transport");
  return (
    <>
