...
import { WiseVsRevolutView } from "@/src/components/money/wise-vs-revolut/WiseVsRevolutView";
import { wiseVsRevolutPage as page } from "@/src/components/money/wise-vs-revolut/wiseVsRevolutPageModel";
...
export default function WiseVsRevolutPage() {
  return (
    <>
