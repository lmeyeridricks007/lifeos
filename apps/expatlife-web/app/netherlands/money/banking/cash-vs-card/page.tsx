...
import { CashVsCardView } from "@/src/components/money/cash-vs-card/CashVsCardView";
import { cashVsCardPage as page } from "@/src/components/money/cash-vs-card/cashVsCardPageModel";
...
export default function CashVsCardPage() {
  return (
    <>
