...
import { FinancialChecklistNetherlandsView } from "@/src/components/money/financial-checklist-netherlands/FinancialChecklistNetherlandsView";
import { financialChecklistNetherlandsPage as page } from "@/src/components/money/financial-checklist-netherlands/financialChecklistNetherlandsPageModel";
...
export default function FinancialChecklistNetherlandsPage() {
  return (
    <>
      ...
      />
      <FinancialChecklistNetherlandsView />
    </>
  );
}
