...
import { MonthlyBudgetNetherlandsView } from "@/src/components/money/monthly-budget-netherlands/MonthlyBudgetNetherlandsView";
import { monthlyBudgetNetherlandsPage as page } from "@/src/components/money/monthly-budget-netherlands/monthlyBudgetNetherlandsPageModel";
...
export default function MonthlyBudgetNetherlandsPage() {
  return (
    <>
