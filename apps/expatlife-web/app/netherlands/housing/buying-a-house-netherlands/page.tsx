...
import { BuyingHouseNetherlandsView } from "@/src/components/housing/BuyingHouseNetherlandsView";
import { buyingHouseNetherlandsPage as page } from "@/src/components/housing/buyingHouseNetherlandsPageModel";
...
export default function BuyingHouseNetherlandsPage() {
  return (
    <>
