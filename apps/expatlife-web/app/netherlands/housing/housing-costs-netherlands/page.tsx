...
import { HousingCostsNetherlandsView } from "@/src/components/housing/HousingCostsNetherlandsView";
import { housingCostsNetherlandsPage as page } from "@/src/components/housing/housingCostsNetherlandsPageModel";
...
export default function HousingCostsNetherlandsPage() {
  return (
    <>
