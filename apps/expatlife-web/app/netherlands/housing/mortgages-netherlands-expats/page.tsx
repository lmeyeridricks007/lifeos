...
import { MortgagesNetherlandsExpatsView } from "@/src/components/housing/MortgagesNetherlandsExpatsView";
import { mortgagesNetherlandsExpatsPage as page } from "@/src/components/housing/mortgagesNetherlandsExpatsPageModel";
...
export default function MortgagesNetherlandsExpatsPage() {
  return (
    <>
      ...
      <MortgagesNetherlandsExpatsView />
    </>
  );
}
