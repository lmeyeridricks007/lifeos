...
import { BuyVsRentNetherlandsView } from "@/src/components/housing/BuyVsRentNetherlandsView";
import { buyVsRentNetherlandsPage as page } from "@/src/components/housing/buyVsRentNetherlandsPageModel";
...
export default function BuyVsRentNetherlandsPage() {
  return (
    <>
