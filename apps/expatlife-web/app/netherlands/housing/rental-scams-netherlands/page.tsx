...
import { RentalScamsNetherlandsView } from "@/src/components/housing/RentalScamsNetherlandsView";
import { rentalScamsNetherlandsPage as page } from "@/src/components/housing/rentalScamsNetherlandsPageModel";
...
export default function RentalScamsNetherlandsPage() {
  return (
    <>
      ...
      <HowToJsonLd
        ...
        urlPath={`${path}#verify-landlord`}
      />
      <RentalScamsNetherlandsView />
    </>
  );
}
