...
import { BusinessConsultantsNetherlandsView } from "@/src/components/services/business-consultants/BusinessConsultantsNetherlandsView";
import { businessConsultantsNetherlandsPage as page } from "@/src/components/services/business-consultants/businessConsultantsNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Business consultants in the Netherlands for expats — strategy, setup and growth",
    description:
      "Structured directory of Dutch business consultants for strategy, market entry, KvK facilitation and operations consulting. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "Dutch business consultant / strategy / market entry / operations",
...
export default function BusinessConsultantsNetherlandsPage() {
  return (
    <>
