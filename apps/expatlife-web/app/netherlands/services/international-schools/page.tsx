...
import { InternationalSchoolsServicesView } from "@/src/components/services/international-schools/InternationalSchoolsServicesView";
import { internationalSchoolsServicesPage as page } from "@/src/components/services/international-schools/internationalSchoolsServicesPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "International schools in the Netherlands for expats — provider directory",
    description:
      "Structured directory of international school discovery patterns for fees orientation, curricula, admission and location. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "International school discovery / curriculum orientation",
...
export default function InternationalSchoolsServicesPage() {
  return (
    <>
      ...
      <InternationalSchoolsServicesView />
    </>
  );
}
