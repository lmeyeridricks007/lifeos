...
import { RemovalCompaniesNetherlandsView } from "@/src/components/services/removal-companies/RemovalCompaniesNetherlandsView";
import { removalCompaniesNetherlandsPage as page } from "@/src/components/services/removal-companies/removalCompaniesNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Removal companies in the Netherlands for expats — international household moves",
    description:
      "Structured directory of international household removal companies serving expats arriving in or leaving the Netherlands. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "International household removal",
...
export default function RemovalCompaniesNetherlandsPage() {
  return (
    <>
      ...
      <RemovalCompaniesNetherlandsView />
    </>
  );
}
