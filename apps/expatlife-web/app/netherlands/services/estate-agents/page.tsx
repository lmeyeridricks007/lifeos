...
import { EstateAgentsNetherlandsView } from "@/src/components/services/estate-agents/EstateAgentsNetherlandsView";
import { estateAgentsNetherlandsPage as page } from "@/src/components/services/estate-agents/estateAgentsNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Estate agents (makelaars) in the Netherlands for expats — buy and sell support",
    description:
      "Structured directory of Dutch estate agents / makelaars for buying and selling property. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "Residential estate agency / makelaar",
...
export default function EstateAgentsNetherlandsPage() {
  return (
    <>
