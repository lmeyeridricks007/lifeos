...
import { NotariesNetherlandsView } from "@/src/components/services/notaries/NotariesNetherlandsView";
import { notariesNetherlandsPage as page } from "@/src/components/services/notaries/notariesNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Notaries (notaris) in the Netherlands for expats — deed and conveyancing support",
    description:
      "Structured directory of Dutch notaries for purchase deeds, mortgage deeds and related notarial orientation. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "Dutch civil-law notary / notaris",
...
export default function NotariesNetherlandsPage() {
  return (
    <>
