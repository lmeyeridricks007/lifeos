...
import { PetRelocationCompaniesNetherlandsView } from "@/src/components/services/pet-relocation-companies/PetRelocationCompaniesNetherlandsView";
import { petRelocationCompaniesNetherlandsPage as page } from "@/src/components/services/pet-relocation-companies/petRelocationCompaniesNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Pet relocation companies in the Netherlands for expats — import, export and flight-pet logistics",
    description:
      "Structured directory of specialist pet relocation companies serving expats arriving in or leaving the Netherlands with companion animals. Informational soft discovery — not a ranking.",
    ...
    itemListElement: page.providers.map((provider, index) => ({
      ...
      item: {
        ...
        serviceType: "Pet relocation and flight-pet logistics",
...
export default function PetRelocationCompaniesNetherlandsPage() {
  return (
    <>
      ...
      <PetRelocationCompaniesNetherlandsView />
    </>
  );
}
