...
import { InsuranceProvidersNetherlandsView } from "@/src/components/services/insurance-providers/InsuranceProvidersNetherlandsView";
import { insuranceProvidersNetherlandsPage as page } from "@/src/components/services/insurance-providers/insuranceProvidersNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Insurance providers in the Netherlands for expats",
    description:
      "Neutral directory of real Dutch insurance providers offering health, liability, home, travel, business and expat-relevant insurance products.",
...
export default function InsuranceProvidersNetherlandsPage() {
  ...
  return (
    <>
      ...
      <InsuranceProvidersNetherlandsView />
    </>
  );
}
