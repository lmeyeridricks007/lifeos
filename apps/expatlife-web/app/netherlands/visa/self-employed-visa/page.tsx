...
export const metadata: Metadata = {
  ...
  description: String(SELF_EMPLOYED_VISA.seo.description),
...
export default function SelfEmployedVisaPage() {
  ...
  return (
    <>
      ...
      <GuidePageTemplate
        ...
        planningInstructionalFigure={getVisasResidencyInstructionalFigure(SELF_EMPLOYED_VISA.slug)}
      />
    </>
  );
}
