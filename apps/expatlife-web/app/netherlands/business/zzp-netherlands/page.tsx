...
import { ZzpNetherlandsView } from "@/src/components/business/ZzpNetherlandsView";
import { zzpNetherlandsPage as page } from "@/src/components/business/zzpNetherlandsPageModel";
...
export default function ZzpNetherlandsPage() {
  return (
    <>
