...
import { StartingBusinessNetherlandsView } from "@/src/components/business/StartingBusinessNetherlandsView";
import { startingBusinessNetherlandsPage as page } from "@/src/components/business/startingBusinessNetherlandsPageModel";
...
export default function StartingBusinessNetherlandsPage() {
  return (
    <>
      ...
      <StartingBusinessNetherlandsView />
    </>
  );
}
