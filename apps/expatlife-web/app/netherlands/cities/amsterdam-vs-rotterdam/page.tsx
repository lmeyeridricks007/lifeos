...
import { AmsterdamVsRotterdamView } from "@/src/components/cities/amsterdam-vs-rotterdam/AmsterdamVsRotterdamView";
import { amsterdamVsRotterdamPage as page } from "@/src/components/cities/amsterdam-vs-rotterdam/amsterdamVsRotterdamPageModel";
...
export default function AmsterdamVsRotterdamPage() {
  return (
    <>
