...
import { DutchHumourView } from "@/src/components/life/DutchHumourView";
import { dutchHumourPage as page } from "@/src/components/life/dutchHumourPageModel";
...
export default function DutchHumourPage() {
  return (
    <>
