...
import { DutchEtiquetteView } from "@/src/components/life/DutchEtiquetteView";
import { dutchEtiquettePage as page } from "@/src/components/life/dutchEtiquettePageModel";
...
export default function DutchEtiquettePage() {
  return (
    <>
