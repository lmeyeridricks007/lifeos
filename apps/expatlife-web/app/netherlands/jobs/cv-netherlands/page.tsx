...
import { CvNetherlandsView } from "@/src/components/jobs/CvNetherlandsView";
import { cvNetherlandsPage as page } from "@/src/components/jobs/cvNetherlandsPageModel";
...
export default function CvNetherlandsPage() {
  return (
    <>
