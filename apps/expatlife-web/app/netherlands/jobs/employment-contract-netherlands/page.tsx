...
import { employmentContractNetherlandsPage as page } from "@/src/components/jobs/employmentContractNetherlandsPageModel";
...
export default function EmploymentContractNetherlandsPage() {
  return (
    <>
      ...
      <EmploymentContractNetherlandsView />
    </>
  );
}
