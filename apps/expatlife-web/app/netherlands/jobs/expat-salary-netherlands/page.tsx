...
import { ExpatSalaryNetherlandsView } from "@/src/components/jobs/ExpatSalaryNetherlandsView";
import { expatSalaryNetherlandsPage as page } from "@/src/components/jobs/expatSalaryNetherlandsPageModel";
...
export default function ExpatSalaryNetherlandsPage() {
  return (
    <>
