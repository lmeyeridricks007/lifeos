...
import { CoverLetterNetherlandsView } from "@/src/components/jobs/CoverLetterNetherlandsView";
import { coverLetterNetherlandsPage as page } from "@/src/components/jobs/coverLetterNetherlandsPageModel";
...
export default function CoverLetterNetherlandsPage() {
  return (
    <>
