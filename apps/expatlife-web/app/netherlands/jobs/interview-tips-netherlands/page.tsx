...
import { InterviewTipsNetherlandsView } from "@/src/components/jobs/InterviewTipsNetherlandsView";
import { interviewTipsNetherlandsPage as page } from "@/src/components/jobs/interviewTipsNetherlandsPageModel";
...
export default function InterviewTipsNetherlandsPage() {
  return (
    <>
