...
import { RemoteWorkNetherlandsView } from "@/src/components/jobs/RemoteWorkNetherlandsView";
import { remoteWorkNetherlandsPage as page } from "@/src/components/jobs/remoteWorkNetherlandsPageModel";
...
export default function RemoteWorkNetherlandsPage() {
  return (
    <>
