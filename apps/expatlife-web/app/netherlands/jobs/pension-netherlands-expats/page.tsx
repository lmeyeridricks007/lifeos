...
import { PensionNetherlandsExpatsView } from "@/src/components/jobs/PensionNetherlandsExpatsView";
import { pensionNetherlandsExpatsPage as page } from "@/src/components/jobs/pensionNetherlandsExpatsPageModel";
...
export default function PensionNetherlandsExpatsPage() {
  return (
    <>
