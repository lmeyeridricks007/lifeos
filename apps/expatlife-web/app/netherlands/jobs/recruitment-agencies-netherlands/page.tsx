...
import { RecruitmentAgenciesNetherlandsView } from "@/src/components/jobs/RecruitmentAgenciesNetherlandsView";
import { recruitmentAgenciesNetherlandsPage as page } from "@/src/components/jobs/recruitmentAgenciesNetherlandsPageModel";
...
export default function RecruitmentAgenciesNetherlandsPage() {
  return (
    <>
