...
import { SalaryNegotiationNetherlandsView } from "@/src/components/jobs/SalaryNegotiationNetherlandsView";
import { salaryNegotiationNetherlandsPage as page } from "@/src/components/jobs/salaryNegotiationNetherlandsPageModel";
...
export default function SalaryNegotiationNetherlandsPage() {
  return (
    <>
      ...
      <SalaryNegotiationNetherlandsView />
    </>
  );
}
