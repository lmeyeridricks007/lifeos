...
import { EmployeeBenefitsNetherlandsView } from "@/src/components/jobs/EmployeeBenefitsNetherlandsView";
import { employeeBenefitsNetherlandsPage as page } from "@/src/components/jobs/employeeBenefitsNetherlandsPageModel";
...
export default function EmployeeBenefitsNetherlandsPage() {
  return (
    <>
      ...
      <EmployeeBenefitsNetherlandsView />
    </>
  );
}
