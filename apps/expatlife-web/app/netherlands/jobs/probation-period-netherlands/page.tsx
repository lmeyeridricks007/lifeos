...
import { ProbationPeriodNetherlandsView } from "@/src/components/jobs/ProbationPeriodNetherlandsView";
import { probationPeriodNetherlandsPage as page } from "@/src/components/jobs/probationPeriodNetherlandsPageModel";
...
export default function ProbationPeriodNetherlandsPage() {
  return (
    <>
      ...
      <ProbationPeriodNetherlandsView />
    </>
  );
}
