...
import { DutchDirectnessAtWorkView } from "@/src/components/jobs/DutchDirectnessAtWorkView";
import { dutchDirectnessAtWorkPage as page } from "@/src/components/jobs/dutchDirectnessAtWorkPageModel";
...
export default function DutchDirectnessAtWorkPage() {
  return (
    <>
