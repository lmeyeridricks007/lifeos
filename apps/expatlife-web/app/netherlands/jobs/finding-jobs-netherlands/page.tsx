...
import { FindingJobsNetherlandsView } from "@/src/components/jobs/FindingJobsNetherlandsView";
import { findingJobsNetherlandsPage as page } from "@/src/components/jobs/findingJobsNetherlandsPageModel";
...
export default function FindingJobsNetherlandsPage() {
  return (
    <>
