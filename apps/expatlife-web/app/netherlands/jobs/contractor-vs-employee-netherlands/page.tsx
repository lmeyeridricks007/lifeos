...
import { ContractorVsEmployeeNetherlandsView } from "@/src/components/jobs/ContractorVsEmployeeNetherlandsView";
import { contractorVsEmployeeNetherlandsPage as page } from "@/src/components/jobs/contractorVsEmployeeNetherlandsPageModel";
...
export default function ContractorVsEmployeeNetherlandsPage() {
  return (
    <>
      ...
      <ContractorVsEmployeeNetherlandsView />
    </>
  );
}
