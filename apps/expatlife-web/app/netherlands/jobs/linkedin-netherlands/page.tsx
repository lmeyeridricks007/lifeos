...
import { LinkedInNetherlandsView } from "@/src/components/jobs/LinkedInNetherlandsView";
import { linkedInNetherlandsPage as page } from "@/src/components/jobs/linkedinNetherlandsPageModel";
...
export default function LinkedInNetherlandsPage() {
  return (
    <>
