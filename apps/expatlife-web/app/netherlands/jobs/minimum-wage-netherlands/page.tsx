...
import { MinimumWageNetherlandsView } from "@/src/components/jobs/MinimumWageNetherlandsView";
import { minimumWageNetherlandsPage as page } from "@/src/components/jobs/minimumWageNetherlandsPageModel";
...
export default function MinimumWageNetherlandsPage() {
  return (
    <>
