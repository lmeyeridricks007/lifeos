...
import { DutchWorkplaceCultureView } from "@/src/components/jobs/DutchWorkplaceCultureView";
import { dutchWorkplaceCulturePage as page } from "@/src/components/jobs/dutchWorkplaceCulturePageModel";
...
export default function DutchWorkplaceCulturePage() {
  return (
    <>
