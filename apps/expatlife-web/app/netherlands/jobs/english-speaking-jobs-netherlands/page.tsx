...
import { EnglishSpeakingJobsNetherlandsView } from "@/src/components/jobs/EnglishSpeakingJobsNetherlandsView";
import { englishSpeakingJobsNetherlandsPage as page } from "@/src/components/jobs/englishSpeakingJobsNetherlandsPageModel";
...
export default function EnglishSpeakingJobsNetherlandsPage() {
  return (
    <>
      ...
      />
      <EnglishSpeakingJobsNetherlandsView />
    </>
  );
}
