...
import { NetworkingNetherlandsView } from "@/src/components/jobs/NetworkingNetherlandsView";
import { networkingNetherlandsPage as page } from "@/src/components/jobs/networkingNetherlandsPageModel";
...
export default function NetworkingNetherlandsPage() {
  return (
    <>
