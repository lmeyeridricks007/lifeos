...
import { HolidayAllowanceNetherlandsView } from "@/src/components/jobs/HolidayAllowanceNetherlandsView";
import { holidayAllowanceNetherlandsPage as page } from "@/src/components/jobs/holidayAllowanceNetherlandsPageModel";
...
export default function HolidayAllowanceNetherlandsPage() {
  return (
    <>
      ...
      <HolidayAllowanceNetherlandsView />
    </>
  );
}
