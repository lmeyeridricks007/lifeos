...
import { FreelancingNetherlandsView } from "@/src/components/jobs/FreelancingNetherlandsView";
import { freelancingNetherlandsPage as page } from "@/src/components/jobs/freelancingNetherlandsPageModel";
...
export default function FreelancingNetherlandsPage() {
  return (
    <>
