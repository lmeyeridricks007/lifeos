...
import { CheapGroceriesNetherlandsView } from "@/src/components/living/cheap-groceries/CheapGroceriesNetherlandsView";
import { cheapGroceriesNetherlandsPage as page } from "@/src/components/living/cheap-groceries/cheapGroceriesNetherlandsPageModel";
...
export default function CheapGroceriesNetherlandsPage() {
  return (
    <>
