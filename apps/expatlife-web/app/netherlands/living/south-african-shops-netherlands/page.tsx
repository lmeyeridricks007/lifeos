...
import { SouthAfricanShopsNetherlandsView } from "@/src/components/living/south-african-shops/SouthAfricanShopsNetherlandsView";
import { southAfricanShopsNetherlandsPage as page } from "@/src/components/living/south-african-shops/southAfricanShopsNetherlandsPageModel";
...
export default function SouthAfricanShopsNetherlandsPage() {
  return (
    <>
      ...
      />
      <SouthAfricanShopsNetherlandsView />
    </>
  );
}
