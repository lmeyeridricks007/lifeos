...
import { TurkishSupermarketsNetherlandsView } from "@/src/components/living/turkish-supermarkets/TurkishSupermarketsNetherlandsView";
import { turkishSupermarketsNetherlandsPage as page } from "@/src/components/living/turkish-supermarkets/turkishSupermarketsNetherlandsPageModel";
...
export default function TurkishSupermarketsNetherlandsPage() {
  return (
    <>
      ...
      />
      <TurkishSupermarketsNetherlandsView />
    </>
  );
}
