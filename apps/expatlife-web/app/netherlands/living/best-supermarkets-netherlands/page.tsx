...
import { BestSupermarketsNetherlandsView } from "@/src/components/living/best-supermarkets/BestSupermarketsNetherlandsView";
import { bestSupermarketsNetherlandsPage as page } from "@/src/components/living/best-supermarkets/bestSupermarketsNetherlandsPageModel";
...
export default function BestSupermarketsNetherlandsPage() {
  return (
    <>
      ...
      />
      <BestSupermarketsNetherlandsView />
    </>
  );
}
