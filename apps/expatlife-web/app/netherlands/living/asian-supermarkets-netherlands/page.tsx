...
import { AsianSupermarketsNetherlandsView } from "@/src/components/living/asian-supermarkets/AsianSupermarketsNetherlandsView";
import { asianSupermarketsNetherlandsPage as page } from "@/src/components/living/asian-supermarkets/asianSupermarketsNetherlandsPageModel";
...
export default function AsianSupermarketsNetherlandsPage() {
  return (
    <>
      ...
      />
      <AsianSupermarketsNetherlandsView />
    </>
  );
}
