...
import { RoadTripsNetherlandsView } from "@/src/components/living/road-trips-netherlands/RoadTripsNetherlandsView";
import { roadTripsNetherlandsPage as page } from "@/src/components/living/road-trips-netherlands/roadTripsNetherlandsPageModel";
...
export default function RoadTripsNetherlandsPage() {
  return (
    <>
