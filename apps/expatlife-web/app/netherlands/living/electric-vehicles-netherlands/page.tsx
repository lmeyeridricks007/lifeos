...
import { ElectricVehiclesNetherlandsView } from "@/src/components/living/electric-vehicles-netherlands/ElectricVehiclesNetherlandsView";
import { electricVehiclesNetherlandsPage as page } from "@/src/components/living/electric-vehicles-netherlands/electricVehiclesNetherlandsPageModel";
...
export default function ElectricVehiclesNetherlandsPage() {
  return (
    <>
      ...
      />
      <ElectricVehiclesNetherlandsView />
    </>
  );
}
