...
import { TippingNetherlandsView } from "@/src/components/living/tipping/TippingNetherlandsView";
import { tippingNetherlandsPage as page } from "@/src/components/living/tipping/tippingNetherlandsPageModel";
...
export default function TippingNetherlandsPage() {
  return (
    <>
