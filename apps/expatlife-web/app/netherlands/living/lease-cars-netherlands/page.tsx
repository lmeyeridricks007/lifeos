...
import { LeaseCarsNetherlandsView } from "@/src/components/living/lease-cars-netherlands/LeaseCarsNetherlandsView";
import { leaseCarsNetherlandsPage as page } from "@/src/components/living/lease-cars-netherlands/leaseCarsNetherlandsPageModel";
...
export default function LeaseCarsNetherlandsPage() {
  return (
    <>
