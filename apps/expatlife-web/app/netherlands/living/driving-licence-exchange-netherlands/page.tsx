...
import { DrivingLicenceExchangeNetherlandsView } from "@/src/components/living/driving-licence-exchange-netherlands/DrivingLicenceExchangeNetherlandsView";
import { drivingLicenceExchangeNetherlandsPage as page } from "@/src/components/living/driving-licence-exchange-netherlands/drivingLicenceExchangeNetherlandsPageModel";
...
export default function DrivingLicenceExchangeNetherlandsPage() {
  return (
    <>
      ...
      />
      <DrivingLicenceExchangeNetherlandsView />
    </>
  );
}
