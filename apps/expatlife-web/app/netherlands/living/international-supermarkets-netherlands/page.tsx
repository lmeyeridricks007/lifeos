...
import { InternationalSupermarketsNetherlandsView } from "@/src/components/living/international-supermarkets/InternationalSupermarketsNetherlandsView";
import { internationalSupermarketsNetherlandsPage as page } from "@/src/components/living/international-supermarkets/internationalSupermarketsNetherlandsPageModel";
...
export default function InternationalSupermarketsNetherlandsPage() {
  return (
    <>
      ...
      />
      <InternationalSupermarketsNetherlandsView />
    </>
  );
}
