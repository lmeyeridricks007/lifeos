...
import { DutchSupermarketsView } from "@/src/components/living/dutch-supermarkets/DutchSupermarketsView";
import { dutchSupermarketsPage as page } from "@/src/components/living/dutch-supermarkets/dutchSupermarketsPageModel";
...
export default function DutchSupermarketsPage() {
  return (
    <>
