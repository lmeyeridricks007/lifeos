...
import { BikeSharingNetherlandsView } from "@/src/components/living/bike-sharing-netherlands/BikeSharingNetherlandsView";
import { bikeSharingNetherlandsPage as page } from "@/src/components/living/bike-sharing-netherlands/bikeSharingNetherlandsPageModel";
...
export default function BikeSharingNetherlandsPage() {
  return (
    <>
