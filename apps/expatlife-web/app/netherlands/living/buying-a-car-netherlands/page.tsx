...
import { BuyingACarNetherlandsView } from "@/src/components/living/buying-a-car-netherlands/BuyingACarNetherlandsView";
import { buyingACarNetherlandsPage as page } from "@/src/components/living/buying-a-car-netherlands/buyingACarNetherlandsPageModel";
...
export default function BuyingACarNetherlandsPage() {
  return (
    <>
