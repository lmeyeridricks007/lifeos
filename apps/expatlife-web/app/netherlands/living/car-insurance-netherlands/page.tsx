...
import { CarInsuranceNetherlandsView } from "@/src/components/living/car-insurance-netherlands/CarInsuranceNetherlandsView";
import { carInsuranceNetherlandsPage as page } from "@/src/components/living/car-insurance-netherlands/carInsuranceNetherlandsPageModel";
...
export default function CarInsuranceNetherlandsPage() {
  return (
    <>
