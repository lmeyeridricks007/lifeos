...
import { IndianSupermarketsNetherlandsView } from "@/src/components/living/indian-supermarkets/IndianSupermarketsNetherlandsView";
import { indianSupermarketsNetherlandsPage as page } from "@/src/components/living/indian-supermarkets/indianSupermarketsNetherlandsPageModel";
...
export default function IndianSupermarketsNetherlandsPage() {
  return (
    <>
      ...
      />
      <IndianSupermarketsNetherlandsView />
    </>
  );
}
