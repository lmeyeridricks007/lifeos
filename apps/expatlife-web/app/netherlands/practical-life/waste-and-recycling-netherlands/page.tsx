...
import { WasteAndRecyclingNetherlandsView } from "@/src/components/practical-life/WasteAndRecyclingNetherlandsView";
import { wasteAndRecyclingNetherlandsPage as page } from "@/src/components/practical-life/wasteAndRecyclingNetherlandsPageModel";
...
export default function WasteAndRecyclingNetherlandsPage() {
  ...
  return (
    <>
      ...
      <HowToJsonLd
        ...
        urlPath={page.path}
      />
      <WasteAndRecyclingNetherlandsView />
    </>
  );
}
