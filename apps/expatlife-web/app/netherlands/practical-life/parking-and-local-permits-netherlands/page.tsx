...
import { ParkingAndLocalPermitsNetherlandsView } from "@/src/components/practical-life/ParkingAndLocalPermitsNetherlandsView";
import { parkingAndLocalPermitsNetherlandsPage as page } from "@/src/components/practical-life/parkingAndLocalPermitsNetherlandsPageModel";
...
export default function ParkingAndLocalPermitsNetherlandsPage() {
  ...
  return (
    <>
      ...
      <HowToJsonLd
        ...
        urlPath={page.path}
      />
      <ParkingAndLocalPermitsNetherlandsView />
    </>
  );
}
