...
import { PrescriptionsNetherlandsView } from "@/src/components/health/PrescriptionsNetherlandsView";
import { prescriptionsNetherlandsPage as page } from "@/src/components/health/prescriptionsNetherlandsPageModel";
...
function MedicalWebPageJsonLd() {
  const jsonLd = {
    ...
    about: {
      ...
      name: "Prescriptions / Recepten",
      description:
        "Orientation for expats on prescriptions in the Netherlands — who issues recepten, electronic prescriptions, pharmacy pickup, herhaalrecept, medication lists, insurance orientation and foreign prescriptions.",
    },
    audience: {
      "@type": "PeopleAudience",
...
export default function PrescriptionsNetherlandsPage() {
  return (
    <>
