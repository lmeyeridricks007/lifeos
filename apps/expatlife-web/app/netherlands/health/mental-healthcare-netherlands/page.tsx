...
import { MentalHealthcareNetherlandsView } from "@/src/components/health/MentalHealthcareNetherlandsView";
import { mentalHealthcareNetherlandsPage as page } from "@/src/components/health/mentalHealthcareNetherlandsPageModel";
...
function MedicalWebPageJsonLd() {
  const jsonLd = {
    ...
    about: {
      ...
      name: "Mental Healthcare / GGZ",
      description:
        "Orientation for expats on mental healthcare in the Netherlands — GP first contact, POH-GGZ, GGZ specialist care, stepped care, waiting times, English-language realities, costs and crisis pathways (112 / 113).",
    },
    audience: {
      "@type": "PeopleAudience",
...
export default function MentalHealthcareNetherlandsPage() {
  return (
    <>
      ...
      />
      <MentalHealthcareNetherlandsView />
    </>
  );
}
