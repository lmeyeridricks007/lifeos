...
import { PharmaciesNetherlandsView } from "@/src/components/health/PharmaciesNetherlandsView";
import { pharmaciesNetherlandsPage as page } from "@/src/components/health/pharmaciesNetherlandsPageModel";
...
function MedicalWebPageJsonLd() {
  const jsonLd = {
    ...
    about: {
      ...
      name: "Pharmacy / Apotheek",
      description:
        "Orientation for expats on pharmacies in the Netherlands — finding an apotheek, opening hours, OTC versus prescription pickup, service desk, medication counseling and emergency pharmacy (dienstapotheek) pathways.",
    },
    audience: {
      "@type": "PeopleAudience",
...
export default function PharmaciesNetherlandsPage() {
  return (
    <>
