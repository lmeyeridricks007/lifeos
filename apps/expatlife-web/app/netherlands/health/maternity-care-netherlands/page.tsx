...
import { MaternityCareNetherlandsView } from "@/src/components/health/MaternityCareNetherlandsView";
import { maternityCareNetherlandsPage as page } from "@/src/components/health/maternityCareNetherlandsPageModel";
...
function MedicalWebPageJsonLd() {
  const jsonLd = {
    ...
    about: {
      ...
      name: "Maternity Care / Verloskunde",
      description:
        "Orientation for expats on maternity care in the Netherlands — verloskundige first line, obstetric and hospital pathways, registration timing, insurance orientation and kraamzorg awareness.",
    },
    audience: {
      "@type": "PeopleAudience",
...
export default function MaternityCareNetherlandsPage() {
  return (
    <>
