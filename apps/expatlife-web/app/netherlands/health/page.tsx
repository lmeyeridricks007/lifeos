...
import { HealthNetherlandsHubView } from "@/src/components/health/HealthNetherlandsHubView";
import { healthNetherlandsHubPage as page } from "@/src/components/health/healthNetherlandsHubPageModel";
...
function HealthCollectionJsonLd() {
  const liveChildren = page.journeySections.flatMap((s) => s.links);
  const jsonLd = {
    ...
    mainEntity: {
      "@type": "ItemList",
      name: "Healthcare guides for expats in the Netherlands",
...
export default function NetherlandsHealthHubPage() {
  return (
    <>
      ...
      <HealthCollectionJsonLd />
      <HealthNetherlandsHubView />
    </>
  );
}
