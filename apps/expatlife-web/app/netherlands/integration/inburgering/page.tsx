...
export const metadata: Metadata = buildSocialMetadata({
  title: "Inburgering in the Netherlands: HSM, Wi 2021, B1 & KNM",
  description:
    "Do you have to inburgeren on HSM? Wet inburgering 2021 / B1 default, KNM changes from 1 July 2025 (still current), and DUO vs IND roles. Orientation only — confirm on official portals.",
