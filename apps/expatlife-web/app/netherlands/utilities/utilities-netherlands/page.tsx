...
import { UtilitiesNetherlandsView } from "@/src/components/utilities/UtilitiesNetherlandsView";
import { utilitiesNetherlandsPage as page } from "@/src/components/utilities/utilitiesNetherlandsPageModel";
...
function UtilityProviderDirectoryJsonLd() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Major utility providers in the Netherlands",
    description:
      "Neutral directory of utility provider examples for energy, internet, water and mobile services in the Netherlands.",
...
export default function UtilitiesNetherlandsPage() {
  ...
  return (
    <>
      ...
      <UtilityProviderDirectoryJsonLd />
      <UtilitiesNetherlandsView />
    </>
  );
}
