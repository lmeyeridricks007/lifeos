...
import { EnergyAndWaterNetherlandsView } from "@/src/components/utilities/EnergyAndWaterNetherlandsView";
import { energyAndWaterNetherlandsPage as page } from "@/src/components/utilities/energyAndWaterNetherlandsPageModel";
...
function ProviderDirectoryJsonLd() {
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Energy and water providers in the Netherlands",
    description: "Neutral directory of energy and regional water provider examples in the Netherlands.",
...
export default function EnergyAndWaterNetherlandsPage() {
