...
import { FamilyActivitiesNetherlandsView } from "@/src/components/family/family-activities-netherlands/FamilyActivitiesNetherlandsView";
import { familyActivitiesNetherlandsPage as page } from "@/src/components/family/family-activities-netherlands/familyActivitiesNetherlandsPageModel";
...
export default function FamilyActivitiesNetherlandsPage() {
  return (
    <>
      ...
      />
      <FamilyActivitiesNetherlandsView />
    </>
  );
}
