...
import { PetsNetherlandsView } from "@/src/components/family/pets-netherlands/PetsNetherlandsView";
import { petsNetherlandsPage as page } from "@/src/components/family/pets-netherlands/petsNetherlandsPageModel";
...
export default function PetsNetherlandsPage() {
  return (
    <>
