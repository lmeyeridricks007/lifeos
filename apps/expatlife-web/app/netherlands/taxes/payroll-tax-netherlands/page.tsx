...
import { PayrollTaxNetherlandsView } from "@/src/components/taxes/PayrollTaxNetherlandsView";
import { payrollTaxNetherlandsPage as page } from "@/src/components/taxes/payrollTaxNetherlandsPageModel";
...
export default function PayrollTaxNetherlandsPage() {
  return (
    <>
