...
import { AverageSalaryNetherlandsView } from "@/src/components/taxes/AverageSalaryNetherlandsView";
import { averageSalaryNetherlandsPage as page } from "@/src/components/taxes/averageSalaryNetherlandsPageModel";
...
export default function AverageSalaryNetherlandsPage() {
  return (
    <>
