...
import { RentAllowanceNetherlandsView } from "@/src/components/taxes/RentAllowanceNetherlandsView";
import { rentAllowanceNetherlandsPage as page } from "@/src/components/taxes/rentAllowanceNetherlandsPageModel";
...
export default function RentAllowanceNetherlandsPage() {
  return (
    <>
