...
import { GrossVsNetSalaryView } from "@/src/components/taxes/GrossVsNetSalaryView";
import { grossVsNetSalaryPage as page } from "@/src/components/taxes/grossVsNetSalaryPageModel";
...
export default function GrossVsNetSalaryPage() {
  return (
    <>
      <WebPageJsonLd
        name={hero.pageTitle}
