...
import { BonusTaxNetherlandsView } from "@/src/components/taxes/BonusTaxNetherlandsView";
import { bonusTaxNetherlandsPage as page } from "@/src/components/taxes/bonusTaxNetherlandsPageModel";
...
export default function BonusTaxNetherlandsPage() {
  return (
    <>
