...
import { TaxesAfterMovingNetherlandsView } from "@/src/components/taxes/TaxesAfterMovingNetherlandsView";
import { taxesAfterMovingNetherlandsPage as page } from "@/src/components/taxes/taxesAfterMovingNetherlandsPageModel";
...
export default function TaxesAfterMovingNetherlandsPage() {
  return (
    <>
      ...
      <TaxesAfterMovingNetherlandsView />
    </>
  );
}
