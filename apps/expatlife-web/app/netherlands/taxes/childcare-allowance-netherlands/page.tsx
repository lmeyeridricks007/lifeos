...
import { ChildcareAllowanceNetherlandsView } from "@/src/components/taxes/ChildcareAllowanceNetherlandsView";
import { childcareAllowanceNetherlandsPage as page } from "@/src/components/taxes/childcareAllowanceNetherlandsPageModel";
...
export default function ChildcareAllowanceNetherlandsPage() {
  return (
    <>
      ...
      <ChildcareAllowanceNetherlandsView />
    </>
  );
}
