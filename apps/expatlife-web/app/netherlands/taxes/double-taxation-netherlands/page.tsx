...
import { DoubleTaxationNetherlandsView } from "@/src/components/taxes/DoubleTaxationNetherlandsView";
import { doubleTaxationNetherlandsPage as page } from "@/src/components/taxes/doubleTaxationNetherlandsPageModel";
...
export default function DoubleTaxationNetherlandsPage() {
  return (
    <>
