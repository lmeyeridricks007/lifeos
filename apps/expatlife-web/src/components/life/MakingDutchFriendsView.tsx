...
import {
  ...
  LIFE_HUB_PATH,
  makingDutchFriendsPage as page,
  ...
  type ServiceRow,
} from "./makingDutchFriendsPageModel";
...
function buildOutboundLink(meta: OptionalOutboundLinkMeta, fallbackLabel = "Visit site") {
  ...
  return buildTrackedOutboundLink(meta.website, {
    pagePath: MAKING_DUTCH_FRIENDS_PATH,
...
function OutboundLinkButton({
  ...
  return (
    <a
      ...
      target="_blank"
      data-outbound-page-context="making-dutch-friends"
      className={cn(
        ...
        return (
          ...
          >
            ...
            <dl className="mt-3 space-y-2 text-sm">
              ...
              <div>
                <dt className="font-semibold text-foreground">Best routes</dt>
                <dd className="text-foreground-muted">{city.bestRoutes}</dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">Clubs</dt>
                <dd className="text-foreground-muted">{city.clubs}</dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">Expat hubs</dt>
                <dd className="text-foreground-muted">{city.expatHubs}</dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">Neighbourhood</dt>
                <dd className="text-foreground-muted">{city.neighbourhood}</dd>
              </div>
            </dl>
...
export function MakingDutchFriendsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Making Dutch Friends", item: new URL(MAKING_DUTCH_FRIENDS_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
              ...
              <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,0.85fr)] lg:items-center">
                <div>
                  <nav aria-label="Breadcrumb" className="flex flex-wrap gap-2 text-xs text-foreground-muted">
                    ...
                    <span aria-hidden>/</span>
                    <span className="text-foreground" aria-current="page">Making Dutch Friends</span>
                  </nav>
          ...
          <div className={sectionStackClass}>
            ...
            >
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <GuideCrossLink
                  ...
                  description="Neighbours, clubs, volunteering and broader integration routes."
                  linkLabel="Open Community Basics"
                />
                <GuideCrossLink
                  href={DUTCH_SOCIAL_NORMS_PATH}
                  title="Dutch Social Norms"
                  description="Everyday etiquette, direct communication and visiting customs."
            ...
            <PremiumGuideSection
              ...
              tipsKey="snapshot"
              intro={
                <SectionIntro eyebrow="At a glance" title="Making Friends in the Netherlands at a Glance" fullWidth>
                  <p>Six orientation signals — then pick two routes for your first six weeks.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              id="understanding-friendships"
              tipsKey="understandingFriendships"
              intro={
                <SectionIntro title={page.understandingFriendshipsHeading} fullWidth>
                  {page.understandingFriendshipsParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.understandingFriendships}
            >
              <InfoTable
                rows={page.friendshipCultureTopics.map((r) => ({ topic: r.topic, detail: r.detail }))}
                columns={[
              ...
              />
              <div className="grid gap-4 md:grid-cols-2">
                {page.friendshipCultureLinks.map((link) => (
                  <GuideCrossLink
                    key={link.href}
                    href={link.href}
                    title={link.label}
            ...
            <PremiumGuideSection
              id="why-difficult"
              tipsKey="whyDifficult"
              intro={
                <SectionIntro title={page.whyDifficultHeading} fullWidth>
                  {page.whyDifficultParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.whyDifficult}
            >
              <FeatureGrid items={page.whyDifficultCards} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="bestWays"
              intro={
                <SectionIntro title={page.bestWaysHeading} fullWidth>
                  <p>{page.bestWaysIntro}</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              id="outdoor-communities"
              tipsKey="outdoorCommunities"
              intro={
                <SectionIntro title={page.outdoorHeading} fullWidth>
                  {page.outdoorParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.outdoorCommunities}
            >
              <LinkedServiceTable rows={page.outdoorGroups} columns={[...serviceTableColumns]} fallbackLabel="Find groups" />
              <ChecklistBlock title="Outdoor group checklist" items={page.outdoorPackChecklist} columns={2} />
            </PremiumGuideSection>
            ...
            >
              ...
              <ChecklistBlock title="Join a sports club" items={page.sportsJoiningChecklist} columns={2} />
            </PremiumGuideSection>
            ...
            >
              <LinkedServiceTable rows={page.languageGroups} columns={[...serviceTableColumns]} fallbackLabel="Find groups" />
              <ChecklistBlock title="Language practice tips" items={page.languagePracticeTips} columns={2} />
              <GuideCrossLink
            ...
            >
              <LinkedServiceTable rows={page.volunteerGroups} columns={[...serviceTableColumns]} fallbackLabel="Find roles" />
              <ChecklistBlock title="Volunteer for social contact" items={page.volunteerTips} columns={2} />
              <GuideCrossLink
                href={VOLUNTEERING_PATH}
                title="Volunteering in the Netherlands"
                description="National portals, gemeente listings and weekly shift ideas."
            ...
            >
              <LinkedServiceTable rows={page.expatGroups} columns={[...serviceTableColumns]} fallbackLabel="Join community" />
              <ChecklistBlock title="Balance expat and local life" items={page.expatBalanceTips} columns={2} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="community-groups"
              tipsKey="communityGroups"
              intro={
                <SectionIntro title={page.communityGroupsHeading} fullWidth>
                  {page.communityGroupsParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.communityGroups}
            >
              <LinkedServiceTable rows={page.communityGroups} columns={[...serviceTableColumns]} fallbackLabel="Find groups" />
              <ChecklistBlock title="Community group tips" items={page.communityGroupTips} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="hobbies"
              intro={
                <SectionIntro title={page.hobbiesHeading} fullWidth>
                  {page.hobbiesParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.hobbies}
            >
              <LinkedServiceTable rows={page.hobbyGroups} columns={[...serviceTableColumns]} fallbackLabel="Find clubs" />
              <ChecklistBlock title="Pick and stick with one hobby" items={page.hobbyPickTips} columns={2} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="professional-networks"
              tipsKey="professionalNetworks"
              intro={
                <SectionIntro title={page.professionalHeading} fullWidth>
                  {page.professionalParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.professionalNetworks}
            >
              <LinkedServiceTable rows={page.professionalGroups} columns={[...serviceTableColumns]} fallbackLabel="Find networks" />
              <ChecklistBlock title="Balance work and social life" items={page.professionalBalanceTips} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="neighbours"
              intro={
                <SectionIntro title={page.neighboursHeading} fullWidth>
                  {page.neighboursParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.neighbours}
            >
              <InfoTable
                rows={page.neighbourScenarios.map((r) => ({
                  route: r.route,
                  example: r.example,
              ...
              />
              <ChecklistBlock title="Neighbour friendship tips" items={page.neighbourTips} columns={2} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="what-doesnt-work"
              tipsKey="whatDoesntWork"
              intro={
                <SectionIntro title={page.whatDoesntWorkHeading} fullWidth>
                  {page.whatDoesntWorkParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.whatDoesntWork}
            >
              <InfoTable
                rows={page.whatDoesntWorkRows.map((r) => ({
                  approach: r.approach,
                  why: r.why,
                  instead: r.instead,
                }))}
                columns={[
                  { key: "approach", label: "What often fails" },
                  { key: "why", label: "Why" },
                  { key: "instead", label: "Try instead" },
                ]}
              />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="lifeStages"
              intro={
                <SectionIntro title={page.lifeStagesHeading} fullWidth>
                  {page.lifeStagesParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.lifeStages}
            >
              <div className={guidePremiumCardGridClass(page.lifeStageCards.length)}>
                {page.lifeStageCards.map((card, index) => {
                  const Icon = iconPool[index % iconPool.length];
                  return (
                    <article key={card.stage} className={cardClass}>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-foreground-muted"><span className="font-semibold text-foreground">Challenges: </span>{card.challenges}</p>
                      <p className="mt-2 text-sm leading-relaxed text-foreground-muted"><span className="font-semibold text-foreground">Best routes: </span>{card.bestRoutes}</p>
                      <p className="mt-3 text-sm font-semibold text-brand-strong">{card.tip}</p>
                    </article>
                  );
                })}
              </div>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro title={page.citiesHeading} fullWidth>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro title={page.successStoriesHeading} fullWidth>
                  {page.successStoriesParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              visual={page.visuals.successStories}
            >
              <div className={guidePremiumCardGridClass(page.successStories.length)}>
                {page.successStories.map((story, index) => {
                  const Icon = iconPool[index % iconPool.length];
                  return (
                    <article key={`${story.profile}-${story.city}`} className={cardClass}>
                      ...
                      <p className="mt-1 text-xs font-bold uppercase tracking-[0.12em] text-brand-strong">{story.city}</p>
                      <p className="mt-2 text-sm leading-relaxed text-foreground-muted"><span className="font-semibold text-foreground">Route: </span>{story.route}</p>
                      <p className="mt-2 text-sm leading-relaxed text-foreground-muted"><span className="font-semibold text-foreground">Outcome: </span>{story.outcome}</p>
                      <p className="mt-3 text-sm font-semibold text-brand-strong">{story.lesson}</p>
                    </article>
                  );
                })}
              </div>
            ...
            <PremiumGuideSection
              ...
              tipsKey="mistakes"
              intro={
                <SectionIntro title={page.mistakesHeading} fullWidth>
                  <p>Common strategy gaps — adjust channels before concluding friendship is impossible here.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              ...
              tipsKey="timeline"
              intro={
                <SectionIntro title={page.timelineHeading} fullWidth>
                  {page.timelineParagraphs.map((p) => <p key={p}>{p}</p>)}
                </SectionIntro>
              }
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {page.integrationTimeline.map((phase) => (
                  <article key={phase.phase} className={cardClass}>
                    <div className={cn("absolute inset-x-0 top-0 h-1.5", movingNlSignatureGradientClass)} aria-hidden />
                    <p className="text-xs font-bold uppercase tracking-[0.14em] text-brand-strong">{phase.phase}</p>
                    <ul className="mt-4 space-y-2">
                      {phase.tasks.map((task) => (
                        <li key={task} className="flex gap-2 text-sm leading-relaxed text-foreground-muted">
                          <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-brand-strong" aria-hidden />
                          <span>{task}</span>
                        </li>
                      ))}
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro title="Frequently Asked Questions" fullWidth>
                  <p>Confirm club and group details locally — offerings change by season and city.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro title="Related Guides" fullWidth>
                  <p>Continue from friendship routes into community integration, social norms and city guides.</p>
                </SectionIntro>
              }
            ...
            <section id="explore-next" className={cn(CITIES_FUNNEL_SECTION_SCROLL_MARGIN, "scroll-mt-24 overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-expatos-xl sm:p-8 lg:p-10")}>
              ...
              <div className="mt-6">
                <SectionIntro eyebrow="Explore next" title="Plan the Next Step" tone="onDark" fullWidth>
                  <p>Move from friendship orientation into community integration, social norms and language learning.</p>
                </SectionIntro>
                    ...
                    {page.officialSources.map((source) => {
                      ...
                      return (
                        <a
                          ...
                          {...trackedOutboundAnchorProps(outbound)}
                          target="_blank"
                          data-outbound-page-context="making-dutch-friends-official-sources"
