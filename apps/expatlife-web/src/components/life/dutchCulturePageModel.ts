...
export const MAKING_FRIENDS_PATH = MAKING_DUTCH_FRIENDS_PATH;
...
export const dutchCulturePage = {
  ...
  relatedGuides: [
    ...
    { label: "Dutch Etiquette", href: DUTCH_ETIQUETTE_PATH, description: "Manners for visits, dining and public spaces.", status: "live" },
    { label: "Dutch Birthday Traditions", href: DUTCH_BIRTHDAY_TRADITIONS_PATH, description: "Circle parties, gifts and office birthdays.", status: "live" },
    { label: "Dutch Humour Explained", href: DUTCH_HUMOUR_PATH, description: "Irony, sarcasm and social context.", status: "live" },
  ...
  relatedGuidesReadingOrder: [
    ...
    "Dutch Etiquette → situational manners",
  ...
  cultureHubCards: [
    ...
    { label: "Dutch Etiquette", href: DUTCH_ETIQUETTE_PATH, description: "Visiting, dining and public manners.", status: "live" },
    ...
    { label: "Making Dutch Friends", href: MAKING_DUTCH_FRIENDS_PATH, description: "Clubs, volunteering and friendship routes.", status: "live" },
    ...
    { label: "Dutch Humour Explained", href: DUTCH_HUMOUR_PATH, description: "Irony, jokes and social context.", status: "live" },
  ...
  exploreNextCards: [
    ...
    { label: "Making Dutch Friends", href: MAKING_DUTCH_FRIENDS_PATH, description: "Activity-first social routes.", status: "live" },
  ] satisfies LifeGuideLink[],
  exploreNextTips: [
  ...
  schemaCollectionItems: [
    ...
    { name: "Dutch Etiquette", description: "Visiting, dining, neighbours and public manners." },
    ...
    { name: "Dutch Birthday Traditions", description: "Circle parties, gifts and office birthdays." },
    { name: "Community Basics", description: "Building social life and neighbourhood connections." },
    { name: "Making Dutch Friends", description: "Activity-first friendship and club routes." },
    { name: "Dutch Humour Explained", description: "Irony, sarcasm and social humour context." },
