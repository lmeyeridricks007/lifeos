...
import { averageSalaryNetherlandsPage as page } from "./averageSalaryNetherlandsPageModel";
...
export function AverageSalaryRecommendedServices() {
    ...
    <div className="mt-6 space-y-8">
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation consultants for salary moves</h3>
          <p className="mt-2 w-full max-w-none text-sm leading-relaxed text-foreground-muted">
            Useful when an offer depends on timing, housing search, family logistics or employer relocation support — confirm scope and fees
