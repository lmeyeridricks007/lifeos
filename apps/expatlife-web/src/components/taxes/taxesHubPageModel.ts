...
export const taxesHubPage = {
  ...
  hero: {
    ...
    subtitle:
      "The taxes information architecture for expats: topic guides, calculators, and official figure links. Start with the Money foundation explainers if you need the system basics, then use this hub to open the right specialist page.",
    primaryCta: { label: "Explore Tax Topics", href: "#tax-topics" },
    secondaryCta: { label: "Open tax tools", href: "/netherlands/taxes/tools/" },
    chips: ["Topic hub", "30% ruling", "Allowances", "Calculators"],
    image: {
  ...
  taxTopics: [
    {
      ...
      status: "live",
      description: "Money-pillar flagship: learning path across payroll, returns, 30%, allowances, boxes and tools.",
    },
    {
      label: "How Taxes Work in the Netherlands",
      href: "/netherlands/money/how-taxes-work-in-the-netherlands/",
      status: "live",
      description: "Beginner system explainer: payroll vs annual return, Box 1–3, credits vs allowances.",
    },
    {
      label: "Expat Taxes in the Netherlands",
      href: "/netherlands/money/expat-taxes-netherlands/",
      status: "live",
      description: "Scenario-led Money guide: part-year moves, foreign assets, family benefits and cross-border situations.",
    },
    {
      label: "Taxes After Moving to the Netherlands",
      href: "/netherlands/taxes/taxes-after-moving-netherlands/",
      status: "live",
      description: "First tax steps after relocation: BSN, payroll, residency, allowances, 30% ruling and annual filing.",
    },
    {
      label: "Taxes When Leaving the Netherlands",
      href: "/netherlands/taxes/leaving-netherlands-tax/",
      status: "live",
      description: "Exit tax considerations: deregistration, final tax returns, residency changes, pensions, allowances and cross-border transitions.",
    },
    {
      label: "Foreign Income in the Netherlands",
      href: "/netherlands/taxes/foreign-income-netherlands/",
      status: "live",
      description: "Foreign salary, remote work income, rental property abroad, investments, worldwide income concepts and reporting awareness.",
    },
    {
    ...
    },
    {
      ...
      href: "/netherlands/money/how-taxes-work-in-the-netherlands/",
      status: "live",
      description: "Until a dedicated income-tax page ships, use the system explainer plus payroll and net-salary guides.",
    },
    {
      label: "30% Ruling",
    ...
    },
    {
      ...
      href: "/netherlands/money/how-taxes-work-in-the-netherlands/",
      status: "live",
      description: "Box structure orientation lives in the system explainer until a dedicated box-tax page ships.",
    },
    {
      label: "Payroll Tax",
    ...
    },
    {
      ...
      href: "/netherlands/taxes/foreign-income-netherlands/",
      status: "live",
      description: "Cross-border income topics to understand before discussing specifics with an adviser.",
    },
    {
  ...
  faqCards: [
    { label: "What taxes matter after moving to the Netherlands?", href: "/netherlands/taxes/taxes-after-moving-netherlands/", status: "live" },
    { label: "What happens tax-wise when leaving the Netherlands?", href: "/netherlands/taxes/leaving-netherlands-tax/", status: "live" },
    ...
    { label: "What are Box 1 / Box 2 / Box 3 taxes?", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live" },
    ...
    { label: "Do I need to declare foreign income?", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live" },
    { label: "What happens if I work remotely?", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live" },
    { label: "Can I keep investments abroad?", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live" },
  ...
  relatedGuides: [
    ...
    { label: "Taxes tools hub", href: "/netherlands/taxes/tools/" },
  ...
  exploreNextCards: [
    { label: "Tax guide for expats", href: "/netherlands/money/tax-guide-for-expats/", description: "Money-pillar learning path before diving into specialist tax topics." },
    { label: "How taxes work", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", description: "Plain-English system map: payroll vs return, boxes, credits and allowances." },
    ...
    { label: "Official figures 2026", href: "/netherlands/official-figures/", description: "Shared citation table for 30% norms, salary floors and other statutory amounts." },
    ...
    { label: "Taxes tools", href: "/netherlands/taxes/tools/", description: "Salary net, 30% ruling, healthcare allowance and double-tax awareness calculators." },
