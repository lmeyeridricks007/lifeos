...
export const expatTaxesNetherlandsPage = {
  ...
  topicLinks: [
    { label: "Tax residency", href: "/netherlands/money/tax-residency-netherlands/", status: "live", description: "Tax residency concepts and move-year questions." },
    ...
    { label: "Income tax (system basics)", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live", description: "System explainer until a dedicated income-tax page ships." },
    { label: "Box tax system", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live", description: "Box 1–3 orientation in the system explainer." },
    ...
    { label: "Tax return", href: "/netherlands/money/tax-return-netherlands/", status: "live", description: "Annual filing orientation for expats." },
    { label: "Foreign income", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live", description: "Cross-border income and reporting awareness." },
  ...
  serviceLinks: [
    { label: "Tax advisors", href: "/netherlands/services/tax-advisors/", status: "live", description: "Compare tax advisors and international tax specialists." },
  ...
  officialSources: [
    { label: "ExpatCopilot official figures 2026", href: "/netherlands/official-figures/" },
  ...
  relatedGuides: [
    ...
    { label: "Taxes After Moving to the Netherlands", href: "/netherlands/taxes/taxes-after-moving-netherlands/", status: "live" },
    { label: "Taxes When Leaving the Netherlands", href: "/netherlands/taxes/leaving-netherlands-tax/", status: "live" },
    ...
    { label: "Foreign Income in the Netherlands", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live" },
    { label: "Double Taxation in the Netherlands", href: "/netherlands/taxes/double-taxation-netherlands/", status: "live" },
    { label: "Tax Return Guide", href: "/netherlands/money/tax-return-netherlands/", status: "live" },
  ...
  exploreNextCards: [
    ...
    { label: "Taxes After Moving", href: "/netherlands/taxes/taxes-after-moving-netherlands/", status: "live", description: "Understand first tax steps after relocation: BSN, payroll, residency, allowances and annual filing." },
    { label: "Taxes When Leaving", href: "/netherlands/taxes/leaving-netherlands-tax/", status: "live", description: "Understand deregistration, final return, pension, allowance and cross-border transition questions before leaving." },
    ...
    { label: "Foreign Income", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live", description: "Review remote work, overseas income, assets abroad and reporting awareness." },
    { label: "Tax Return Guide", href: "/netherlands/money/tax-return-netherlands/", status: "live", description: "Annual filing orientation for expats." },
    { label: "Find Tax Services", href: "/netherlands/services/tax-advisors/", status: "live", description: "Compare tax advisors and expat accountants." },
  ] satisfies ExpatTaxGuideLink[],
} as const;
