...
export const averageSalaryNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Expat Salary in the Netherlands", href: "/netherlands/jobs/expat-salary-netherlands/", status: "live", description: "Salary expectations for international professionals by city, industry and tax context." },
