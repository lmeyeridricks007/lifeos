...
export const grossVsNetSalaryPage = {
  ...
  relatedTaxTopics: [
    ...
    { label: "Expat Taxes", href: "/netherlands/money/expat-taxes-netherlands/", status: "live", description: "Wider expat tax context for residency, returns and foreign income." },
  ...
  relatedGuides: [
    ...
    { label: "Expat Taxes in the Netherlands", href: "/netherlands/money/expat-taxes-netherlands/", status: "live", description: "Tax system guide for international residents." },
  ...
  exploreNextCards: [
    ...
    { label: "Expat Taxes", href: "/netherlands/money/expat-taxes-netherlands/", status: "live", description: "Understand broader expat tax questions." },
