...
export const thirtyPercentRulingPage = {
  ...
  relatedTaxTopics: [
    ...
    { label: "How taxes work", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live", description: "System explainer including boxes and payroll vs return." },
    { label: "Tax Residency", href: "/netherlands/money/tax-residency-netherlands/", status: "live", description: "Tax residency concepts for expats." },
    { label: "Official figures 2026", href: "/netherlands/official-figures/", status: "live", description: "Shared citation table including 30% norms and salary floors." },
    ...
    { label: "Tax Returns", href: "/netherlands/money/tax-return-netherlands/", status: "live", description: "Annual filing orientation for expats." },
  ...
  exploreNextCards: [
    ...
    { label: "Tax Residency", href: "/netherlands/money/tax-residency-netherlands/", status: "live", description: "Tax residency concepts for expats." },
    { label: "Tax Returns", href: "/netherlands/money/tax-return-netherlands/", status: "live", description: "Annual filing orientation for expats." },
    { label: "Official figures 2026", href: "/netherlands/official-figures/", status: "live", description: "Shared citation table including 30% norms." },
    { label: "How taxes work", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live", description: "System explainer for boxes, payroll and returns." },
    { label: "Find Tax Advisors", href: "/netherlands/services/tax-advisors/", status: "live", description: "Compare tax advisors and expat accountants." },
  ] satisfies ThirtyPercentRulingLink[],
} as const;
