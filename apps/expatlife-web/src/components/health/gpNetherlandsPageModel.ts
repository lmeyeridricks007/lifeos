...
export const gpNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Hospitals & Specialists", href: "#referrals", status: "comingSoon", description: "Dedicated hospital pathway guide — planned; referral section above covers the GP gate." },
  ] satisfies GpLink[],
  healthcareHubTips: [
    ...
    "Dedicated pharmacy, hospital and mental health cornerstones are planned — use live links meanwhile.",
  ],
  healthcareHubCards: [
