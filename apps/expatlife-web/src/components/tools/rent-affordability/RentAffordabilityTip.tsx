...
/** Click-to-toggle tooltip (matches cost-of-living tool pattern; portals above overflow). */
export function RentAffordabilityTip({ text, label = "More information" }: { text: string; label?: string }) {
  const id = useId();
