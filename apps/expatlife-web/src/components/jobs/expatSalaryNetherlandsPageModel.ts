...
export const expatSalaryNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "comingSoon", description: "Dutch CV and application materials for international professionals." },
    { label: "Interview Tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "comingSoon", description: "Dutch interview culture and preparation before offer talks." },
