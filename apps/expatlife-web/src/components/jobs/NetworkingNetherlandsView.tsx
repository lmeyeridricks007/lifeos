...
import { NetworkingNetherlandsRecommendedServices } from "./NetworkingNetherlandsRecommendedServices";
import {
  ...
  networkingNetherlandsPage as page,
  type NetworkingNetherlandsLink,
} from "./networkingNetherlandsPageModel";
...
function LinkCard({ item, iconIndex = 0, tone = "default" }: { item: NetworkingNetherlandsLink; iconIndex?: number; tone?: "default" | "onDark" }) {
...
export function NetworkingNetherlandsView() {
    ...
    <div className={sitePageCanvasClass}>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Networking Netherlands", item: `${baseUrl}${NETWORKING_NETHERLANDS_PATH}` },
        ]}
      />
      <Container className={siteGuideColumnPadYClass}>
        <div className="mx-auto w-full max-w-6xl">
              ...
              <div className="grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center">
                <div>
                  ...
                  <p className="mt-5 max-w-3xl rounded-2xl border border-amber-200/70 bg-amber-50/70 px-4 py-3 text-sm leading-relaxed text-amber-950 shadow-sm ring-1 ring-amber-200/40">
                    This guide is practical orientation only — not career, immigration or recruitment advice. Networking and hiring norms vary by employer and sector. Some links on this page may be affiliate or referral links.
                  </p>
                </div>
                <HeroImage />
              </div>
          ...
          <div className="sticky top-3 z-20 mt-6 overflow-x-auto rounded-2xl border border-slate-200/80 bg-white/90 p-2 shadow-card ring-1 ring-slate-900/[0.04] backdrop-blur-xl">
            <nav aria-label="Networking guide sections" className="flex min-w-max gap-2">
          ...
          <div className={sectionStackClass}>
            <section id="intro" className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                ...
                <ChecklistBlock title="Three orientation moves before your first event" items={page.introPlanningSteps} columns={2} />
            ...
            <section id="snapshot" className={sectionClass}>
              <SectionIntro eyebrow="At a glance" title="Networking Netherlands Snapshot">
            ...
            <section id="communities" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="Where to belong" title={page.communitiesHeading} fullWidth>
                  {page.communitiesParagraphs.map((paragraph) => (
                    <p key={paragraph}>{paragraph}</p>
                  ))}
                </SectionIntro>
                <BulletPanel title="Community principles" items={page.communitiesPoints} />
              </div>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <InfoTable
                  ...
                  columns={[
                    { key: "section", label: "Community type" },
                    { key: "include", label: "What to look for" },
                    { key: "tip", label: "Tip" },
                  ]}
                />
                <ChecklistBlock title="Community shortlist checklist" items={page.communitiesChecklist} columns={2} />
              </div>
            </section>

            <section id="events" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="Show up" title={page.eventsHeading} fullWidth>
                  {page.eventsParagraphs.map((paragraph) => (
                    <p key={paragraph}>{paragraph}</p>
                  ))}
                </SectionIntro>
                <BulletPanel title="Event principles" items={page.eventsPoints} />
              </div>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                ...
                <BulletPanel title="Event tips" items={page.eventsTips} />
              </div>
            </section>

            <section id="referrals" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="Warm paths" title={page.referralsHeading} fullWidth>
                  {page.referralsParagraphs.map((paragraph) => (
                    <p key={paragraph}>{paragraph}</p>
                  ))}
                </SectionIntro>
                <BulletPanel title="Referral principles" items={page.referralsPoints} />
              </div>
            ...
            <section id="checklist" className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                ...
                <ChecklistBlock title="Networking package checklist" items={page.applicationChecklist} columns={2} />
              </div>
            </section>
            ...
            <section id="services" className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                ...
                <NetworkingNetherlandsRecommendedServices />
