...
export const dutchWorkplaceCulturePage = {
  ...
  relatedGuides: [
    ...
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "comingSoon", description: "Dutch CV and application document norms for expats." },
    { label: "Interview tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "comingSoon", description: "Dutch interview culture, preparation and follow-up for expats." },
