              ...
              intro={
                <>
                  ...
                  <p>
                    ...
                    <Link href="/netherlands/jobs/holiday-allowance-netherlands/" className="font-semibold text-link hover:text-link-hover">Holiday Allowance guide</Link>
                    {" "}for a full vakantiegeld explainer, plus the{" "}
