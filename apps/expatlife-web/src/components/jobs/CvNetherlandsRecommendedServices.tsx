...
import { cvNetherlandsPage as page, CV_NETHERLANDS_PATH } from "./cvNetherlandsPageModel";
...
export function CvNetherlandsRecommendedServices() {
  ...
  return (
    <div className="space-y-8">
      ...
      <ProviderCardSection
        ...
        description="Useful when work-permit routes, recognised sponsors or relocation timing still need scoped professional help alongside official IND guidance — not as a CV-writing service."
        cards={visaPermits}
      />
      <ProviderCardSection
        eyebrow="Relocation"
      ...
      <AffiliateDisclosure
        variant="copilot"
        text="ExpatCopilot may earn a commission from some partners. Listings here support application and relocation planning — not pay-to-rank CV writers and not job or visa guarantees. Confirm scope, credentials and pricing with any provider."
      />
    </div>
  );
}
