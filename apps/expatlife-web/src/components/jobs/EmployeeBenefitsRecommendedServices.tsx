...
import { employeeBenefitsNetherlandsPage as page } from "./employeeBenefitsNetherlandsPageModel";
...
export function EmployeeBenefitsRecommendedServices() {
    ...
    <div className="space-y-8">
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation support alongside benefits packages</h3>
