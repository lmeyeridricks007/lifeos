...
import { holidayAllowanceNetherlandsPage as page } from "./holidayAllowanceNetherlandsPageModel";
...
export function HolidayAllowanceNetherlandsRecommendedServices() {
    ...
    <div className="space-y-8">
      <MoveGuideAffiliateSupportBlock
        ...
        categoryLinks={[
          ...
          { href: "/netherlands/services/payroll-services/", label: "Payroll services" },
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation support alongside compensation planning</h3>
