...
import {
  ...
  JOBS_HUB_PATH,
  dutchWorkplaceCulturePage as page,
  type MistakeFixRow,
  type TimelineStep,
...
export function DutchWorkplaceCultureView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
      ...
      <main className={sitePageCanvasClass}>
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className="sticky top-3 z-20 mt-6 overflow-x-auto rounded-2xl border border-slate-200/80 bg-white/90 p-2 shadow-card ring-1 ring-slate-900/[0.04] backdrop-blur-xl">
            <nav aria-label="Workplace culture page sections" className="flex min-w-max gap-2">
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              tipsKey="snapshot"
              intro={
                <SectionIntro eyebrow="At a glance" title="Dutch Workplace Culture at a Glance" fullWidth>
                  <p>Use these signals to orient yourself on communication, hierarchy, balance and meetings — then verify with your team.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              id="business-culture"
              tipsKey="businessCulture"
              intro={
                <SectionIntro eyebrow="Business culture" title={page.businessCultureHeading} fullWidth>
                  {page.businessCultureParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.businessCulture}
            >
              <BulletPanel title="How Dutch companies often operate" items={page.businessCulturePoints} />
              <FeatureGrid items={page.businessCultureExamples} />
              <ChecklistBlock title="Questions to ask your manager in week one" items={page.businessCultureAskManager} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Communication" title={page.directCommunicationHeading} fullWidth>
                  {page.directCommunicationParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
            ...
            >
              <div className="grid gap-4 lg:grid-cols-2">
                <ChecklistBlock title="Benefits of directness" items={page.directCommunicationBenefits} />
                <ChecklistBlock title="Common misunderstandings" items={page.directCommunicationMisunderstandings} />
              </div>
              <ChecklistBlock title="How expats can adapt" items={page.directCommunicationTips} columns={2} />
              <InfoTable
                rows={page.directCommunicationExamples.map((r) => ({ situation: r.situation, whatHappens: r.whatHappens, howToAdapt: r.howToAdapt }))}
                columns={[
                  { key: "situation", label: "Situation" },
                  { key: "whatHappens", label: "What happens" },
                  { key: "howToAdapt", label: "How to adapt" },
                ]}
              />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="hierarchy"
              intro={
                <SectionIntro eyebrow="Structure" title={page.hierarchyHeading} fullWidth>
                  {page.hierarchyParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.hierarchy}
            >
              <BulletPanel title="Flat hierarchy — key points" items={page.hierarchyPoints} />
              <InfoTable
                rows={page.hierarchyScenarios.map((r) => ({ profile: r.profile, scenario: r.scenario, whatToCheck: r.whatToCheck }))}
                columns={[
              ...
              />
              <ChecklistBlock title="Clarify authority early" items={page.hierarchyAskManager} columns={1} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="feedback"
              intro={
                <SectionIntro eyebrow="Feedback" title={page.feedbackHeading} fullWidth>
                  {page.feedbackParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.feedback}
            >
              <FeatureGrid items={page.feedbackExamples} />
            ...
            <PremiumGuideSection
              ...
              tipsKey="meetings"
              intro={
                <SectionIntro eyebrow="Meetings" title={page.meetingsHeading} fullWidth>
                  {page.meetingsParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.meetings}
            >
              <BulletPanel title="Meeting culture — key points" items={page.meetingsPoints} />
              <InfoTable
              ...
              />
              <ChecklistBlock title="Meeting checklist" items={page.meetingsChecklist} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Balance" title={page.workLifeBalanceHeading} fullWidth>
                  {page.workLifeBalanceParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
            ...
            >
              <BulletPanel title="Work-life balance — key points" items={page.workLifeBalancePoints} />
              <FeatureGrid items={page.workLifeBalanceExamples} />
              <ChecklistBlock title="Balance checklist" items={page.workLifeBalanceChecklist} columns={2} />
              <ChecklistBlock title="Ask your manager" items={page.workLifeBalanceAskManager} columns={1} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="remote-hybrid"
              tipsKey="remoteHybrid"
              intro={
                <SectionIntro eyebrow="Flexible work" title={page.remoteHybridHeading} fullWidth>
                  {page.remoteHybridParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.remoteHybrid}
            >
              <BulletPanel title="Hybrid work — key points" items={page.remoteHybridPoints} />
              <FeatureGrid items={page.remoteHybridExamples} />
              <InfoTable
                rows={page.remoteHybridPolicyRows.map((r) => ({ topic: r.topic, typical: r.typical, ask: r.ask }))}
                columns={[
                  { key: "topic", label: "Topic" },
                  { key: "typical", label: "Typical pattern" },
                  { key: "ask", label: "What to ask HR or manager" },
                ]}
              />
              <ChecklistBlock title="Hybrid onboarding checklist" items={page.remoteHybridChecklist} columns={2} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="professional-communication"
              tipsKey="professionalCommunication"
              intro={
                <SectionIntro eyebrow="Channels" title={page.professionalCommunicationHeading} fullWidth>
                  {page.professionalCommunicationParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.professionalCommunication}
            >
              <FeatureGrid items={page.professionalCommunicationExamples} />
              <InfoTable
                rows={page.professionalCommunicationTemplates.map((r) => ({
                  channel: r.channel,
              ...
              />
              <ChecklistBlock title="Email and chat checklist" items={page.professionalCommunicationChecklist} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="punctuality"
              intro={
                <SectionIntro eyebrow="Reliability" title={page.punctualityHeading} fullWidth>
                  {page.punctualityParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
            ...
            >
              <ChecklistBlock title="Time and commitment checklist" items={page.punctualityChecklist} columns={2} />
              <InfoTable
                rows={page.punctualityScenarios.map((r) => ({ situation: r.situation, whatHappens: r.whatHappens, howToAdapt: r.howToAdapt }))}
                columns={[
                  { key: "situation", label: "Situation" },
                  { key: "whatHappens", label: "What happens" },
                  { key: "howToAdapt", label: "How to adapt" },
            ...
            <PremiumGuideSection
              ...
              tipsKey="diversity"
              intro={
                <SectionIntro eyebrow="International teams" title={page.diversityHeading} fullWidth>
                  {page.diversityParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.diversity}
            >
              <BulletPanel title="International teams — key points" items={page.diversityPoints} />
              <FeatureGrid items={page.diversityCityCards} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              tipsKey="networking"
              intro={
                <SectionIntro eyebrow="Relationships" title={page.networkingHeading} fullWidth>
                  {page.networkingParagraphs.map((p) => (
                    <p key={p}>{p}</p>
                  ))}
                </SectionIntro>
              }
              visual={page.visuals.networking}
            >
              <ChecklistBlock title="Networking tips" items={page.networkingTips} columns={2} />
              <InfoTable
                rows={page.networkingRoutes.map((r) => ({ route: r.route, example: r.example, firstStep: r.firstStep }))}
                columns={[
              ...
              <GuideCrossLink
                ...
                title="Finding jobs in the Netherlands"
                description="Combine culture awareness with job search strategy, recruiters and visa sponsorship context."
                linkLabel="Open finding jobs guide"
              />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="workplace-situations"
              tipsKey="workplaceSituations"
              intro={
                <SectionIntro eyebrow="Examples" title={page.workplaceSituationsHeading} fullWidth>
                  <p>Recognise common patterns so you can respond instead of guessing intent.</p>
                </SectionIntro>
              }
              visual={page.visuals.workplaceSituations}
            >
              <FeatureGrid items={page.workplaceSituationsCards} />
              <InfoTable
                rows={page.workplaceSituationRows.map((r) => ({
                  situation: r.situation,
                  whatHappens: r.whatHappens,
                  howToAdapt: r.howToAdapt,
                }))}
                columns={[
                  { key: "situation", label: "Situation" },
                  { key: "whatHappens", label: "What happens" },
            ...
            <PremiumGuideSection
              ...
              tipsKey="industryDifferences"
              intro={
                <SectionIntro eyebrow="Sectors" title={page.industryDifferencesHeading} fullWidth>
                  <p>Adjust expectations when moving between startup pace and government process.</p>
                </SectionIntro>
              }
              visual={page.visuals.industryDifferences}
            >
              <InfoTable
                rows={page.industryCards.map((r) => ({ industry: r.industry, cultureNote: r.cultureNote, expatTip: r.expatTip }))}
                columns={[
                  { key: "industry", label: "Industry" },
                  { key: "cultureNote", label: "Culture note" },
                  { key: "expatTip", label: "Expat tip" },
                ]}
              />
              <ChecklistBlock title="When changing sector" items={page.industryCompareTips} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Challenges" title={page.expatChallengesHeading} fullWidth>
                  <p>Most friction is an adaptation gap — use the fix table as a weekly check.</p>
                </SectionIntro>
              }
              visual={page.visuals.expatChallenges}
            >
              <FeatureGrid items={page.expatChallengeCards} />
              <MistakeFixTable title="Practical fixes for common culture challenges" rows={page.challengeFixRows} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Success" title={page.successChecklistHeading} fullWidth>
                  <p>Run through this list during your first months in a Dutch team.</p>
                </SectionIntro>
              }
              visual={page.visuals.successChecklist}
            >
              <ChecklistBlock title="How to succeed in a Dutch workplace" items={page.successChecklist} columns={2} />
              <TimelineStepGrid steps={page.adaptationTimeline} />
              <GuideCrossLink
                href={EMPLOYEE_RIGHTS_NETHERLANDS_PATH}
                title="Employee rights in the Netherlands"
                description="Pair culture adaptation with leave, sick pay and workplace protections orientation."
            ...
            <PremiumGuideSection
              ...
              tipsKey="myths"
              intro={
                <SectionIntro eyebrow="Myths" title={page.mythsHeading} fullWidth>
                  <p>Balanced explanations — culture varies by company, team and sector.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions" fullWidth>
                  <p>Use these answers to know what to observe — confirm specifics with colleagues.</p>
                </SectionIntro>
              }
            ...
            <PremiumGuideSection
              id="official-sources"
              tipsKey="officialSources"
              intro={
                <SectionIntro eyebrow="Resources" title="Career Resources" fullWidth>
                  <p>{page.officialSourcesDisclaimer}</p>
                </SectionIntro>
              }
              visual={page.visuals.officialSources}
            >
              <ChecklistBlock title="What to verify where" items={page.officialSourcesVerifyList} columns={2} />
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Career guides" title="Related Guides" fullWidth>
                  <p>Suggested order: jobs search → contract review → rights orientation.</p>
                </SectionIntro>
              }
            ...
            >
              ...
              <div className="mt-6">
                <SectionIntro eyebrow="Explore next" title="Plan the Next Step" tone="onDark" fullWidth>
                  <p>Move from culture orientation into contracts, rights, salary and community integration.</p>
                </SectionIntro>
                ...
                <div className={guidePremiumSectionDetailStackClass}>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {page.exploreNextCards.map((item, idx) => (
                      <LinkCard key={item.href} item={{ ...item, status: "live" as const }} iconIndex={idx} tone="onDark" />
                    ))}
                  </div>
                  ...
                  <GuideCrossLink
                    ...
                    description="Review offers, probation and notice periods before your first Dutch role."
