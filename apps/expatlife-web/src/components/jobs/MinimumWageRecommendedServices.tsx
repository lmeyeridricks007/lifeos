...
import { minimumWageNetherlandsPage as page } from "./minimumWageNetherlandsPageModel";
...
export function MinimumWageRecommendedServices() {
    ...
    <div className="space-y-8">
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation support for job moves</h3>
          <p className="mt-2 w-full max-w-none text-sm leading-relaxed text-foreground-muted">
            Useful when a lower-salary role still depends on housing timing, city choice or family logistics — confirm scope and fees
