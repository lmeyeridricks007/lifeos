...
import { pensionNetherlandsExpatsPage as page } from "./pensionNetherlandsExpatsPageModel";
...
export function PensionNetherlandsExpatsRecommendedServices() {
    ...
    <div className="space-y-8">
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation support alongside pension planning</h3>
