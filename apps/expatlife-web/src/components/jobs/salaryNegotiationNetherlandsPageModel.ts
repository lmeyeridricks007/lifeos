...
export const salaryNegotiationNetherlandsPage = {
  ...
  services: [
    { label: "Recruitment Agencies Netherlands", href: "/netherlands/jobs/recruitment-agencies-netherlands/", status: "comingSoon", description: "How Dutch recruiters work when offers arrive via agencies." },
    { label: "English Speaking Jobs Netherlands", href: "/netherlands/jobs/english-speaking-jobs-netherlands/", status: "comingSoon", description: "English-friendly market context while targeting offers." },
    { label: "Remote Work Netherlands", href: "/netherlands/jobs/remote-work-netherlands/", status: "comingSoon", description: "Remote and hybrid terms that affect total package talks." },
  ...
  relatedGuides: [
    { label: "Finding Jobs in the Netherlands", href: "/netherlands/jobs/finding-jobs-netherlands/", status: "live", description: "Job market channels, recruiters and sponsorship context before offers." },
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "comingSoon", description: "Dutch CV and application materials that get you to interview stage." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "comingSoon", description: "Dutch motivatiebrief norms when applications still require a letter." },
    { label: "LinkedIn Netherlands", href: "/netherlands/jobs/linkedin-netherlands/", status: "comingSoon", description: "Profile and recruiter messaging that feed the pipeline before offers." },
    { label: "Interview Tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "comingSoon", description: "Interview culture and follow-up before compensation talks begin." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "comingSoon", description: "Referrals and community outreach that often precede offer conversations." },
  ...
  exploreNextCards: [
    { label: "Interview Tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "comingSoon", description: "Interview prep before compensation talks." },
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "comingSoon", description: "Application materials that lead into offer stage." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "comingSoon", description: "Motivatiebrief norms if you are still applying in parallel." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "comingSoon", description: "Keep referrals warm while offers are in play." },
    ...
    { label: "Expat Salary", href: "/netherlands/jobs/expat-salary-netherlands/", status: "live", description: "Salary expectations for international professionals." },
  ] satisfies SalaryNegotiationNetherlandsLink[],
} as const;
