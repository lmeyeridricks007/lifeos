...
export const salaryNegotiationNetherlandsPage = {
  ...
  services: [
    { label: "Recruitment Agencies Netherlands", href: "/netherlands/jobs/recruitment-agencies-netherlands/", status: "live", description: "How Dutch recruiters work when offers arrive via agencies." },
    { label: "English Speaking Jobs Netherlands", href: "/netherlands/jobs/english-speaking-jobs-netherlands/", status: "live", description: "English-friendly market context while targeting offers." },
    { label: "Remote Work Netherlands", href: "/netherlands/jobs/remote-work-netherlands/", status: "live", description: "Remote and hybrid terms that affect total package talks." },
  ...
  relatedGuides: [
    ...
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "live", description: "Dutch CV and application materials that get you to interview stage." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "live", description: "Dutch motivatiebrief norms when applications still require a letter." },
    { label: "LinkedIn Netherlands", href: "/netherlands/jobs/linkedin-netherlands/", status: "live", description: "Profile and recruiter messaging that feed the pipeline before offers." },
    { label: "Interview Tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "live", description: "Interview culture and follow-up before compensation talks begin." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "live", description: "Referrals and community outreach that often precede offer conversations." },
  ...
  exploreNextCards: [
    { label: "Interview Tips Netherlands", href: "/netherlands/jobs/interview-tips-netherlands/", status: "live", description: "Interview prep before compensation talks." },
    { label: "CV Netherlands", href: "/netherlands/jobs/cv-netherlands/", status: "live", description: "Application materials that lead into offer stage." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "live", description: "Motivatiebrief norms if you are still applying in parallel." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "live", description: "Keep referrals warm while offers are in play." },
