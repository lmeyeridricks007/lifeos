...
export const findingJobsNetherlandsPage = {
  ...
  relatedGuides: [
    { label: "Recruitment Agencies Netherlands", href: "/netherlands/jobs/recruitment-agencies-netherlands/", status: "comingSoon", description: "How Dutch recruiters, uitzendbureaus and intermediars work for expats." },
    { label: "English Speaking Jobs Netherlands", href: "/netherlands/jobs/english-speaking-jobs-netherlands/", status: "comingSoon", description: "English-friendly sectors, cities and language reality checks." },
    ...
    { label: "CV Netherlands", href: CV_NETHERLANDS_PATH, status: "comingSoon", description: "Dutch CV, motivation letter and LinkedIn alignment for applications." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "comingSoon", description: "Dutch motivatiebrief norms when vacancies require a letter." },
    { label: "LinkedIn Netherlands", href: "/netherlands/jobs/linkedin-netherlands/", status: "comingSoon", description: "Profile, Open to Work, messaging recruiters and Dutch LinkedIn norms." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "comingSoon", description: "Events, communities, referrals and Dutch directness in professional outreach." },
    { label: "Interview Tips Netherlands", href: INTERVIEW_TIPS_NETHERLANDS_PATH, status: "comingSoon", description: "Dutch interview culture, preparation, questions and follow-up for expats." },
  ...
  services: [
    { label: "Recruitment agencies Netherlands", href: "/netherlands/jobs/recruitment-agencies-netherlands/", status: "comingSoon", description: "How Dutch recruiters and uitzendbureaus work for expats — not a services directory ranking." },
  ...
  exploreNextCards: [
    { label: "Recruitment Agencies Netherlands", href: "/netherlands/jobs/recruitment-agencies-netherlands/", status: "comingSoon", description: "Work the agency channel: uitzend, intermediars and partnership habits." },
    { label: "English Speaking Jobs Netherlands", href: "/netherlands/jobs/english-speaking-jobs-netherlands/", status: "comingSoon", description: "English-friendly market lane and language reality checks." },
    { label: "Remote Work Netherlands", href: "/netherlands/jobs/remote-work-netherlands/", status: "comingSoon", description: "Remote and hybrid employment expectations." },
    { label: "CV Netherlands", href: CV_NETHERLANDS_PATH, status: "comingSoon", description: "Localise CV, motivation letter and LinkedIn for Dutch applications." },
    { label: "Cover Letter Netherlands", href: "/netherlands/jobs/cover-letter-netherlands/", status: "comingSoon", description: "Dutch motivatiebrief when vacancies still require a letter." },
    { label: "LinkedIn Netherlands", href: "/netherlands/jobs/linkedin-netherlands/", status: "comingSoon", description: "Profile, Open to Work and recruiter messaging for Dutch hiring." },
    { label: "Networking Netherlands", href: "/netherlands/jobs/networking-netherlands/", status: "comingSoon", description: "Events, communities and referrals beyond public job boards." },
    { label: "Interview Tips Netherlands", href: INTERVIEW_TIPS_NETHERLANDS_PATH, status: "comingSoon", description: "Prepare for Dutch interview culture, questions and follow-up." },
    { label: "Salary Negotiation", href: SALARY_NEGOTIATION_NETHERLANDS_PATH, status: "live", description: "Negotiate total compensation once interviews progress." },
  ] satisfies FindingJobsLink[],
} as const;
