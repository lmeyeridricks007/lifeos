...
import { expatSalaryNetherlandsPage as page } from "./expatSalaryNetherlandsPageModel";
...
export function ExpatSalaryRecommendedServices() {
    ...
    <div className="space-y-8">
      ...
      {relocationCards.length > 0 ? (
        <div className="w-full">
          ...
          <h3 className="mt-2 text-lg font-bold tracking-tight text-foreground">Relocation support for offer evaluation</h3>
