...
export const employmentContractNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Dutch workplace culture", href: "/netherlands/jobs/dutch-workplace-culture/", status: "live", description: "Workplace norms, communication and onboarding culture for expats." },
    { label: "Contractor vs Employee", href: "/netherlands/jobs/contractor-vs-employee-netherlands/", status: "live", description: "Compare employment and contractor or ZZP models before signing." },
