...
export const ENGLISH_SPEAKING_JOBS_AFFILIATE_PLACEMENT_ID = "nl-jobs-english-speaking-jobs-support-providers" as const;

export type EnglishSpeakingJobsNetherlandsLink = {
  label: string;
  href: string;
  description?: string;
...
export type EnglishSpeakingJobsCard = { title: string; body: string };
...
const VISUAL_PREFIX = "english-speaking-jobs-netherlands";
...
export const englishSpeakingJobsNetherlandsPage = {
  slug: "english-speaking-jobs-netherlands",
  path: ENGLISH_SPEAKING_JOBS_NETHERLANDS_PATH,
  publish: true,
  publishDate: scheduledPublishDateForPath(ENGLISH_SPEAKING_JOBS_NETHERLANDS_PATH) ?? "2026-10-07",
  affiliatePlacementId: ENGLISH_SPEAKING_JOBS_AFFILIATE_PLACEMENT_ID,
  seo: {
    title: "English Speaking Jobs Netherlands | Expat Guide to English-Friendly Roles",
    description:
      "Find and evaluate English-speaking jobs in the Netherlands: sectors, cities, language reality checks and when Dutch is still needed — without fake employer rankings or job guarantees.",
    keywords: [
      ...
      "Language norms networking",
      "career networking Netherlands",
    ],
  },
  hero: {
    eyebrow: "Netherlands · Jobs · English-speaking roles",
    pageTitle: "English Speaking Jobs in the Netherlands",
    subtitle:
      "Target English-friendly Dutch roles with clear language expectations — sectors, cities, reality checks and when learning Dutch still matters for career growth.",
    primaryCta: { label: "Target English Roles", href: "#habits" },
    secondaryCta: { label: "Browse Jobs Guides", href: JOBS_HUB_PATH },
    chips: ["Sectors & cities", "Role evaluation", "Language norms", "Dutch still helps"],
    image: {
  ...
  sectionNav: [
    ...
    { href: "#communities", label: "Sectors & cities" },
    { href: "#events", label: "Language checks" },
    { href: "#referrals", label: "Evaluating roles" },
    { href: "#directness", label: "Workplace language" },
    { href: "#linkedin-channel", label: "Search channels" },
  ...
  intro: {
    heading: "How English-Speaking Jobs Work in the Netherlands",
    paragraphs: [
      "The Netherlands has a large international labour market — especially in tech, life sciences, logistics, finance, creative and headquarters roles across the Randstad and Eindhoven. English can be the working language in many teams, but English-speaking job ads still hide Dutch requirements for clients, managers or long-term growth.",
      "This guide owns the English-job market lane: where English-friendly roles concentrate, how to evaluate language reality, when Dutch still matters and how to search without false guarantees. Finding Jobs owns general multi-channel search; Recruitment Agencies owns working with recruiters; Remote Work owns remote/hybrid employment; LinkedIn and Networking own tactics.",
      "Treat English fluency as an advantage — not a promise of every vacancy, every city or every sponsorship outcome.",
    ],
    keyPoints: [
      { title: "Sector and city matter", body: "English density is higher in international hubs than in every regional Dutch employer." },
      { title: "Read the language fine print", body: "Job ads may say English while stakeholders still expect Dutch later." },
      { title: "Be honest in interviews", body: "Overclaiming Dutch fluency backfires quickly in direct Dutch culture." },
      { title: "Pair with other channels", body: "Use Finding Jobs, agencies and networking — not English boards alone." },
    ],
  ...
  snapshotCards: [
    ...
    { label: "Role evaluation", value: "Forwardable", note: "Make it easy for contacts to introduce you." },
  ...
  communitiesHeading: "Where English-Friendly Roles Concentrate",
  communitiesParagraphs: [
    "English-friendly hiring clusters around international companies, scale-ups, research institutes and HQ functions — especially in Amsterdam, Rotterdam, The Hague, Utrecht and Eindhoven. Outside those hubs, Dutch remains more common for client-facing and public-sector roles.",
    "Sectors with frequent English team languages include technology, engineering, life sciences, logistics, finance, creative agencies and some shared-service centres. Hospitality, care, education and local government often expect stronger Dutch.",
    "This is market orientation — not a ranking of employers, cities or 'guaranteed English jobs'.",
  ],
  communitiesPoints: [
    "Shortlist sectors that match your experience and English-team norms.",
    "Prioritise cities where your industry actually hires internationals.",
    "Check whether the team, clients and managers work in English day to day.",
    "Plan Dutch learning if you want broader mobility later.",
    "Pair English boards with Finding Jobs, agencies and networking.",
  ],
  communitiesRows: [
    {
  ...
  eventsHeading: "Language Reality Checks Before You Apply",
  eventsParagraphs: [
  ...
  ] satisfies EnglishSpeakingJobsCard[],
  eventsTips: [
  ...
  referralsHeading: "How to Evaluate English-Friendly Vacancies",
  referralsParagraphs: [
  ...
  directnessHeading: "English Teams Inside Dutch Workplaces",
  ...
  linkedinChannelHeading: "Search Channels for English Roles",
  ...
  habitsHeading: "A Practical English-Role Search Cadence",
  habitsParagraphs: [
  ...
  mistakesHeading: "Common Mistakes Searching English Jobs",
  mistakes: [
    {
  ...
  checklistHeading: "English-Speaking Jobs Checklist",
  checklistIntro:
  ...
  howToSchema: {
    name: "How to find English-speaking jobs in the Netherlands",
    description:
      "Step-by-step orientation for expats targeting English-friendly roles in the Netherlands.",
    anchor: "#checklist",
  },
  ...
  scenariosHeading: "Expat English-Job Scenarios",
  scenarios: [
    {
  ...
  ] satisfies EnglishSpeakingJobsNetherlandsLink[],
  ...
  hubCards: [
    ...
    },
    {
      ...
      href: RECRUITMENT_AGENCIES_NETHERLANDS_PATH,
      status: "live",
      description: "Working with Dutch recruiters and uitzendbureaus.",
    },
    {
      label: "Remote Work",
      href: REMOTE_WORK_NETHERLANDS_PATH,
  ...
  servicesNote:
    "Some links may be affiliate or referral links. Professional services may help with specific steps — they do not replace honest outreach, official IND guidance or qualified advice. This page does not rank English employers or job boards — and does not guarantee interviews or permits.",
  faq: [
    {
  ...
  exploreNextCards: [
    ...
    },
    {
      ...
      href: RECRUITMENT_AGENCIES_NETHERLANDS_PATH,
      status: "live",
      description: "Agency channel for English-friendly and sponsored roles.",
    },
    {
      label: "Remote Work Netherlands",
      href: REMOTE_WORK_NETHERLANDS_PATH,
