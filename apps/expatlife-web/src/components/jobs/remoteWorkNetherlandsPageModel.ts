...
export const REMOTE_WORK_AFFILIATE_PLACEMENT_ID = "nl-jobs-remote-work-support-providers" as const;

export type RemoteWorkNetherlandsLink = {
  label: string;
  href: string;
  description?: string;
...
export type RemoteWorkCard = { title: string; body: string };
...
const VISUAL_PREFIX = "remote-work-netherlands";
...
export const remoteWorkNetherlandsPage = {
  slug: "remote-work-netherlands",
  path: REMOTE_WORK_NETHERLANDS_PATH,
  publish: true,
  publishDate: scheduledPublishDateForPath(REMOTE_WORK_NETHERLANDS_PATH) ?? "2026-10-07",
  affiliatePlacementId: REMOTE_WORK_AFFILIATE_PLACEMENT_ID,
  seo: {
    title: "Remote Work Netherlands | Hybrid & Remote Jobs Guide for Expats",
    description:
      "Understand remote and hybrid work for expats employed in the Netherlands: employer expectations, hybrid norms, working-from-abroad caution and home-office habits — not freelancing advice.",
    keywords: [
      ...
      "Home-office habits networking",
      "career networking Netherlands",
    ],
  },
  hero: {
    eyebrow: "Netherlands · Jobs · Remote & hybrid work",
    pageTitle: "Remote Work in the Netherlands",
    subtitle:
      "Navigate remote and hybrid employment as an expat in the Netherlands — what employers expect, how hybrid usually works, and what to clarify before working from abroad.",
    primaryCta: { label: "Clarify Remote Terms", href: "#habits" },
    secondaryCta: { label: "Browse Jobs Guides", href: JOBS_HUB_PATH },
    chips: ["Remote vs hybrid", "Abroad caution", "Home-office habits", "Not freelancing"],
    image: {
  ...
  sectionNav: [
    ...
    { href: "#communities", label: "Remote vs hybrid" },
    { href: "#events", label: "Expectations" },
    { href: "#referrals", label: "Abroad caution" },
    { href: "#directness", label: "Home office" },
    { href: "#linkedin-channel", label: "Finding roles" },
  ...
  intro: {
    heading: "How Remote and Hybrid Work Works in the Netherlands",
    paragraphs: [
      "Many Dutch employers offer hybrid patterns — often a few office days plus remote days — while fully remote roles exist but are less universal than international job ads imply. For expats, remote flexibility can help relocation and focus, but contracts, tax residency, permits and team norms still matter.",
      "This guide owns remote/hybrid employment for people hired by Dutch employers (or working primarily for a Netherlands-based role): expectations, hybrid norms, working-from-abroad caution and home-office habits. Freelancing and contractor models live on Freelancing / Contractor vs Employee. English Speaking Jobs owns language-market reality; Finding Jobs owns multi-channel search.",
      "Clarify remote terms in writing before you rely on them — this page is orientation only, not tax, immigration or employment advice.",
    ],
    keyPoints: [
      { title: "Hybrid is common", body: "Ask how many office days, which locations and whether the pattern is fixed or flexible." },
      { title: "Fully remote is selective", body: "Confirm eligibility for your role, seniority and authorization status." },
      { title: "Abroad is not automatic", body: "Working from another country can trigger tax, social security and permit issues — verify with employer and advisers." },
      { title: "ZZP is a different lane", body: "Self-employed remote work belongs on Freelancing — not this employment guide." },
    ],
  ...
  snapshotCards: [
    ...
    { label: "Abroad caution", value: "Forwardable", note: "Make it easy for contacts to introduce you." },
  ...
  communitiesHeading: "Remote vs Hybrid: What Dutch Employers Usually Mean",
  communitiesParagraphs: [
    "Hybrid usually means a mix of office and home days with expectations about core hours, team ceremonies and in-person collaboration. Fully remote means little or no required office presence — confirm it in the contract and team policy, not only in the vacancy headline.",
    "Dutch employers vary widely: some teams are office-first with rare remote days; others are remote-first with quarterly onsites. Ask about desk booking, travel budget and equipment before you accept.",
    "This page covers employment remote/hybrid norms — not ZZP freelancing. Open Freelancing Netherlands for self-employed remote work.",
  ],
  communitiesPoints: [
    "Get office-day counts and locations in writing.",
    "Ask whether remote eligibility changes after probation.",
    "Clarify equipment, coworking stipends and travel for onsites.",
    "Separate employment remote terms from freelance contracting.",
    "Do not assume working from abroad is included.",
  ],
  communitiesRows: [
    {
  ...
  eventsHeading: "Employer Expectations for Remote and Hybrid Roles",
  eventsParagraphs: [
  ...
  referralsHeading: "Working From Abroad: Orientation Caution",
  referralsParagraphs: [
  ...
  directnessHeading: "Home-Office Habits That Fit Dutch Teams",
  ...
  linkedinChannelHeading: "Finding Remote Roles Without Confusing Freelancing",
  ...
  habitsHeading: "A Practical Hybrid Work Cadence",
  habitsParagraphs: [
  ...
  mistakesHeading: "Common Remote/Hybrid Mistakes for Expats",
  mistakes: [
    {
    ...
    {
      title: "Ignoring Home-office habits",
  ...
  checklistHeading: "Remote Work Checklist",
  checklistIntro:
  ...
  howToSchema: {
    name: "How to evaluate remote and hybrid work in the Netherlands",
    description:
      "Step-by-step orientation for expats evaluating remote and hybrid employment in the Netherlands.",
    anchor: "#checklist",
  },
  ...
  scenariosHeading: "Expat Remote/Hybrid Scenarios",
  scenarios: [
    {
  ...
  relatedGuides: [
    ...
    },
    {
      ...
      href: RECRUITMENT_AGENCIES_NETHERLANDS_PATH,
      status: "live",
      description: "Agency channel when remote roles are marketed via recruiters.",
    },
    {
    ...
    },
    {
      ...
      status: "live",
      description: "ZZP and freelance routes when employment remote is not the model.",
    },
    {
      label: "Starting consultancy",
      href: STARTING_CONSULTANCY_NETHERLANDS_PATH,
      status: "live",
      description: "Advisory practice setup when you leave employed remote for consultancy.",
    },
    {
  ...
  ] satisfies RemoteWorkNetherlandsLink[],
  ...
  hubCards: [
    ...
    },
    {
      ...
      href: RECRUITMENT_AGENCIES_NETHERLANDS_PATH,
      status: "live",
      description: "Working with Dutch recruiters on remote-friendly roles.",
    },
    {
      label: "English Speaking Jobs",
      href: ENGLISH_SPEAKING_JOBS_NETHERLANDS_PATH,
      status: "live",
      description: "English-friendly market lane.",
    },
    {
      label: "Freelancing Netherlands",
      href: FREELANCING_NETHERLANDS_PATH,
      status: "live",
      description: "Self-employed remote work is a different model.",
    },
  ...
  servicesNote:
    "Some links may be affiliate or referral links. Professional services may help with specific steps — they do not replace honest outreach, official IND guidance or qualified advice. This page does not rank remote-job boards or coworking spaces — and does not guarantee remote eligibility, tax outcomes or permits.",
  faq: [
    {
  ...
  exploreNextCards: [
    ...
    },
    {
      ...
      href: RECRUITMENT_AGENCIES_NETHERLANDS_PATH,
      status: "live",
      description: "Agency channel for hybrid and remote vacancies.",
    },
    {
      label: "English Speaking Jobs Netherlands",
      href: ENGLISH_SPEAKING_JOBS_NETHERLANDS_PATH,
      status: "live",
      description: "Language reality for English-friendly remote teams.",
    },
    {
      label: "Freelancing Netherlands",
      href: FREELANCING_NETHERLANDS_PATH,
      status: "live",
      description: "ZZP when you are not an employee.",
    },
    {
      label: "Contractor vs Employee",
      href: CONTRACTOR_VS_EMPLOYEE_NETHERLANDS_PATH,
      status: "live",
      description: "Compare employment vs contractor models before you choose.",
    },
