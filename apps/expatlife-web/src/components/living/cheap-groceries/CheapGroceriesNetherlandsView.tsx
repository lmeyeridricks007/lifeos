...
import {
  ...
  cheapGroceriesNetherlandsPage as page,
  type GuideLink,
...
const habitStackColumns = [
  { key: "situation", label: "Situation" },
  { key: "cheaperMove", label: "Cheaper move" },
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to a cheaper grocery week</h3>
...
function HabitStackSection({
  ...
  section: {
    ...
    intro: string;
    paragraphs: readonly string[];
    rows: ReadonlyArray<{ situation: string; cheaperMove: string; why: string; watchOut: string }>;
    cards: ReadonlyArray<{ title: string; body: string }>;
    crossLinks: readonly GuideLink[];
  };
}) {
  return (
    ...
    >
      <InfoTable
        columns={habitStackColumns}
        rows={section.rows.map((row) => ({
          situation: row.situation,
          cheaperMove: row.cheaperMove,
          why: row.why,
...
export function CheapGroceriesNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Cheap groceries", item: new URL(CHEAP_GROCERIES_NETHERLANDS_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Cheap-grocery levers at a glance" fullWidth>
                  <p>
                    Six cards cover discounters, private label, weekly offers, timing, waste reduction and student-friendly
                    tactics — deeper sections expand each lever without ranking chains or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection id="system" tipsKey="system" visual={page.visuals.system} eyebrow="Savings system" section={page.system} />
            <TacticSection
              id="discounters"
              tipsKey="discounters"
              visual={page.visuals.discounters}
              eyebrow="Discounters"
              section={page.discounters}
            />
            <TacticSection
              id="private-label"
              tipsKey="privateLabel"
              visual={page.visuals.privateLabel}
              eyebrow="Private label"
              section={page.privateLabel}
            />
            <TacticSection id="offers" tipsKey="offers" visual={page.visuals.offers} eyebrow="Weekly offers" section={page.offers} />
            <TacticSection id="timing" tipsKey="timing" visual={page.visuals.timing} eyebrow="Timing" section={page.timing} />
            <TacticSection id="waste" tipsKey="waste" visual={page.visuals.waste} eyebrow="Less waste" section={page.waste} />
            <TacticSection id="student" tipsKey="student" visual={page.visuals.student} eyebrow="Student & budget" section={page.student} />
            <HabitStackSection
              id="habit-stack"
              tipsKey="habitStack"
              visual={page.visuals.habitStack}
              eyebrow="Habit stack"
              section={page.habitStack}
            />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={CHEAP_GROCERIES_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common cheap-grocery mistakes" fullWidth>
                  <p>
                    These patterns create avoidable first-month friction — chasing every deal, skipping private label, or
                    celebrating stickers while food spoils.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Savings checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>Five practical steps for expats spending less on groceries in the Netherlands without award lists.</p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about cheap groceries in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Best supermarkets covers fit choice. Dutch covers the system primer. Shopping covers errands. This page
                    stays on money-saving tactics. Money guides place food spend in the wider budget picture.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>
                    Continue to Best or Dutch supermarket guides, Shopping & groceries, apps, payments, or money guides when
                    you need them.
                  </p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>Confirm offers, private-label ranges and coverage on retailer and consumer sources — orientation only.</p>
                </SectionIntro>
