...
const LIVING_START_HERE_INSTRUCTIONAL = getLivingStartHereInstructionalFigure("weather");
...
export function WeatherView() {
  ...
  const shareUrl = absoluteUrlFromPath(LIVING_WEATHER_PATH);
  const crumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands/", baseUrl).toString() },
    { name: LIVING_PILLAR_BREADCRUMB_LABEL, item: absoluteUrlFromPath(LIVING_SURVIVAL_GUIDE_PATH) },
    { name: "Weather & Seasons", item: absoluteUrlFromPath(LIVING_WEATHER_PATH) },
  ];
