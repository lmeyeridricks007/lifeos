...
import {
  ...
  indianSupermarketsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./indianSupermarketsNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to a Indian pantry</h3>
...
export function IndianSupermarketsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Indian supermarkets",
            item: new URL(INDIAN_SUPERMARKETS_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Indian shopping levers at a glance" fullWidth>
                  <p>
                    Six cards cover Indian toko formats, product categories, first-visit tips, aisle vs specialty, city
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={INDIAN_SUPERMARKETS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common Indian-shopping mistakes" fullWidth>
                  <p>
                    These patterns create avoidable first-month friction — expecting one mega Indian chain, buying staples only at specialty
            ...
            >
              <ChecklistBlock title="Indian shopping checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats building a Indian and Middle-Eastern pantry in the Netherlands without award
                    lists.
                  </p>
                </SectionIntro>
              }
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about Indian and Middle-Eastern specialty groceries in
                    the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    ...
                    errands. International owns the broad map. This page stays on Indian and Middle-Eastern specialty depth.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm Indian and Middle-Eastern world-food ranges, specialty hours and coverage on retailer and consumer sources — orientation only.
                  </p>
                </SectionIntro>
