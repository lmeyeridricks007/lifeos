...
export const LIVING_CLUSTER_SIBLING_LINKS_GETTING_AROUND: LivingClusterLinkItem[] = [
  ...
  },
  {
    ...
    title: "OV-chipkaart",
    description: "Personal vs anonymous cards, top-up, check-in/out, missed checkout, and when OVpay is enough.",
  ...
  },
  {
    ...
    title: "NS trains",
    description: "Ticket types (single, Flex, season), how to buy, peak orientation, and first-week NS commute tips.",
    cta: "Open NS trains",
  },
  {
    href: "/netherlands/living/trams-netherlands/",
    title: "Trams",
    description: "City tram travel for expats: how to ride, check-in/out, etiquette, and when tram beats bus or metro.",
    cta: "Open Trams",
  },
  {
    href: "/netherlands/living/metro-netherlands/",
    title: "Metro",
    description: "Amsterdam and Rotterdam metro orientation: tickets, peak tips, NS interchange, and when metro wins.",
    cta: "Open Metro",
  },
  {
    href: "/netherlands/living/regional-buses-netherlands/",
  ...
  },
  {
    ...
    cta: "Open Bike sharing",
  },
  {
    href: "/netherlands/living/train-discounts-netherlands/",
    title: "Train discounts",
    description: "NS discount products: Dal Voordeel, Weekend Voordeel, Flex orientation, and when a discount beats PAYG.",
    cta: "Open Train discounts",
  },
  {
    href: "/netherlands/living/weekend-travel-netherlands/",
    title: "Weekend travel",
    description: "Day trips and weekends by NS and regional OV: planning, tickets, last mile and packing tips.",
    cta: "Open Weekend travel",
  },
  {
    href: "/netherlands/living/driving-licence-exchange-netherlands/",
    title: "Driving licence exchange",
    description: "Foreign licence validity and Dutch rijbewijs exchange when car ownership enters the picture.",
    cta: "Open licence exchange",
  },
  {
    href: "/netherlands/living/buying-a-car-netherlands/",
    title: "Buying a car",
    description: "Used or new purchase orientation: BPM/tax, RDW, insurance, APK and ownership costs for expats.",
    cta: "Open buying a car",
  },
  {
    href: "/netherlands/living/road-tax-netherlands/",
    title: "Road tax",
    description: "Wegenbelasting / MRB orientation: who pays, weight/fuel/province factors, and how to check and pay.",
    cta: "Open road tax",
  },
  {
    href: "/netherlands/living/car-insurance-netherlands/",
    title: "Car insurance",
    description: "Mandatory WA, WA+ vs all-risk, what to compare, and how cover ties to RDW registration.",
    cta: "Open car insurance",
  },
  {
    href: "/netherlands/living/mot-apk-netherlands/",
    title: "MOT / APK",
    description: "Dutch vehicle inspection: when due, how to book RDW-approved stations, and pass/fail orientation.",
    cta: "Open MOT / APK",
  },
  {
    href: "/netherlands/living/speed-cameras-netherlands/",
    title: "Speed cameras",
    description: "Speed cameras, trajectcontrole and fine orientation for drivers in the Netherlands.",
    cta: "Open speed cameras",
  },
  {
    href: "/netherlands/living/electric-vehicles-netherlands/",
    title: "Electric vehicles",
    description: "Buying and using EVs: home and public charging, tax orientation, range and ownership notes.",
    cta: "Open electric vehicles",
  },
  {
    href: "/netherlands/living/car-sharing-netherlands/",
    title: "Car sharing",
    description: "When sharing beats owning: membership models, trip flow and cost orientation vs ownership.",
    cta: "Open car sharing",
  },
  {
    href: "/netherlands/living/lease-cars-netherlands/",
    title: "Lease cars",
    description: "Private lease, operational lease and company-car orientation for expats.",
    cta: "Open lease cars",
  },
  {
    href: "/netherlands/practical-life/parking-and-local-permits-netherlands/",
    title: "Parking & local permits",
    description: "Resident permits, visitor codes, paid zones and parking apps once you drive locally.",
    cta: "Open parking guides",
  },
  {
    href: LIVING_ESSENTIAL_APPS_PATH,
    title: "Essential apps",
