...
import {
  ...
  ovpayNetherlandsPage as page,
  type TransportLink,
  type MistakeCard as MistakeCardData,
} from "./ovpayNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four habits for OVpay</h3>
...
export function OvpayNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "OVpay", item: new URL(OVPAY_NETHERLANDS_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="OVpay at a glance" fullWidth>
                  <p>
                    Six cards cover what OVpay is, how contactless works, check-in/out, caps, when a chipkaart still helps,
                    and common mistakes — deeper sections expand each theme without product advice.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Contactless" title={page.howItWorks.heading} fullWidth>
            ...
            >
              <div className={guidePremiumCardGridClass(page.howItWorks.steps.length)}>
              ...
              <InfoTable
                columns={compareColumns}
                rows={page.howItWorks.rows.map((row) => ({
                  topic: row.topic,
                  whatToCheck: row.whatToCheck,
                  tip: row.tip,
                }))}
              />
              <div className={guidePremiumCardGridClass(page.howItWorks.cards.length)}>
                {page.howItWorks.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <div className={guidePremiumCardGridClass(page.howItWorks.crossLinks.length)}>
                {page.howItWorks.crossLinks.map((item, idx) => (
                  <LinkCard key={`${item.href}-${item.label}`} item={item} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              id="caps-products"
              tipsKey="capsProducts"
              visual={page.visuals.capsProducts}
              intro={
                <SectionIntro eyebrow="Caps" title={page.capsProducts.heading} fullWidth>
                  <p>{page.capsProducts.intro}</p>
                  {page.capsProducts.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                columns={compareColumns}
                rows={page.capsProducts.rows.map((row) => ({
                  topic: row.topic,
                  whatToCheck: row.whatToCheck,
                  tip: row.tip,
                }))}
              />
              <div className={guidePremiumCardGridClass(page.capsProducts.cards.length)}>
                {page.capsProducts.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <div className={guidePremiumCardGridClass(page.capsProducts.crossLinks.length)}>
                {page.capsProducts.crossLinks.map((item, idx) => (
                  <LinkCard key={`${item.href}-${item.label}`} item={item} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              id="vs-chipkaart"
              tipsKey="vsChipkaart"
              visual={page.visuals.vsChipkaart}
              intro={
                <SectionIntro eyebrow="Compare" title={page.vsChipkaart.heading} fullWidth>
                  <p>{page.vsChipkaart.intro}</p>
                  {page.vsChipkaart.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                columns={compareColumns}
                rows={page.vsChipkaart.rows.map((row) => ({
                  topic: row.topic,
                  whatToCheck: row.whatToCheck,
                  tip: row.tip,
                }))}
              />
              <div className={guidePremiumCardGridClass(page.vsChipkaart.cards.length)}>
                {page.vsChipkaart.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <div className={guidePremiumCardGridClass(page.vsChipkaart.crossLinks.length)}>
                {page.vsChipkaart.crossLinks.map((item, idx) => (
                  <LinkCard key={`${item.href}-${item.label}`} item={item} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={OVPAY_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common OVpay mistakes" fullWidth>
                  <p>
                    These patterns create avoidable stress — missed checkouts, mixing methods mid-leg, assuming every foreign
                    card works, or ignoring chipkaart when you need products. Official OVpay terms beat forum folklore.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="OVpay readiness checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>Five orientation steps for expats starting OVpay contactless travel calmly in the Netherlands.</p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about OVpay in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and transport guides" fullWidth>
                  <p>
                    Getting around covers multimodal mobility. OV-chipkaart covers personal travel cards. NS trains covers rail
                    products — this page stays on contactless OVpay travel.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Hub" title="Public transport cluster hub" fullWidth>
                  <p>
                    Stay inside the public transport cluster — OVpay, OV-chipkaart, NS trains and Getting around — with light
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>Continue to OV-chipkaart, NS trains, Getting around, or light driving options when you need them.</p>
                </SectionIntro>
              }
            >
