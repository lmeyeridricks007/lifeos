...
import {
  ...
  internationalSupermarketsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./internationalSupermarketsNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to an international pantry</h3>
...
export function InternationalSupermarketsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "International supermarkets",
            item: new URL(INTERNATIONAL_SUPERMARKETS_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="International sourcing levers at a glance" fullWidth>
                  <p>
                    Six cards cover world-food aisles, specialty markets, neighbourhood shops, pantry must-haves, city
                    routes and delivery — deeper sections expand each lever without ranking stores or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection id="system" tipsKey="system" visual={page.visuals.system} eyebrow="Sourcing map" section={page.system} />
            <TacticSection id="aisles" tipsKey="aisles" visual={page.visuals.aisles} eyebrow="World-food aisles" section={page.aisles} />
            <TacticSection
              id="specialty"
              tipsKey="specialty"
              visual={page.visuals.specialty}
              eyebrow="Specialty markets"
              section={page.specialty}
            />
            <DecisionSection
              id="decision"
              tipsKey="decision"
            ...
            />
            <TacticSection id="pantry" tipsKey="pantry" visual={page.visuals.pantry} eyebrow="Pantry gaps" section={page.pantry} />
            <TacticSection
              id="neighbourhood"
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={INTERNATIONAL_SUPERMARKETS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common international-sourcing mistakes" fullWidth>
                  <p>
                    These patterns create avoidable first-month friction — expecting one mega-store, skipping specialty
                    when aisles are shallow, or buying everything at specialty prices.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Sourcing checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats building an international pantry in the Netherlands without award
                    lists.
                  </p>
                </SectionIntro>
              }
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about international and specialty groceries in
                    the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    ...
                    errands. This page stays on international product sourcing.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm world-food ranges, hours and coverage on retailer and consumer sources — orientation only.
                  </p>
                </SectionIntro>
