...
import {
  ...
  asianSupermarketsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./asianSupermarketsNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to an Asian pantry</h3>
...
export function AsianSupermarketsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Asian supermarkets",
            item: new URL(ASIAN_SUPERMARKETS_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Asian shopping levers at a glance" fullWidth>
                  <p>
                    Six cards cover toko formats, product categories, first-visit tips, aisle vs specialty, city
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={ASIAN_SUPERMARKETS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common Asian-shopping mistakes" fullWidth>
                  <p>
                    These patterns create avoidable first-month friction — expecting one mega Asian chain, buying staples only at toko prices
                    or overbuying produce without a cooking plan.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Asian shopping checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats building an Asian pantry in the Netherlands without award
                    lists.
                  </p>
                </SectionIntro>
              }
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about Asian toko and specialty groceries in
                    the Netherlands.
                  </p>
                </SectionIntro>
              </div>
            ...
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm Asian world-food ranges, specialty hours and coverage on retailer and consumer sources — orientation only.
                  </p>
                </SectionIntro>
