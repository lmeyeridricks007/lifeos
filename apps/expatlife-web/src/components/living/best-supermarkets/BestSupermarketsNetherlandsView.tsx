...
import {
  ...
  bestSupermarketsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./bestSupermarketsNetherlandsPageModel";
...
const comparisonColumns = [
  ...
  { key: "betterFit", label: "Better fit" },
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to choose a supermarket fit</h3>
...
function FitSection({
  ...
  section: {
    ...
    rows: ReadonlyArray<{ priority: string; whatToLookFor: string; tip: string }>;
...
function ComparisonFitSection({
  ...
  section: {
    ...
    intro: string;
    paragraphs: readonly string[];
    rows: ReadonlyArray<{ situation: string; betterFit: string; why: string; watchOut: string }>;
    cards: ReadonlyArray<{ title: string; body: string }>;
    crossLinks: readonly GuideLink[];
  };
}) {
...
export function BestSupermarketsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Best supermarkets", item: new URL(BEST_SUPERMARKETS_NETHERLANDS_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Best-fit choice axes at a glance" fullWidth>
                  <p>
                    Six cards cover budget, organic, international products, one-stop weekly shops, neighbourhood convenience
                    and delivery — deeper sections expand each axis without ranking chains or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <FitSection id="decision" tipsKey="decision" visual={page.visuals.decision} eyebrow="Decision" section={page.decision} />
            <ComparisonFitSection id="budget" tipsKey="budget" visual={page.visuals.budget} eyebrow="Budget" section={page.budget} />
            <FitSection id="organic" tipsKey="organic" visual={page.visuals.organic} eyebrow="Organic" section={page.organic} />
            <ComparisonFitSection
              id="international"
              tipsKey="international"
              visual={page.visuals.international}
              eyebrow="International"
              section={page.international}
            />
            <FitSection id="one-stop" tipsKey="oneStop" visual={page.visuals.oneStop} eyebrow="One-stop" section={page.oneStop} />
            <ComparisonFitSection
              id="neighbourhood"
              tipsKey="neighbourhood"
              visual={page.visuals.neighbourhood}
              eyebrow="Neighbourhood"
              section={page.neighbourhood}
            />
            <FitSection id="delivery" tipsKey="delivery" visual={page.visuals.delivery} eyebrow="Delivery" section={page.delivery} />
            <ComparisonFitSection
              id="comparison"
              tipsKey="comparison"
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={BEST_SUPERMARKETS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            >
              <ScenarioTable title="Match your household story" rows={page.scenarios.rows} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common supermarket-choice mistakes" fullWidth>
                  <p>
                    These patterns create avoidable first-month friction — chasing fake rankings, ignoring branch size, or
                    expecting one chain to cover every priority.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Choice checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>Five decision steps for expats picking a supermarket fit in the Netherlands without award lists.</p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about choosing a supermarket in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Dutch supermarkets covers the system primer. Shopping & groceries covers errands and self-checkout how-to.
                    This page stays on choosing among fits. Money guides place food spend in the wider budget picture.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>Continue to Dutch supermarkets, Shopping & groceries, apps, payments, or money guides when you need them.</p>
                </SectionIntro>
              }
            >
