...
import {
  ...
  tippingNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./tippingNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to a calm food-delivery trial</h3>
...
export function TippingNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Tipping",
            item: new URL(TIPPING_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Tipping levers at a glance" fullWidth>
                  <p>
                    Six cards cover culture baseline, restaurants and cafés, amounts, methods, delivery prompts and everyday service — deeper sections expand each lever without ranking tip apps or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection
              ...
              eyebrow="Culture baseline"
              section={page.culture}
            />
            <TacticSection
              id="restaurants-cafes"
              tipsKey="restaurants"
              visual={page.visuals.restaurants}
              eyebrow="Restaurants & cafés"
              section={page.restaurantsCafes}
            />
            <TacticSection id="amounts" tipsKey="amounts" visual={page.visuals.amounts} eyebrow="How much" section={page.amounts} />
            <TacticSection id="methods" tipsKey="methods" visual={page.visuals.methods} eyebrow="How to tip" section={page.methods} />
            <TacticSection id="delivery" tipsKey="delivery" visual={page.visuals.delivery} eyebrow="Delivery apps" section={page.delivery} />
            <TacticSection id="everyday" tipsKey="everyday" visual={page.visuals.everyday} eyebrow="Everyday service" section={page.everyday} />
            <DecisionSection
              id="when-to-tip"
              tipsKey="whenToTip"
              visual={page.visuals.whenToTip}
              eyebrow="When tipping matters"
              section={page.whenToTip}
            />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={TIPPING_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            >
              <ScenarioTable title="Match your week story" rows={page.scenarios.rows} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common tipping mistakes" fullWidth>
                  <p>
                    These patterns create avoidable friction — US-style percentages, double tipping, fee confusion, tip anxiety on tiny bills, or chasing fake tip-app rankings.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="First tipping checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats building a calm Dutch tipping habit without mandatory US-style scripts or tip-app awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about tipping in the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Restaurants covers sit-down culture. Food delivery covers apps and fees. Meal kits covers subscription boxes. Cheap covers saving. Specialty guides own homeland ingredients. This page stays on tipping etiquette.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>
                    Continue to Restaurants, Food delivery, Meal kits, Cheap, Payments, Cash vs card, apps, or money guides when you need them.
                  </p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Sources and verification" tone="onDark" fullWidth>
                  <p>
                    Confirm tip screens, service charges and checkout wording with each venue or app — orientation only.
                  </p>
                </SectionIntro>
