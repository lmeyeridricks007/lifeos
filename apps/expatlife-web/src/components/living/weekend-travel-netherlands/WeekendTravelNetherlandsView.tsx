...
import {
  ...
  weekendTravelNetherlandsPage as page,
  type TransportLink,
  type MistakeCard as MistakeCardData,
} from "./weekendTravelNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four habits for Weekend travel</h3>
...
export function WeekendTravelNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Weekend travel", item: new URL(WEEKEND_TRAVEL_NETHERLANDS_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Weekend travel at a glance" fullWidth>
                  <p>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Planning" title={page.products.heading} fullWidth>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Tickets & discounts" title={page.chipkaart.heading} fullWidth>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Last mile" title={page.decide.heading} fullWidth>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Packing" title={page.student.heading} fullWidth>
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={WEEKEND_TRAVEL_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            >
              <ChecklistBlock title="Weekend travel readiness checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about weekend travel in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Hub" title="Active mobility and public transport hub" fullWidth>
                  <p>
                    Stay inside the cluster — Weekend travel, NS trains, Weekend travel, Getting around, OVpay,
