...
import {
  ...
  restaurantsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./restaurantsNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to a calm restaurant trial</h3>
...
export function RestaurantsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Restaurants",
            item: new URL(RESTAURANTS_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Restaurant dining levers at a glance" fullWidth>
                  <p>
                    Six cards cover reservations, lunch vs dinner, terraces, bills, dietary norms and expectations — deeper sections expand each lever without ranking restaurants or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection
              id="reservations"
              tipsKey="reservations"
              visual={page.visuals.reservations}
              eyebrow="Reservations"
              section={page.reservations}
            />
            <TacticSection
              id="lunch-dinner"
              tipsKey="lunchDinner"
              visual={page.visuals.lunchDinner}
              eyebrow="Lunch vs dinner"
              section={page.lunchDinner}
            />
            <TacticSection
              id="terraces"
              tipsKey="terraces"
              visual={page.visuals.terraces}
              eyebrow="Terraces"
              section={page.terraces}
            />
            <TacticSection id="bills" tipsKey="bills" visual={page.visuals.bills} eyebrow="Bills & service" section={page.bills} />
            <TacticSection
              id="dietary"
              tipsKey="dietary"
              visual={page.visuals.dietary}
              eyebrow="Dietary norms"
              section={page.dietary}
            />
            <TacticSection
              id="expectations"
              ...
              section={page.expectations}
            />
            <TacticSection id="tipping" tipsKey="tipping" visual={page.visuals.tipping} eyebrow="Tipping (short)" section={page.tipping} />
            <DecisionSection
              id="when-to-dine"
              tipsKey="whenToDine"
              visual={page.visuals.whenToDine}
              eyebrow="When to dine out"
              section={page.whenToDine}
            />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={RESTAURANTS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common restaurant dining mistakes" fullWidth>
                  <p>
                    These patterns create avoidable friction — skipped reservations, wrong meal timing, tip confusion, waiting for the bill, or mixing sit-down culture with takeaway apps.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="First dining-out checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats trialling sit-down dining in the Netherlands without award lists.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about restaurants and dining out in the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Food delivery covers takeaway apps. Tipping covers tip depth. Meal kits covers subscription boxes. Cheap covers saving. Specialty guides own homeland ingredients. This page stays on sit-down dining culture.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>
                    Continue to Food delivery, Tipping, Meal kits, Cheap, payments, apps, or money guides when you need them.
                  </p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm hours, reservation rules and payment habits with venues and consumer sources — orientation only.
                  </p>
                </SectionIntro>
