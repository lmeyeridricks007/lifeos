...
import {
  ...
  mealKitsNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./mealKitsNetherlandsPageModel";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four steps to a calm meal-kit trial</h3>
...
export function MealKitsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Meal kits",
            item: new URL(MEAL_KITS_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Meal-kit levers at a glance" fullWidth>
                  <p>
                    Six cards cover how kits work, box types, delivery cadence, cost modelling, who they suit and pause habits — deeper sections expand each lever without ranking meal-kit brands or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection
              id="how-they-work"
              tipsKey="howTheyWork"
              visual={page.visuals.howTheyWork}
              eyebrow="How kits work"
              section={page.howTheyWork}
            />
            <TacticSection id="box-types" tipsKey="boxTypes" visual={page.visuals.boxTypes} eyebrow="Box types" section={page.boxTypes} />
            <TacticSection id="delivery" tipsKey="delivery" visual={page.visuals.delivery} eyebrow="Delivery cadence" section={page.delivery} />
            <TacticSection id="cost" tipsKey="cost" visual={page.visuals.cost} eyebrow="Cost modelling" section={page.cost} />
            <DecisionSection
              id="who-suits"
              tipsKey="whoSuits"
              visual={page.visuals.whoSuits}
              eyebrow="Who they suit"
              section={page.whoSuits}
            />
            <TacticSection
              id="pause-cancel"
              tipsKey="pauseCancel"
              visual={page.visuals.pauseCancel}
              eyebrow="Pause & cancel"
              section={page.pauseCancel}
            />
            <TacticSection id="waste" tipsKey="waste" visual={page.visuals.waste} eyebrow="Servings & waste" section={page.waste} />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={MEAL_KITS_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common meal-kit mistakes" fullWidth>
                  <p>
                    These patterns create avoidable friction — missing skip deadlines, comparing promo prices only, treating kits as all groceries, or ignoring fridge and handoff reality.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="First-box meal-kit checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats trialling meal-kit subscriptions in the Netherlands without award lists.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about meal-kit subscriptions in the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Cheap covers saving tactics. Best covers supermarket fit. Dutch covers the system primer. Shopping covers errands. Specialty guides own homeland ingredients. This page stays on meal-kit subscriptions.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>
                    Continue to Cheap, Best, Dutch, Shopping, specialty, apps, payments, or money guides when you need them.
                  </p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm meal-kit plans, prices, delivery windows and pause rules on provider and consumer sources — orientation only.
                  </p>
                </SectionIntro>
