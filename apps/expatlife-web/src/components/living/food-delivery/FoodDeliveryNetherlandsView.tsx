...
import {
  ...
  foodDeliveryNetherlandsPage as page,
  type GuideLink,
  type MistakeCard as MistakeCardData,
} from "./foodDeliveryNetherlandsPageModel";
...
export function FoodDeliveryNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          {
            name: "Food delivery",
            item: new URL(FOOD_DELIVERY_NETHERLANDS_PATH, baseUrl).toString(),
          },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Food-delivery levers at a glance" fullWidth>
                  <p>
                    Six cards cover takeaway apps, grocery delivery, fees, tipping, coverage and when to use delivery — deeper sections expand each lever without ranking delivery apps or inventing awards.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <TacticSection
              ...
              tipsKey="restaurantPlatforms"
              visual={page.visuals.restaurantPlatforms}
              eyebrow="Takeaway apps"
              section={page.restaurantPlatforms}
            />
            <TacticSection
              id="grocery-delivery"
              tipsKey="groceryDelivery"
              visual={page.visuals.groceryDelivery}
              eyebrow="Grocery delivery"
              section={page.groceryDelivery}
            />
            <TacticSection id="fees" tipsKey="fees" visual={page.visuals.fees} eyebrow="Fees & minimums" section={page.fees} />
            <TacticSection id="tipping" tipsKey="tipping" visual={page.visuals.tipping} eyebrow="Tipping norms" section={page.tipping} />
            <DecisionSection
              id="when-to-use"
              tipsKey="whenToUse"
              visual={page.visuals.whenToUse}
              eyebrow="When to use"
              section={page.whenToUse}
            />
            <TacticSection
              id="coverage"
              tipsKey="coverage"
            ...
            />
            <TacticSection id="payments" tipsKey="payments" visual={page.visuals.payments} eyebrow="Payments" section={page.payments} />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={FOOD_DELIVERY_NETHERLANDS_PATH}
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common food-delivery mistakes" fullWidth>
                  <p>
                    These patterns create avoidable friction — fee blindness, tip confusion, over-ordering, skipping postcode checks, or treating takeaway as all groceries.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="First-order food-delivery checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>
                    Five practical steps for expats trialling restaurant takeaway and grocery delivery in the Netherlands without award lists.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>
                    Short answers for the searches expats ask most often about food delivery in the Netherlands.
                  </p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related living and money guides" fullWidth>
                  <p>
                    Meal kits covers subscription boxes. Cheap covers saving tactics. Best covers supermarket fit. Dutch covers the system primer. Shopping covers errands. Specialty guides own homeland ingredients. This page stays on takeaway apps and grocery delivery.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>
                    Continue to Meal kits, Cheap, Best, Dutch, Shopping, specialty, apps, payments, or money guides when you need them.
                  </p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official and retailer sources" tone="onDark" fullWidth>
                  <p>
                    Confirm coverage, fees, tip prompts and delivery terms on provider and consumer sources — orientation only.
                  </p>
                </SectionIntro>
