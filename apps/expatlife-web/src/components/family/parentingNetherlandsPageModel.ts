...
export const parentingNetherlandsPage = {
  ...
  healthcare: {
    ...
    links: [
      { label: "Healthcare for Children", href: HEALTHCARE_FOR_CHILDREN_PATH, status: "live", description: "Dedicated guide to GP, JGZ, vaccinations and dental care for children." },
