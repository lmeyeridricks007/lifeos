...
import {
  PETS_NETHERLANDS_PATH,
  petsNetherlandsPage as page,
  type MistakeCard as MistakeCardData,
  type PetsLink,
} from "./petsNetherlandsPageModel";
...
const iconPool = [PawPrint, Home, Stethoscope, ClipboardList, Trees, Wallet, MapPin, Phone, ShieldCheck] as const;
const snapshotIcons = [Home, ClipboardList, Stethoscope, Trees] as const;
const orientationIcons = [Home, ClipboardList, Stethoscope, Trees] as const;
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four habits for pet life after arrival</h3>
...
export function PetsNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Pets", item: absoluteUrlFromPath(PETS_NETHERLANDS_PATH) },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            >
              ...
              <ChecklistBlock title="Pet file checklist" items={page.petFileChecklist} columns={2} />
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Pets at a glance" fullWidth>
                  <p>
                    Six cards cover housing permission, identification, local vet care, insurance orientation, public
                    etiquette and everyday costs — deeper sections expand each theme without veterinary advice.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Housing" title={page.housing.heading} fullWidth>
                  <p>{page.housing.intro}</p>
                  {page.housing.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                ...
                rows={page.housing.rows.map((row) => ({
                  topic: row.topic,
            ...
            <PremiumGuideSection
              ...
              tipsKey="chipRegistration"
              visual={page.visuals.chipRegistration}
              intro={
                <SectionIntro eyebrow="Identification" title={page.chipRegistration.heading} fullWidth>
                  <p>{page.chipRegistration.intro}</p>
                  {page.chipRegistration.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <div className={guidePremiumCardGridClass(page.chipRegistration.cards.length)}>
                {page.chipRegistration.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <BulletPanel title="ID tips" items={page.chipRegistration.tips} />
            </PremiumGuideSection>

            <PremiumGuideSection
              id="vet"
              tipsKey="vet"
              visual={page.visuals.vet}
              intro={
                <SectionIntro eyebrow="Care" title={page.vet.heading} fullWidth>
                  <p>{page.vet.intro}</p>
                  {page.vet.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                columns={compareColumns}
                rows={page.vet.rows.map((row) => ({
                  topic: row.topic,
                  whatToCheck: row.whatToCheck,
                  tip: row.tip,
                }))}
              />
              <div className={guidePremiumCardGridClass(page.vet.cards.length)}>
                {page.vet.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <BulletPanel title="Vet tips" items={page.vet.tips} />
            </PremiumGuideSection>
            ...
            >
              <InfoTable
                columns={costColumns}
                rows={page.insurance.premiumRows.map((row) => ({
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Public space" title={page.parks.heading} fullWidth>
                  <p>{page.parks.intro}</p>
                  {page.parks.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              ...
              <BulletPanel title="Etiquette tips" items={page.parks.tips} />
            ...
            <section id={page.recommendedOptions.sectionId} className={sectionClass}>
              ...
              <div className={guidePremiumSectionDetailStackClass}>
                <BankingRecommendedOptionsSection
                  ...
                  utmReferrerPath={PETS_NETHERLANDS_PATH}
                  surfaceTone="muted"
                />
              </div>
            </section>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common pet-life mistakes" fullWidth>
                  <p>These patterns create avoidable stress — written housing permission and a local vet beat last-minute improvisation.</p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Pet life readiness checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>Five orientation steps for expats setting up everyday pet life after arriving in the Netherlands.</p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about living with pets in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              visual={page.visuals.intro}
              intro={
                <SectionIntro eyebrow="Related" title="Related family, housing and move guides" fullWidth>
                  <p>
                    Bringing pets owns import paperwork. Giving birth is the family cluster sibling. Parenting, family
                    activities and renting deepen everyday life around pets.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Hub" title="Family hub cards" fullWidth>
                  <p>Stay inside the family cluster — pets, giving birth, parenting and activities — plus the Bring pets move guide.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next practical step" tone="onDark" fullWidth>
                  <p>Continue to import paperwork, the giving-birth sibling, parenting culture, renting or family outings.</p>
                </SectionIntro>
              }
            >
              ...
              <div id="sources" className="mt-8 space-y-6">
                <SectionIntro eyebrow="Trust" title="Official sources" tone="onDark" fullWidth>
                  <p>Confirm clinical care with your veterinarian and lease rules with your landlord — these sources are orientation only.</p>
                </SectionIntro>
