...
import {
  PREGNANCY_NETHERLANDS_PATH,
  pregnancyNetherlandsPage as page,
  type PregnancyLink,
  type MistakeCard as MistakeCardData,
} from "./pregnancyNetherlandsPageModel";
...
const snapshotIcons = [HeartPulse, ClipboardList, ShieldCheck, Baby] as const;
const orientationIcons = [Phone, ClipboardList, ShieldCheck, MapPin] as const;
...
function DecisionFlowStrip({ labels, eyebrow = "Pregnancy" }: { labels: readonly string[]; eyebrow?: string }) {
  return (
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four habits for the prenatal journey</h3>
...
export function PregnancyNetherlandsView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Pregnancy", item: absoluteUrlFromPath(PREGNANCY_NETHERLANDS_PATH) },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            >
              ...
              <ChecklistBlock title="Pregnancy file checklist" items={page.safetyFileChecklist} columns={2} />
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Pregnancy at a glance" fullWidth>
                  <p>
                    Six cards cover midwife finding, trimester checkpoints, BSN timing, insurance basics, what to
                    prepare and companion guides — deeper sections expand each theme without medical advice.
                  </p>
                </SectionIntro>
              }
            >
            ...
            >
              <div className={guidePremiumCardGridClass(page.midwife.cards.length)}>
                {page.midwife.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <ChecklistBlock title="Midwife registration checklist" items={page.midwife.checklist} columns={2} />
              <div className={guidePremiumCardGridClass(page.midwife.crossLinks.length)}>
                {page.midwife.crossLinks.map((item, idx) => (
            ...
            <PremiumGuideSection
              id="trimesters"
              tipsKey="trimesters"
              visual={page.visuals.trimesters}
              intro={
                <SectionIntro eyebrow="Checkpoints" title={page.trimesters.heading} fullWidth>
                  <p>{page.trimesters.intro}</p>
                  {page.trimesters.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                ...
                rows={page.trimesters.rows.map((row) => ({
              ...
              />
              <DecisionFlowStrip labels={page.trimesters.flowLabels} eyebrow="Prenatal flow" />
              <Timeline steps={page.trimesters.timeline} eyebrow="Stage" />
              <aside
                className={cn(
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-amber-950">
                  Use the contacts your midwife gave you for urgent pregnancy concerns. Call 112 for life-threatening
                  emergencies. This page does not list clinical symptom advice.
                </p>
              </aside>
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Admin" title={page.registration.heading} fullWidth>
            ...
            >
              ...
              <BulletPanel title="Registration tips" items={page.registration.tips} />
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Cover" title={page.insurance.heading} fullWidth>
            ...
            >
              ...
              <BulletPanel title="Insurance tips" items={page.insurance.tips} />
            ...
            <PremiumGuideSection
              id="prepare"
              tipsKey="prepare"
              visual={page.visuals.prepare}
              intro={
                <SectionIntro eyebrow="Prepare" title={page.prepare.heading} fullWidth>
                  <p>{page.prepare.intro}</p>
                  {page.prepare.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <InfoTable
                ...
                rows={page.prepare.rows.map((row) => ({
                  item: row.item,
                  why: row.why,
                  when: row.when,
                }))}
              />
              <div className={guidePremiumCardGridClass(page.prepare.cards.length)}>
                {page.prepare.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <div className={guidePremiumCardGridClass(page.prepare.crossLinks.length)}>
                {page.prepare.crossLinks.map((item, idx) => (
                  <LinkCard key={`${item.href}-${item.label}`} item={item} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Differences" title={page.differences.heading} fullWidth>
                  ...
                  {page.differences.paragraphs.map((paragraph) => (
                    <p key={paragraph.slice(0, 48)}>{paragraph}</p>
                  ))}
                </SectionIntro>
              }
            >
              <div className={guidePremiumCardGridClass(page.differences.cards.length)}>
                {page.differences.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            >
              <ScenarioTable title="Match your starting point" rows={page.scenarios.rows} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title="Common pregnancy orientation mistakes" fullWidth>
                  <p>These patterns create avoidable stress — early midwife contact and calm admin beat last-minute improvisation.</p>
                </SectionIntro>
              }
            >
            ...
            >
              <ChecklistBlock title="Pregnancy readiness checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="How-to" title={page.howTo.heading} fullWidth>
                  <p>Five orientation steps for expats starting prenatal care with a Dutch midwife practice.</p>
                </SectionIntro>
              }
            >
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about pregnancy in the Netherlands.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related family and health guides" fullWidth>
                  <p>
                    Maternity care is the required system companion. Family activities is the cluster leisure sibling.
                    Giving birth continues labour-day detail.
                  </p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Hub" title="Family hub cards" fullWidth>
                  <p>Stay inside the family cluster — pregnancy, family activities, maternity care, giving birth, parenting and children’s healthcare.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next family step" tone="onDark" fullWidth>
                  <p>Continue to maternity pathways, birth day, family activities, children’s healthcare or insurance comparison.</p>
                </SectionIntro>
              }
            >
