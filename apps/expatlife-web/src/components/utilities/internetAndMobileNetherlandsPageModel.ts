...
export const internetAndMobileNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "live", description: "Services directory for fibre, cable and DSL ISP comparison — who to compare, not setup how-to." },
  ...
  exploreNextCards: [
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "live", description: "Compare fibre, cable and DSL ISPs after you understand setup steps." },
    { label: "Phone providers", href: "/netherlands/services/phone-providers/", status: "live", description: "Compare prepaid, SIM-only and eSIM plans for a local number." },
    ...
    { label: "Energy providers", href: "/netherlands/services/energy-providers/", status: "live", description: "Compare electricity and gas suppliers in the Connectivity directories." },
