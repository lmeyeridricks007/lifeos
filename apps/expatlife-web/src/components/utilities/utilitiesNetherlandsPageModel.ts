...
export const utilitiesNetherlandsPage = {
  ...
  exploreNextCards: [
    { label: "Renting in the Netherlands", href: RENTING_NETHERLANDS_PATH, status: "comingSoon", description: "Check utilities, service costs and included bills before signing." },
    ...
    { label: "Dutch Cities", href: CITIES_HUB_PATH, status: "live", description: "Understand local housing and municipality differences." },
  ...
  futureExpansion: [
    ...
    "/netherlands/utilities/internet-providers-netherlands/",
    "/netherlands/utilities/mobile-providers-netherlands/",
    "/netherlands/utilities/water-netherlands/",
    "/netherlands/utilities/energy-providers-netherlands/",
  ],
};
