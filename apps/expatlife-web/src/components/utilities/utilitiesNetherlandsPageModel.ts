...
export const utilitiesNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "comingSoon", description: "Services directory for fibre, cable and DSL ISP comparison." },
    { label: "Energy providers", href: "/netherlands/services/energy-providers/", status: "comingSoon", description: "Services directory for electricity and gas supplier comparison." },
    { label: "Phone providers", href: "/netherlands/services/phone-providers/", status: "comingSoon", description: "Services directory for prepaid, SIM-only and eSIM plan discovery." },
  ...
  exploreNextCards: [
    { label: "Energy providers", href: "/netherlands/services/energy-providers/", status: "comingSoon", description: "Compare electricity and gas suppliers after utilities orientation." },
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "comingSoon", description: "Compare fibre, cable and DSL broadband deals." },
    { label: "Phone providers", href: "/netherlands/services/phone-providers/", status: "comingSoon", description: "Compare prepaid, SIM-only and eSIM plans." },
