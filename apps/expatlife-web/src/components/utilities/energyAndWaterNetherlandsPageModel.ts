...
export const energyAndWaterNetherlandsPage = {
  ...
  relatedGuides: [
    ...
    { label: "Energy providers", href: "/netherlands/services/energy-providers/", status: "comingSoon", description: "Services directory for electricity and gas supplier comparison — who to compare, not meters or water setup." },
    ...
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "comingSoon", description: "Sibling Connectivity directory for fibre, cable and DSL ISPs." },
    { label: "Phone providers", href: "/netherlands/services/phone-providers/", status: "comingSoon", description: "Sibling Connectivity directory for prepaid, SIM-only and eSIM plans." },
  ...
  exploreNextCards: [
    { label: "Energy providers", href: "/netherlands/services/energy-providers/", status: "comingSoon", description: "Compare electricity and gas suppliers after you understand meters and setup." },
    ...
    { label: "Internet providers", href: "/netherlands/services/internet-providers/", status: "comingSoon", description: "Compare fixed broadband deals in the Connectivity directories." },
