...
export type MovePillarTocItem = { href: string; label: string };

/**
 * In-page anchors for small viewports — desktop users get the sticky rail (`MovePillarSectionNav`).
 */
export function MovePillarMobileToc({ items }: { items: MovePillarTocItem[] }) {
  return (
    <nav
