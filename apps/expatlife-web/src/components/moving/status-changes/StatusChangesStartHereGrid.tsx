import { ClipboardList, GitBranch, Scale } from "lucide-react";
...
import type { MoveStatusChangesStartHereCard } from "./config/moveStatusChanges.types";
...
const ICONS = {
  basis: Scale,
  lifeShift: GitBranch,
  practical: ClipboardList,
} as const;

export function StatusChangesStartHereGrid({
  id,
  eyebrow,
  title,
  subtitle,
  ...
  title: string;
  subtitle: string;
  cards: readonly MoveStatusChangesStartHereCard[];
}) {
  return (
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-copilot-text-muted">Core idea</p>
