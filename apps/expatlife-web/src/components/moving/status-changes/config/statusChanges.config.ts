...
export const statusChangesPageMeta: StatusChangesPageMeta = {
  ...
  deepLinks: [
    ...
    },
    {
      ...
      description: "When the life event is a new employer and contracts, money, and admin move together.",
    },
    {
      href: "/netherlands/moving/resigning-job-netherlands/",
      label: "Resigning a job in the Netherlands",
      description: "When you are leaving employment and stay, money, or household admin may move with the exit.",
    },
    {
      href: "/netherlands/moving/layoffs-netherlands/",
      label: "Layoffs in the Netherlands",
      description: "When employment may end involuntarily — permits, payroll gaps, rent, and family admin in one orientation.",
    },
    {
  ...
  continueMove: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: "Practical framing when work is changing and permits, salary, housing, and family admin may move too.",
        href: "/netherlands/moving/changing-jobs-netherlands/",
        ctaLabel: "Open guide",
      },
      {
        ...
        description: "Notice, contracts, and stay questions when employment may end before the next step is locked.",
        href: "/netherlands/moving/resigning-job-netherlands/",
        ctaLabel: "Open guide",
      },
      {
        ...
        description: "Redundancy risk: employment ending next to stay continuity, money, and practical life.",
        href: "/netherlands/moving/layoffs-netherlands/",
        ctaLabel: "Open guide",
      },
    ],
  ...
  pillarJourneyBridge: {
    ...
    links: [
      ...
      { href: EXTENSIONS, label: "Extensions & changes", description: "Timing, continuity, and after-arrival shifts.", meta: "Move" },
      {
        href: "/netherlands/moving/changing-jobs-netherlands/",
        label: "Changing jobs in the Netherlands",
        description: "Move-pillar checklist when a new role may touch permits, payroll, rent, and household timing.",
        meta: "Move",
      },
      {
        href: "/netherlands/moving/resigning-job-netherlands/",
        label: "Resigning a job in the Netherlands",
        description: "Exit orientation when employment may end and stay or monthly life questions belong in the same plan.",
        meta: "Move",
      },
      {
        href: "/netherlands/moving/layoffs-netherlands/",
        label: "Layoffs in the Netherlands",
        description: "When redundancy is the trigger — map stay, income, housing, and admin without panic.",
        meta: "Move",
      },
