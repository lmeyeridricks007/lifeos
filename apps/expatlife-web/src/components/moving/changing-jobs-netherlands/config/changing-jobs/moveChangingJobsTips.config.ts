import type { MoveChangingJobsTipsConfig } from "./moveChangingJobsNl.config.types";

/** Reassurance band + confidence checklist — practical “tip” layer above the main sections. */
export const moveChangingJobsTips: MoveChangingJobsTipsConfig = {
  reassurance: [
    {
      title: "You do not need to solve everything before you decide",
      body:
