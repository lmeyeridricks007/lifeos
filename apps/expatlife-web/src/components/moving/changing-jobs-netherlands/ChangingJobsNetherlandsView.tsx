...
const WORK_PERMITS_JOB_CHANGES_INSTRUCTIONAL = getWorkPermitsJobChangesInstructionalFigure("changing-jobs-netherlands");
...
export function ChangingJobsNetherlandsView() {
  ...
  const crumbs = [
    ...
    { name: "Changing Jobs in the Netherlands", item: absoluteUrlFromPath(CANONICAL) },
  ];
