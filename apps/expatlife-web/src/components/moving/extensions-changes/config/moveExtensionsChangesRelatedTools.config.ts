  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Working in the Netherlands", description: "Employment and contracts when your job situation is changing.", href: "/netherlands/work/working-in-netherlands/" },
