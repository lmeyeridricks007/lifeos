import { CalendarClock, GitBranch, Scale } from "lucide-react";
...
import type { ExtensionsStartHereCard } from "./config/moveExtensionsChanges.types";
...
const ICONS = {
  ...
  lifePlanning: GitBranch,
} as const;

export function ExtensionsChangesStartHereGrid({
  id,
  eyebrow,
  title,
  subtitle,
  ...
  title: string;
  subtitle: string;
  cards: readonly ExtensionsStartHereCard[];
}) {
  return (
