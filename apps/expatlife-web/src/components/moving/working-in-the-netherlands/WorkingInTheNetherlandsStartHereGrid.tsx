import { Briefcase, Landmark, Plane } from "lucide-react";
...
import type { MoveWorkingNlStartCard } from "./config/workingInTheNetherlands.config";
...
export function WorkingInTheNetherlandsStartHereGrid({
  id,
  eyebrow,
  title,
  subtitle,
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-copilot-text-muted">Work move stage</p>
