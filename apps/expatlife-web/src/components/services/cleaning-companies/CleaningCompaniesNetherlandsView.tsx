...
import {
  cleaningCompaniesNetherlandsPage as page,
  type CleaningLink,
  type CleaningProvider,
} from "./cleaningCompaniesNetherlandsPageModel";
...
function LinkCard({ item, iconIndex = 0 }: { item: CleaningLink; iconIndex?: number }) {
...
function ProviderCard({ provider }: { provider: CleaningProvider }) {
  return (
      ...
      <div className="overflow-x-auto">
        <table className="min-w-[920px] divide-y divide-slate-200 text-left text-sm">
          <thead className="bg-slate-50 text-xs uppercase tracking-[0.12em] text-slate-500">
            <tr>
              {["Provider", "Cities Served", "Expat Focus", "Languages", "End-of-tenancy", "Provider Type"].map((heading) => (
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {page.comparisonTable.map((row) => (
              <tr key={row.provider} className="align-top">
                ...
                <td className="px-4 py-4 text-foreground-muted">{row.endOfTenancy}</td>
...
export function CleaningCompaniesNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Cleaning Companies", item: new URL(page.path, baseUrl).toString() },
  ];
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-copilot-text-secondary">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden className="text-copilot-text-muted">/</li>
              <li className="font-medium text-copilot-text-primary" aria-current="page">Cleaning Companies</li>
            </ol>
          </nav>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_0.78fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-3xl rounded-2xl border border-amber-200/70 bg-amber-50/70 px-4 py-3 text-sm leading-relaxed text-amber-950 shadow-sm ring-1 ring-amber-200/40">
                  Provider inclusion is informational soft discovery — not a ranking or price guarantee. Always verify insurance, keys access, scope checklists and fit directly. Repairs belong with Handymen; housing search with rental/estate directories; furniture vans with Moving and Removal companies.
                </p>
              </div>
              <HeroImage />
            </div>
          ...
          <nav
            ...
            aria-label="Cleaning companies directory sections"
          >
          ...
          <div className={sectionStackClass}>
              ...
              <section id="differentiate" className={sectionClass}>
                <SectionIntro eyebrow="Provider types" title="Cleaning Companies Are Not the Same As…">
                  <p>Start here so you do not collect the wrong quotes. Cleaning companies, entry-rule guides, household removers and relocation packages solve different problems.</p>
                </SectionIntro>
              ...
              <section id="snapshot" className={sectionClass}>
                <SectionIntro eyebrow="Snapshot" title="Cleaning Companies at a Glance">
                  <p>Practical orientation points before you shortlist cleaners or request surveys.</p>
                </SectionIntro>
              ...
              <section id="provider-types" className={sectionClass}>
                <SectionIntro eyebrow="Cleaning models" title="Types of Cleaning Companies">
                  <p>Regular domestic, end-of-tenancy / oplevering, deep cleans, light commercial and matching desks solve different jobs. Match the model before comparing brand names.</p>
                </SectionIntro>
              ...
              <section id="services" className={sectionClass}>
                <SectionIntro eyebrow="Cleaner role" title="What Cleaning Companies Actually Help With">
                  <p>Scope varies by company. The common pattern is domestic cleans, deep cleans and checklist-based oplevering — not repairs or furniture vans.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="compare" className={sectionClass}>
                <SectionIntro eyebrow="Comparison criteria" title="How to Compare Cleaning Companies">
                  <p>Use criteria that reveal job fit — written scopes, insurance, keys handling, language and rebook terms — rather than star ratings.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="costs" className={sectionClass}>
                <SectionIntro eyebrow="Costs" title="Cost Drivers for Cleaning">
                  <p>Hours, frequency, home size, deep vs maintenance intensity and product assumptions drive cleaning prices. Ask for written assumptions before you compare totals.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="prep" className={sectionClass}>
                <SectionIntro eyebrow="Prep" title="What to Prepare Before Cleaning Day">
                  <p>Access codes and landlord checklists often matter as much as the hourly rate. Share keys notes and inspection dates early.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="challenges" className={sectionClass}>
                <SectionIntro eyebrow="Common challenges" title="Challenges Expats Often Face with Cleaning">
                  <p>These friction points are common on move-out week — they are reasons to ask better questions early, not to skip written scopes.</p>
                </SectionIntro>
              ...
              <section id="cities" className={sectionClass}>
                <SectionIntro eyebrow="City coverage" title="Cleaning Companies Across the Netherlands">
                  <p>Cleaning companies cover Dutch origins and destinations nationwide. Destination stairs and parking still matter after ocean transit.</p>
                </SectionIntro>
              ...
              <section id="directory" className={sectionClass}>
                <SectionIntro eyebrow="Directory" title="Cleaning Companies for Expats in the Netherlands">
                  <p>This editorial directory uses real companies and neutral descriptions focused on domestic and move-out cleaning. It does not rank providers, invent reviews or guarantee prices.</p>
                </SectionIntro>
              ...
              <section id="comparison" className={sectionClass}>
                <SectionIntro eyebrow="Comparison table" title="Compare Cleaning Companies">
                  <p>Use this as a starting point for your shortlist. Coverage, end-of-tenancy depth and language support can change — verify details directly.</p>
                </SectionIntro>
                <div className={sectionStackClass}>
                  <ComparisonTable />
                </div>
              ...
              {showAffiliateProviders && affiliateProviderData ? (
                <section id="affiliate-providers" className={sectionClass}>
                  <SectionIntro eyebrow="Related support providers" title="Providers That May Help Around Your Clean">
                    <p>
                      These listings support overlapping needs — housing search, insurance, tax and relocation coordination — not a ranking of cleaning companies. Confirm services and credentials before you commit.
                    </p>
                  </SectionIntro>
                  <div className="mt-6">
                    <AffiliateBlockView
              ...
              <section id="questions" className={sectionClass}>
                <SectionIntro eyebrow="Cleaner interview" title="Questions Expats Should Ask">
                  <p>Use these questions before paying a deposit. The answers should reveal scope boundaries, insurance and keys handling.</p>
                </SectionIntro>
              ...
              <section id="lead-cta" className={cn(CITIES_FUNNEL_SECTION_SCROLL_MARGIN, "scroll-mt-24 overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-expatos-xl sm:p-8 lg:p-10")}>
                ...
                <div className="mt-6 rounded-3xl border border-white/10 bg-white/10 p-5 ring-1 ring-white/10">
                  ...
                  <ul className="mt-4 grid gap-3 text-sm leading-relaxed text-slate-300 sm:grid-cols-3">
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Confirm cleaning scope vs handyman repairs.</li>
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Get written checklist, hours and insurance assumptions.</li>
              ...
              <section id="faq" className={sectionClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions">
                  <p>Use these answers to separate cleaners from entry-rule guides, household removers and relocation packages — and to spot quote red flags early.</p>
                </SectionIntro>
              ...
              <section id="sources" className={sectionClass}>
                <SectionIntro eyebrow="Trust" title="Official & Trusted Resources">
                  <p>Company registration and consumer rights should be checked against official sources — not cleaner marketing alone.</p>
                </SectionIntro>
              ...
              <section id="related-guides" className={sectionClass}>
                <SectionIntro eyebrow="Related guides" title="Continue Your Research">
                  <p>Connect cleaner shortlists to move logistics, housing search, pet relocation and storage timing.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="services-links" className={sectionClass}>
                <SectionIntro eyebrow="Services ecosystem" title="Related Services Around a Clean">
                  <p>Cleaners often overlap with lease handovers, relocation packages, furniture vans and storage timing.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="explore-next" className={sectionClass}>
                <SectionIntro eyebrow="Explore next" title="Plan the Next Step">
                  <p>Move from provider discovery into furniture vans, housing search, pet logistics and city choice.</p>
                </SectionIntro>
              ...
              <footer className="rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-sm leading-relaxed text-foreground-muted shadow-sm">
                Some links on this page may be affiliate or referral links. If you use them, we may earn a commission at no extra cost to you. Ordering reflects relevance to expat cleaning discovery and related support — not pay-to-rank placement of cleaning companies. This is not veterinary, import, legal, insurance or consumer-rights advice.
              </footer>
          </div>
        </Container>
      </main>
