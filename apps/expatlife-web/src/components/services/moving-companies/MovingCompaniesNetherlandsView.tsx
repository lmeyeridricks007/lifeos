...
import {
  movingCompaniesNetherlandsPage as page,
  type MovingCompanyLink,
  type MovingCompanyProvider,
} from "./movingCompaniesNetherlandsPageModel";
...
function LinkCard({ item, iconIndex = 0 }: { item: MovingCompanyLink; iconIndex?: number }) {
...
function ProviderCard({ provider }: { provider: MovingCompanyProvider }) {
  return (
...
export function MovingCompaniesNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Moving Companies", item: new URL(page.path, baseUrl).toString() },
  ];
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-copilot-text-secondary">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden className="text-copilot-text-muted">/</li>
              <li className="font-medium text-copilot-text-primary" aria-current="page">Moving Companies</li>
            </ol>
          </nav>
          ...
          <div className={sectionStackClass}>
              ...
              <section id="differentiate" className={sectionClass}>
                <SectionIntro eyebrow="Provider types" title="Moving Companies Are Not the Same As…">
                  <p>Start here so you do not collect the wrong quotes. Domestic movers, international removals, relocation packages and freight shipping solve different problems.</p>
                </SectionIntro>
              ...
              <section id="snapshot" className={sectionClass}>
                <SectionIntro eyebrow="Snapshot" title="Moving Companies at a Glance">
                  <p>Practical orientation points before you shortlist domestic movers or request quotes.</p>
                </SectionIntro>
              ...
              <section id="mover-types" className={sectionClass}>
                <SectionIntro eyebrow="Mover models" title="Types of Domestic Moving Companies">
                  <p>Local vans, full-service crews, apartment specialists, budget movers and national networks solve different access and volume problems. Match the model before comparing brand names.</p>
                </SectionIntro>
              ...
              <section id="mover-role" className={sectionClass}>
                <SectionIntro eyebrow="Mover role" title="What Domestic Movers Actually Help With">
                  <p>Scope varies by company. The common pattern is packing options, loading, stairs/elevator logistics and transport between Dutch addresses — not international containers.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="compare" className={sectionClass}>
                <SectionIntro eyebrow="Comparison criteria" title="How to Compare Moving Companies">
              ...
              <section id="costs" className={sectionClass}>
                <SectionIntro eyebrow="Costs" title="Cost Drivers for Domestic Moves">
                  <p>Volume, distance, stairs, packing labour and weekend timing drive Dutch domestic move prices. Ask for written assumptions before you compare totals.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="challenges" className={sectionClass}>
                <SectionIntro eyebrow="Common challenges" title="Challenges Expats Often Face on Domestic Moves">
                  <p>These friction points are common in Dutch cities — they are reasons to ask better questions early, not to skip written quotes.</p>
                </SectionIntro>
              ...
              <section id="cities" className={sectionClass}>
                <SectionIntro eyebrow="City coverage" title="Moving Companies Across the Netherlands">
                  <p>Many movers work nationwide. Local experience still matters for canal houses, parking permits and no-lift buildings.</p>
                </SectionIntro>
              ...
              <section id="directory" className={sectionClass}>
                <SectionIntro eyebrow="Directory" title="Moving Companies for Expats in the Netherlands">
              ...
              <section id="comparison" className={sectionClass}>
                <SectionIntro eyebrow="Comparison table" title="Compare Domestic Moving Companies">
              ...
              {showAffiliateProviders && affiliateProviderData ? (
                <section id="affiliate-providers" className={sectionClass}>
                  <SectionIntro eyebrow="Related support providers" title="Providers That May Help Around Your Move">
                    <p>
                      These listings support overlapping needs — housing search, insurance, tax and relocation coordination — not a ranking of moving companies. Confirm services and credentials before you commit.
                    </p>
                  </SectionIntro>
                  <div className="mt-6">
                    <AffiliateBlockView
