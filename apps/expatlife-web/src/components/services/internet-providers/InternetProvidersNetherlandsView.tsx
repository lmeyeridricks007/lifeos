...
import {
  internetProvidersNetherlandsPage as page,
...
function FeatureCard({ title, body, iconIndex = 0 }: { title: string; body: string; iconIndex?: number }) {
  const icons = [Wifi, Cable, Router, ClipboardList, FileText, Globe2, ShieldCheck, Building2] as const;
...
function ProviderCard({ provider }: { provider: InternetProviderEntry }) {
  return (
    <article
      className={cn(
...
export function InternetProvidersNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Internet providers", item: new URL(page.path, baseUrl).toString() },
  ];
      ...
      <main className={sitePageCanvasClass}>
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_0.78fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-3xl rounded-2xl border border-amber-200/70 bg-amber-50/70 px-4 py-3 text-sm leading-relaxed text-amber-950 shadow-sm ring-1 ring-amber-200/40">
                  Provider inclusion is informational soft discovery — not a ranking of ISPs. Always verify address
                  availability, contract term, installation fees and cancellation rules directly with the provider. This
                  is not telecom advice.
                </p>
              </div>
              <HeroImage />
            </div>
          ...
          <nav
            ...
            aria-label="Internet providers guide sections"
          >
          ...
          <div className={sectionStackClass}>
            ...
            <section id="differentiate" className={sectionClass}>
              <SectionIntro eyebrow="Provider types" title="Internet Providers Are Not the Same As…">
                <p>
                  Start here so you do not use the wrong page. This directory owns fixed broadband ISP discovery. Setup
                  how-to lives on the utilities guide; SIMs and phone plans live on Phone providers and Mobile &amp;
                  connectivity.
                </p>
              </SectionIntro>
            ...
            <section id="snapshot" className={sectionClass}>
              <SectionIntro eyebrow="Snapshot" title="Internet Providers at a Glance">
                <p>Practical orientation points before you compare fibre, cable or DSL deals at a Dutch address.</p>
              </SectionIntro>
            ...
            <section id="technology" className={sectionClass}>
              <SectionIntro eyebrow="Technology" title="Fibre, Cable and DSL — What Differs">
                <p>
                  Technology available at your building drives the shortlist more than national brand advertising. Match
                  the product type to your address before comparing monthly prices.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
                {page.technologyCards.map((item, idx) => (
                  <FeatureCard key={item.title} {...item} iconIndex={idx} />
                ))}
              </div>
              <VisualFigure visual={page.visuals.technology} className={sectionVisualMtClass} />
            </section>

            <section id="contracts" className={sectionClass}>
              <SectionIntro eyebrow="Contracts" title="Contract Types Expats Should Understand">
                <p>
                  Promotional fixed terms, rolling contracts, install fees and equipment returns change the true cost of
                  a short Dutch stay. Read the term and notice rules before you click buy.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="availability" className={sectionClass}>
              <SectionIntro eyebrow="Availability & install" title="Address Checks and Installation">
                <p>
                  Always confirm postcode and huisnummer availability, then plan technician access and a mobile data
                  bridge for the gap between keys and activation.
                </p>
              </SectionIntro>
              <div className="mt-6">
                <InfoTable
                  rows={page.availabilitySteps}
                  columns={[
                    { key: "item", label: "Step" },
              ...
              <VisualFigure visual={page.visuals.availability} className={sectionVisualMtClass} />
            </section>

            <section id="bundles" className={sectionClass}>
              <SectionIntro eyebrow="Bundles" title="TV, Internet and Landline Orientation">
                <p>
                  Bundles can simplify billing, but many streaming households only need internet. Compare the incremental
                  TV cost against what you will actually use.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2")}>
                {page.bundleCards.map((item, idx) => (
                  <FeatureCard key={item.title} {...item} iconIndex={idx} />
                ))}
              </div>
              <VisualFigure visual={page.visuals.bundles} className={sectionVisualMtClass} />
            </section>

            <section id="provider-types" className={sectionClass}>
              <SectionIntro eyebrow="Provider models" title="Types of Internet Providers & Comparison Paths">
                <p>
                  National ISPs, cable operators, regional fibre, challengers, comparison sites and landlord-included
                  Wi-Fi solve different problems. Match the model to your building and stay length.
                </p>
              </SectionIntro>
            ...
            <section id="scenarios" className={sectionClass}>
              <SectionIntro eyebrow="Decision paths" title="Scenarios: Which Path Fits Your Move">
                <p>
                  Short leases, fibre-ready flats, landlord Wi-Fi and remote-work households need different shortlists —
            ...
            <section id="mistakes" className={sectionClass}>
              <SectionIntro eyebrow="Common mistakes" title="Mistakes Expats Often Make">
                <p>
                  These friction points are common when ordering Dutch broadband — they are reasons to verify address,
                  term and which page owns mobile or setup how-to.
                </p>
              </SectionIntro>
            ...
            <section id="directory" className={sectionClass}>
              <SectionIntro eyebrow="Directory" title="Internet Providers for Expats in the Netherlands">
                <p>
                  This structured directory uses provider-type discovery, comparison platforms and official consumer
                  orientation. It does not rank ISPs, invent reviews or guarantee speeds.
                </p>
              </SectionIntro>
            ...
            <section id="comparison" className={sectionClass}>
              <SectionIntro eyebrow="Comparison table" title="Compare Provider Models">
                <p>
                  Use this as a starting point for your shortlist. Technology footprint, English support and online
                  ordering can change, so verify all details directly.
                </p>
              </SectionIntro>
              <div className={sectionStackClass}>
                <ComparisonTable />
            ...
            {showAffiliateProviders && affiliateProviderData ? (
              <section id="affiliate-providers" className={sectionClass}>
                <SectionIntro eyebrow="Comparison support" title="Affiliates and Providers That May Help">
                  <p>
                    Soft discovery for Dutch broadband comparison — prioritising Pricewise — not a ranking of ISPs.
                    Confirm address availability, contract length and install fees before you sign. For SIMs, use Phone
                    providers; for setup steps, use the utilities how-to guide.
                  </p>
                </SectionIntro>
                <div className="mt-6">
                  <AffiliateBlockView
            ...
            <section id="checklist" className={sectionClass}>
              <SectionIntro eyebrow="Checklist" title="Before You Sign a Broadband Contract">
                <p>
                  A short pre-sign checklist prevents most first-apartment regrets — especially around address checks,
                  notice periods and equipment returns.
                </p>
              </SectionIntro>
              <div className="mt-6">
                <InfoTable
            ...
            <section id="questions" className={sectionClass}>
              <SectionIntro eyebrow="Provider interview" title="Questions Expats Should Ask">
                <p>
                  Use these questions before choosing an ISP. The answers should help you understand real availability,
                  fees, install windows and exit terms.
                </p>
              </SectionIntro>
              ...
              <div className="mt-6 rounded-3xl border border-white/10 bg-white/10 p-5 ring-1 ring-white/10">
                ...
                <ul className="mt-4 grid gap-3 text-sm leading-relaxed text-slate-300 sm:grid-cols-3">
                  <li className="flex gap-2">
                    ...
                    Confirm address availability for fibre, cable or DSL.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Compare promo price vs renewal and notice period.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Plan install access and a mobile data bridge.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Keep SIMs on Phone providers — not this directory.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
            ...
            <section id="faq" className={sectionClass}>
              <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions">
                <p>
                  Use these FAQ answers to identify what you still need to verify: technology at your address, bundles,
                  mobile overlap and official consumer-rights orientation.
                </p>
              </SectionIntro>
            ...
            <section id="sources" className={sectionClass}>
              <SectionIntro eyebrow="Trust" title="Regulation & Official Resources">
                <p>
                  Consumers should verify address availability and understand contract terms before proceeding. Official
                  sources help you check switching and complaint orientation rather than relying on marketing claims.
                </p>
              </SectionIntro>
            ...
            <section id="related-guides" className={sectionClass}>
              <SectionIntro eyebrow="Related guides" title="Continue Your Connectivity Research">
                <p>
                  Use these guides to connect ISP discovery to energy contracts, phone plans, utilities how-to and
                  housing timing.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="services-links" className={sectionClass}>
              <SectionIntro eyebrow="Services ecosystem" title="Related Services for Household Setup">
                <p>
                  Broadband often overlaps with energy, phone, mobile connectivity, moving and rental timelines.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="explore-next" className={sectionClass}>
              <SectionIntro eyebrow="Explore next" title="Plan the Next Step">
                <p>
                  Move from ISP discovery into the directories and guides that shape energy, mobile and practical
                  setup.
                </p>
              </SectionIntro>
            ...
            <footer className="rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-sm leading-relaxed text-foreground-muted shadow-sm">
              ...
              no extra cost to you. Ordering reflects relevance to expat broadband discovery and comparison orientation —
              not pay-to-rank placement of ISPs. This is not telecom, financial or legal advice.
            </footer>
          </div>
        </Container>
      </main>
