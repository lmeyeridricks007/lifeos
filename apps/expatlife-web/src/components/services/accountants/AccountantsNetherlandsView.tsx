...
import {
  accountantsNetherlandsPage as page,
  type AccountantLink,
  type AccountantProvider,
} from "./accountantsNetherlandsPageModel";
...
function LinkCard({ item, iconIndex = 0 }: { item: AccountantLink; iconIndex?: number }) {
...
function ProviderCard({ provider }: { provider: AccountantProvider }) {
  return (
    <article className={cn("relative overflow-hidden rounded-3xl border border-slate-200/90 bg-white p-5 shadow-expatos-xl ring-1 ring-slate-900/[0.04]", movingNlCardMicroLiftClass)}>
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <span className={providerTypeClass}>{provider.accountantType}</span>
      </div>
...
export function AccountantsNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Accountants", item: new URL(page.path, baseUrl).toString() },
  ];
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-copilot-text-secondary">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden className="text-copilot-text-muted">/</li>
              <li className="font-medium text-copilot-text-primary" aria-current="page">Accountants</li>
            </ol>
          </nav>
          ...
          <nav
            ...
            aria-label="Accountants guide sections"
          >
          ...
          <div className={sectionStackClass}>
              ...
              <section id="differentiate" className={sectionClass}>
                <SectionIntro eyebrow="Provider types" title="Accountants Are Not the Same As…">
                  <p>Start here so you do not use the wrong directory. Accountants and administratiekantoren own bookkeeping and filings admin; tax advisors own advice; financial advisors own wealth planning; business consultants own strategy.</p>
                </SectionIntro>
              ...
              <section id="snapshot" className={sectionClass}>
                <SectionIntro eyebrow="Snapshot" title="Accountants at a Glance">
                  <p>These are practical orientation points to understand before comparing administratiekantoren or opening engagement letters.</p>
                </SectionIntro>
              ...
              <section id="accountant-role" className={sectionClass}>
                <SectionIntro eyebrow="Accountant role" title="What Accountants Actually Help With">
                  <p>Scope varies by firm. Common expat touchpoints are bookkeeping, BTW filings, jaarrekening, payroll admin and ZZP administration packs — not tax strategy or wealth planning rebuilds.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
                  {page.accountantServices.map((item, idx) => <FeatureCard key={item.title} {...item} iconIndex={idx} />)}
                </div>
                <VisualFigure visual={page.visuals.accountantServices} className={sectionVisualMtClass} />
              </section>

              <section id="accountant-types" className={sectionClass}>
                <SectionIntro eyebrow="Firm models" title="Types of Accountants & Administratiekantoren">
                  <p>Bookkeeping offices, titled accountants, payroll specialists, expat-oriented firms and tax-adjacent filing support solve different problems. Match the model to your need before comparing brand names.</p>
                </SectionIntro>
                <div className="mt-6 grid gap-4">
                  {page.accountantTypeComparison.map((item) => (
                ...
                <VisualFigure visual={page.visuals.accountantTypes} className={sectionVisualMtClass} />
              </section>

              <section id="when-to-use" className={sectionClass}>
                <SectionIntro eyebrow="Decision paths" title="When to Use an Accountant vs Tax Advisor vs DIY">
                  <p>Routine BTW and ledger work often suit an administratiekantoor. Complex tax advice belongs on the Tax advisors page. Strategy and growth sit with Business consultants. Match the path to your profile.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="credentials" className={sectionClass}>
                <SectionIntro eyebrow="Checklist" title="What to Verify Before You Instruct an Accountant">
                  <p>Ask about scope, fees, software and language support early. Use official NBA, KvK and Belastingdienst orientation to verify context — this page is not a substitute for professional searches.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="challenges" className={sectionClass}>
                <SectionIntro eyebrow="Common challenges" title="Challenges Expats Often Face">
                  <p>These friction points are common when arranging Dutch administratie — they are reasons to clarify scope, language and which page owns tax advice or strategy.</p>
                </SectionIntro>
              ...
              <section id="directory" className={sectionClass}>
                <SectionIntro eyebrow="Directory" title="Accountants for Expats in the Netherlands">
                  <p>This structured directory uses known accountancy-adjacent providers, role-based discovery paths and neutral descriptions. It does not rank accountants, invent reviews or guarantee filing outcomes.</p>
                </SectionIntro>
              ...
              <section id="comparison" className={sectionClass}>
                <SectionIntro eyebrow="Comparison table" title="Compare Accountant Models">
              ...
              {showAffiliateProviders && affiliateProviderData ? (
                <section id="affiliate-providers" className={sectionClass}>
                  <SectionIntro eyebrow="Comparison support" title="Affiliates and Providers That May Help">
                    <p>
                      Soft discovery for Dutch bookkeeping and admin support — prioritising Blue Umbrella, BROADSTREET and TaxSavers — not a ranking of accountants. Confirm scope, credentials and fees before you instruct a firm. For tax advice and 30% ruling conversations, use the Tax advisors directory.
                    </p>
                  </SectionIntro>
                  <div className="mt-6">
                    <AffiliateBlockView
              ...
              <section id="questions" className={sectionClass}>
                <SectionIntro eyebrow="Firm interview" title="Questions Expats Should Ask">
                  <p>Use these questions before choosing an accountant. The answers should help you understand scope, fees, software handoffs and where tax advice starts.</p>
                </SectionIntro>
              ...
              <section id="related-business" className={sectionClass}>
                <SectionIntro eyebrow="Business guides" title="Related Business & Work Guides">
                  <p>Accountant research should sit beside ZZP setup, starting a business, freelancing, consultancy and contractor-vs-employee orientation.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="lead-cta" className={cn(CITIES_FUNNEL_SECTION_SCROLL_MARGIN, "scroll-mt-24 overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-expatos-xl sm:p-8 lg:p-10")}>
                ...
                <div className="mt-6 rounded-3xl border border-white/10 bg-white/10 p-5 ring-1 ring-white/10">
                  ...
                  <ul className="mt-4 grid gap-3 text-sm leading-relaxed text-slate-300 sm:grid-cols-3">
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Confirm bookkeeping vs tax-advice scope.</li>
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Ask how monthly fees and overruns work in writing.</li>
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Map BTW, jaarrekening and payroll inclusions.</li>
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Use Tax advisors for advice and 30% ruling topics.</li>
              ...
              <section id="faq" className={sectionClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions">
                  <p>Use these FAQ answers to identify what you still need to verify: role boundaries, BTW, jaarrekening, ZZP packages and official source orientation.</p>
                </SectionIntro>
              ...
              <section id="sources" className={sectionClass}>
                <SectionIntro eyebrow="Trust" title="Official Resources">
                  <p>Consumers should verify the firm and understand engagement scope before proceeding. Official sources help you check filing and professional context rather than relying on marketing claims.</p>
                </SectionIntro>
              ...
              <section id="related-guides" className={sectionClass}>
                <SectionIntro eyebrow="Related guides" title="Continue Your Accountant Research">
                  <p>Use these guides to connect accountant discovery to tax advice, wealth planning, business strategy and ZZP setup.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="services-links" className={sectionClass}>
                <SectionIntro eyebrow="Services ecosystem" title="Related Services for Business Admin">
                  <p>Accountant discovery often overlaps with tax advisors, financial advisors, business consultants and mortgage timing.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="explore-next" className={sectionClass}>
                <SectionIntro eyebrow="Explore next" title="Plan the Next Step">
                  <p>Move from accountant discovery into the directories and guides that shape your tax advice, business setup and city context.</p>
                </SectionIntro>
              ...
              <footer className="rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-sm leading-relaxed text-foreground-muted shadow-sm">
                Some links on this page may be affiliate or referral links. If you use them, we may earn a commission at no extra cost to you. Ordering reflects relevance to expat accountant and bookkeeping discovery — not pay-to-rank placement of accountants. This is not tax, financial or legal advice.
              </footer>
          </div>
        </Container>
      </main>
