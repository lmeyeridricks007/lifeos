...
export const mortgageAdvisorsNetherlandsPage = {
  ...
  servicesLinks: [
    ...
    { label: "Notaries", href: "/netherlands/services/notaries/", status: "live", description: "Dutch notaris for levering and hypotheekakte — deed completion beside mortgage advice." },
    { label: "Estate agents", href: "/netherlands/services/estate-agents/", status: "live", description: "Dutch makelaars for buying and selling property — buyer and seller mandates." },
    ...
    { label: "Recruitment Agencies Directory", href: "/netherlands/services/recruitment-agencies/", status: "live", description: "Compare recruitment agency providers when job search and relocation timing overlap." },
    ...
    { label: "Storage companies", href: "/netherlands/services/storage-companies/", status: "live", description: "Self-storage when purchase and sale dates do not overlap." },
  ...
  exploreNextCards: [
    ...
    { label: "Notaries", href: "/netherlands/services/notaries/", status: "live", description: "Align deed and hypotheekakte timing with your mortgage file." },
    { label: "Estate agents", href: "/netherlands/services/estate-agents/", status: "live", description: "Find makelaar support for search, bidding and sale mandates." },
