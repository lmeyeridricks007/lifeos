...
export const mortgageAdvisorsNetherlandsPage = {
  ...
  servicesLinks: [
    ...
    { label: "Notaries", href: "/netherlands/services/notaries/", status: "comingSoon", description: "Dutch notaris for levering and hypotheekakte — deed completion beside mortgage advice." },
    { label: "Estate agents", href: "/netherlands/services/estate-agents/", status: "comingSoon", description: "Dutch makelaars for buying and selling property — buyer and seller mandates." },
    { label: "Immigration Lawyers", href: "/netherlands/services/immigration-lawyers/", status: "live", description: "Legal immigration representation when residence status interacts with buying plans." },
    { label: "Recruitment Agencies Directory", href: "/netherlands/services/recruitment-agencies/", status: "comingSoon", description: "Compare recruitment agency providers when job search and relocation timing overlap." },
    { label: "Visa Consultants", href: "/netherlands/services/visa-consultants/", status: "live", description: "Visa-route support adjacent to immigration legal representation." },
    {
      label: "Moving companies",
      href: "/netherlands/services/moving-companies/",
      status: "comingSoon",
      description: "Domestic NL house moves when buying or changing address within the country.",
    },
    {
      label: "Removal companies",
      href: "/netherlands/services/removal-companies/",
      status: "comingSoon",
      description: "International household removals when arriving or leaving the Netherlands.",
    },
    { label: "Storage companies", href: "/netherlands/services/storage-companies/", status: "comingSoon", description: "Self-storage when purchase and sale dates do not overlap." },
    { label: "Rental agencies", href: "/netherlands/services/rental-agencies/", status: "live", description: "Tenant mediation — different from buy/sell makelaars." },
  ] satisfies MortgageAdvisorLink[],
  exploreNextCards: [
    ...
    { label: "Notaries", href: "/netherlands/services/notaries/", status: "comingSoon", description: "Align deed and hypotheekakte timing with your mortgage file." },
    { label: "Estate agents", href: "/netherlands/services/estate-agents/", status: "comingSoon", description: "Find makelaar support for search, bidding and sale mandates." },
    { label: "Financial Advisors", href: "/netherlands/services/financial-advisors/", status: "live", description: "Broader planning once the mortgage conversation starts." },
