...
import {
  petRelocationCompaniesNetherlandsPage as page,
  type PetRelocationLink,
  type PetRelocationProvider,
} from "./petRelocationCompaniesNetherlandsPageModel";
...
function LinkCard({ item, iconIndex = 0 }: { item: PetRelocationLink; iconIndex?: number }) {
...
function ProviderCard({ provider }: { provider: PetRelocationProvider }) {
  return (
      ...
      <div className="overflow-x-auto">
        <table className="min-w-[920px] divide-y divide-slate-200 text-left text-sm">
          <thead className="bg-slate-50 text-xs uppercase tracking-[0.12em] text-slate-500">
            <tr>
              {["Provider", "Cities Served", "Expat Focus", "Languages", "Crate support", "Provider Type"].map((heading) => (
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {page.comparisonTable.map((row) => (
              <tr key={row.provider} className="align-top">
                ...
                <td className="px-4 py-4 text-foreground-muted">{row.crateSupport}</td>
...
export function PetRelocationCompaniesNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Pet Relocation Companies", item: new URL(page.path, baseUrl).toString() },
  ];
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-copilot-text-secondary">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden className="text-copilot-text-muted">/</li>
              <li className="font-medium text-copilot-text-primary" aria-current="page">Pet Relocation Companies</li>
            </ol>
          </nav>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_0.78fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-3xl rounded-2xl border border-amber-200/70 bg-amber-50/70 px-4 py-3 text-sm leading-relaxed text-amber-950 shadow-sm ring-1 ring-amber-200/40">
                  Provider inclusion is informational soft discovery — not a ranking or price guarantee. Always verify airline acceptance, crate specs, insurance and fit directly. For entry rules use Bringing pets; for household goods use Removal companies; for everyday pet life use Pets in the Netherlands.
                </p>
              </div>
              <HeroImage />
            </div>
          ...
          <nav
            ...
            aria-label="Pet relocation companies directory sections"
          >
          ...
          <div className={sectionStackClass}>
              ...
              <section id="differentiate" className={sectionClass}>
                <SectionIntro eyebrow="Provider types" title="Pet Relocation Companies Are Not the Same As…">
                  <p>Start here so you do not collect the wrong quotes. Pet relocators, entry-rule guides, household removers and relocation packages solve different problems.</p>
                </SectionIntro>
              ...
              <section id="snapshot" className={sectionClass}>
                <SectionIntro eyebrow="Snapshot" title="Pet Relocation Companies at a Glance">
                  <p>Practical orientation points before you shortlist pet relocators or request surveys.</p>
                </SectionIntro>
              ...
              <section id="provider-types" className={sectionClass}>
                <SectionIntro eyebrow="Pet relocation models" title="Types of Pet Relocation Companies">
                  <p>Door-to-door, flight/cargo desks, IPATA networks, EU ground transfer and corporate mobility pets solve different route problems. Match the model before comparing brand names.</p>
                </SectionIntro>
              ...
              <section id="services" className={sectionClass}>
                <SectionIntro eyebrow="Relocator role" title="What Pet Relocation Companies Actually Help With">
                  <p>Scope varies by company. The common pattern is IATA crates, airline acceptance, document timing and ground transfer — not furniture vans.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="compare" className={sectionClass}>
                <SectionIntro eyebrow="Comparison criteria" title="How to Compare Pet Relocation Companies">
                  <p>Use criteria that reveal route fit — written plans, breed acceptance, crate specs, insurance and rebook terms — rather than star ratings.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="costs" className={sectionClass}>
                <SectionIntro eyebrow="Costs" title="Cost Drivers for Pet Relocation">
                  <p>Route, species/weight, seasonality, crate and quarantine bridges drive pet relocation prices. Ask for written assumptions before you compare totals.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="prep" className={sectionClass}>
                <SectionIntro eyebrow="Prep" title="What to Prepare Before Pet Travel Day">
                  <p>Document timing and crate training often matter as much as the flight booking. Share breed details and key dates early.</p>
                </SectionIntro>
                <div className="mt-6">
                  <InfoTable
              ...
              <section id="challenges" className={sectionClass}>
                <SectionIntro eyebrow="Common challenges" title="Challenges Expats Often Face with Pet Relocation">
                  <p>These friction points are common on pet flights — they are reasons to ask better questions early, not to skip written route plans.</p>
                </SectionIntro>
              ...
              <section id="cities" className={sectionClass}>
                <SectionIntro eyebrow="City coverage" title="Pet Relocation Companies Across the Netherlands">
                  <p>Pet relocators cover Dutch origins and destinations nationwide. Destination stairs and parking still matter after ocean transit.</p>
                </SectionIntro>
              ...
              <section id="directory" className={sectionClass}>
                <SectionIntro eyebrow="Directory" title="Pet Relocation Companies for Expats in the Netherlands">
                  <p>This editorial directory uses real companies and neutral descriptions focused on pet logistics. It does not rank providers, invent reviews or guarantee prices.</p>
                </SectionIntro>
              ...
              <section id="comparison" className={sectionClass}>
                <SectionIntro eyebrow="Comparison table" title="Compare Pet Relocation Companies">
                  <p>Use this as a starting point for your shortlist. Coverage, crate options and language support can change — verify details directly.</p>
                </SectionIntro>
                <div className={sectionStackClass}>
                  <ComparisonTable />
                </div>
              ...
              {showAffiliateProviders && affiliateProviderData ? (
                <section id="affiliate-providers" className={sectionClass}>
                  <SectionIntro eyebrow="Related support providers" title="Providers That May Help Around Your Pet Move">
                    <p>
                      These listings support overlapping needs — housing search, insurance, tax and relocation coordination — not a ranking of pet relocation companies. Confirm services and credentials before you commit.
                    </p>
                  </SectionIntro>
                  <div className="mt-6">
                    <AffiliateBlockView
              ...
              <section id="questions" className={sectionClass}>
                <SectionIntro eyebrow="Mover interview" title="Questions Expats Should Ask">
                  <p>Use these questions before paying a deposit. The answers should reveal airline assumptions, crate ownership and delay rules.</p>
                </SectionIntro>
              ...
              <section id="lead-cta" className={cn(CITIES_FUNNEL_SECTION_SCROLL_MARGIN, "scroll-mt-24 overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-expatos-xl sm:p-8 lg:p-10")}>
                ...
                <div className="mt-6 rounded-3xl border border-white/10 bg-white/10 p-5 ring-1 ring-white/10">
                  ...
                  <ul className="mt-4 grid gap-3 text-sm leading-relaxed text-slate-300 sm:grid-cols-3">
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Confirm live-animal scope vs household goods removals.</li>
                    <li className="flex gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />Get written airline, crate and insurance assumptions.</li>
              ...
              <section id="faq" className={sectionClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions">
                  <p>Use these answers to separate pet relocators from entry-rule guides, household removers and relocation packages — and to spot quote red flags early.</p>
                </SectionIntro>
              ...
              <section id="sources" className={sectionClass}>
                <SectionIntro eyebrow="Trust" title="Official & Trusted Resources">
                  <p>Animal-health and entry rules should be checked against official sources — not relocator marketing alone.</p>
                </SectionIntro>
              ...
              <section id="related-guides" className={sectionClass}>
                <SectionIntro eyebrow="Related guides" title="Continue Your Research">
                  <p>Connect pet relocator shortlists to entry rules, everyday pet life, household removals and relocation packages.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="services-links" className={sectionClass}>
                <SectionIntro eyebrow="Services ecosystem" title="Related Services Around a Pet Move">
                  <p>Pet relocators often overlap with housing pet clauses, relocation packages, household goods timing and everyday pet support.</p>
                </SectionIntro>
                <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
              ...
              <section id="explore-next" className={sectionClass}>
                <SectionIntro eyebrow="Explore next" title="Plan the Next Step">
                  <p>Move from provider discovery into entry rules, pet life, household logistics, housing and city choice.</p>
                </SectionIntro>
              ...
              <footer className="rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-sm leading-relaxed text-foreground-muted shadow-sm">
                Some links on this page may be affiliate or referral links. If you use them, we may earn a commission at no extra cost to you. Ordering reflects relevance to expat pet-relocation discovery and related support — not pay-to-rank placement of pet relocation companies. This is not veterinary, import, legal, insurance or consumer-rights advice.
              </footer>
          </div>
        </Container>
      </main>
