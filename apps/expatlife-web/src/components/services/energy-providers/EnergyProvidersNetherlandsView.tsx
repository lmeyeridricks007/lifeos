...
import {
  energyProvidersNetherlandsPage as page,
...
function FeatureCard({ title, body, iconIndex = 0 }: { title: string; body: string; iconIndex?: number }) {
  const icons = [Zap, Flame, ClipboardList, FileText, Globe2, ShieldCheck, Building2, BadgeCheck] as const;
...
function ProviderCard({ provider }: { provider: EnergyProviderEntry }) {
  return (
    <article
      className={cn(
...
export function EnergyProvidersNetherlandsView() {
  const breadcrumbCrumbs = [
    { name: "Home", item: new URL("/", baseUrl).toString() },
    { name: "Netherlands", item: new URL("/netherlands", baseUrl).toString() },
    { name: "Services", item: new URL("/netherlands/services/", baseUrl).toString() },
    { name: "Energy providers", item: new URL(page.path, baseUrl).toString() },
  ];
      ...
      <main className={sitePageCanvasClass}>
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_0.78fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-3xl rounded-2xl border border-amber-200/70 bg-amber-50/70 px-4 py-3 text-sm leading-relaxed text-amber-950 shadow-sm ring-1 ring-amber-200/40">
                  Provider inclusion is informational soft discovery — not a ranking of energy brands. Always verify rates,
                  standing charges, contract term and cancellation rules directly with the provider. This is not energy or
                  financial advice.
                </p>
              </div>
              <HeroImage />
          ...
          <nav
            ...
            aria-label="Energy providers guide sections"
          >
          ...
          <div className={sectionStackClass}>
            ...
            <section id="differentiate" className={sectionClass}>
              <SectionIntro eyebrow="Provider types" title="Energy Providers Are Not the Same As…">
                <p>
                  Start here so you do not use the wrong page. This directory owns electricity and gas supplier discovery. Meters,
                  water and move-in setup live on Energy &amp; water; broadband lives on Internet providers.
                </p>
              </SectionIntro>
            ...
            <section id="snapshot" className={sectionClass}>
              <SectionIntro eyebrow="Snapshot" title="Energy Providers at a Glance">
            ...
            <section id="market" className={sectionClass}>
              <SectionIntro eyebrow="Market" title="Electricity, Gas and Market Roles">
                <p>
                  Clarify supplier vs grid, then compare electricity and gas products. Match the contract style to your stay
                  length before chasing teaser rates.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
                {page.marketCards.map((item, idx) => (
                  <FeatureCard key={item.title} {...item} iconIndex={idx} />
                ))}
              </div>
              <VisualFigure visual={page.visuals.market} className={sectionVisualMtClass} />
            </section>

            <section id="contracts" className={sectionClass}>
              <SectionIntro eyebrow="Contracts" title="Fixed vs Variable Contracts Expats Should Understand">
                <p>
                  Fixed, variable and dynamic tariffs change bill predictability and exit flexibility. Read term, standing
                  charge and notice rules before you switch.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="switching" className={sectionClass}>
              <SectionIntro eyebrow="Switching" title="How Switching Usually Works">
                <p>
                  Most switches are online. Confirm who holds the current contract, compare full pricing, plan meter
                  readings and keep written confirmation of the start date.
                </p>
              </SectionIntro>
              <div className="mt-6">
                <InfoTable
                  rows={page.switchingSteps}
                  columns={[
                    { key: "item", label: "Step" },
              ...
              <VisualFigure visual={page.visuals.switching} className={sectionVisualMtClass} />
            </section>

            <section id="products" className={sectionClass}>
              <SectionIntro eyebrow="Products" title="Electricity, Gas and Dual-Fuel Orientation">
                <p>
                  Dual-fuel can simplify billing, but separate electricity and gas deals can be cheaper. Match products
                  to whether your rental still uses gas.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2")}>
                {page.productCards.map((item, idx) => (
                  <FeatureCard key={item.title} {...item} iconIndex={idx} />
                ))}
              </div>
              <VisualFigure visual={page.visuals.products} className={sectionVisualMtClass} />
            </section>

            <section id="provider-types" className={sectionClass}>
              <SectionIntro eyebrow="Provider models" title="Types of Energy Providers & Comparison Paths">
                <p>
                  National retailers, green challengers, dynamic tariffs, comparison sites and landlord-included energy
                  solve different problems. Match the model to your stay length and risk comfort.
                </p>
              </SectionIntro>
            ...
            <section id="scenarios" className={sectionClass}>
              <SectionIntro eyebrow="Decision paths" title="Scenarios: Which Path Fits Your Move">
                <p>
                  Short leases, fixed-price comfort, dynamic tariffs and landlord-included energy need different shortlists —
            ...
            <section id="mistakes" className={sectionClass}>
              <SectionIntro eyebrow="Common mistakes" title="Mistakes Expats Often Make">
                <p>
                  These friction points are common when switching Dutch energy — they are reasons to verify contract type,
                  standing charges and which page owns meters or water setup.
                </p>
              </SectionIntro>
            ...
            <section id="directory" className={sectionClass}>
              <SectionIntro eyebrow="Directory" title="Energy Providers for Expats in the Netherlands">
                <p>
                  This structured directory uses provider-type discovery, comparison platforms and official consumer
                  orientation. It does not rank energy brands, invent reviews or guarantee bills.
                </p>
              </SectionIntro>
            ...
            <section id="comparison" className={sectionClass}>
              <SectionIntro eyebrow="Comparison table" title="Compare Provider Models">
                <p>
                  Use this as a starting point for your shortlist. Contract style, dual-fuel fit, English support and online
            ...
            {showAffiliateProviders && affiliateProviderData ? (
              <section id="affiliate-providers" className={sectionClass}>
                <SectionIntro eyebrow="Comparison support" title="Affiliates and Providers That May Help">
                  <p>
                    Soft discovery for Dutch energy comparison — prioritising Pricewise — not a ranking of energy brands.
                    Confirm unit rates, standing charges, contract length and exit fees before you switch. For meters and
                    water, use Energy &amp; water; for broadband, use Internet providers.
                  </p>
                </SectionIntro>
                <div className="mt-6">
                  <AffiliateBlockView
            ...
            <section id="checklist" className={sectionClass}>
              <SectionIntro eyebrow="Checklist" title="Before You Switch an Energy Contract">
                <p>
                  A short pre-switch checklist prevents most first-apartment regrets — especially around contract type,
                  standing charges, meter readings and lease length.
                </p>
              </SectionIntro>
              <div className="mt-6">
                <InfoTable
            ...
            <section id="questions" className={sectionClass}>
              <SectionIntro eyebrow="Provider interview" title="Questions Expats Should Ask">
                <p>
                  Use these questions before choosing a supplier. The answers should help you understand real rates,
                  standing charges, switch timing and exit terms.
                </p>
              </SectionIntro>
            ...
            >
              ...
              <div className="mt-6 rounded-3xl border border-white/10 bg-white/10 p-5 ring-1 ring-white/10">
                ...
                <ul className="mt-4 grid gap-3 text-sm leading-relaxed text-slate-300 sm:grid-cols-3">
                  ...
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Compare unit rate, standing charge, promo vs renewal and notice.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Plan meter readings and a clear switch start date.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
                    Keep meters and water on Energy & water — not this directory.
                  </li>
                  <li className="flex gap-2">
                    <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-cyan-200" aria-hidden />
            ...
            <section id="faq" className={sectionClass}>
              <SectionIntro eyebrow="FAQ" title="Frequently Asked Questions">
                <p>
                  Use these FAQ answers to identify what you still need to verify: fixed vs variable, dual-fuel, switching
                  and official consumer-rights orientation.
                </p>
              </SectionIntro>
            ...
            <section id="sources" className={sectionClass}>
              <SectionIntro eyebrow="Trust" title="Regulation & Official Resources">
                <p>
                  Consumers should verify rates and understand contract terms before proceeding. Official sources help you
            ...
            <section id="related-guides" className={sectionClass}>
              <SectionIntro eyebrow="Related guides" title="Continue Your Utilities & Connectivity Research">
                <p>
                  Use these guides to connect energy discovery to meters/setup how-to, internet, phone plans and housing timing.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="services-links" className={sectionClass}>
              <SectionIntro eyebrow="Services ecosystem" title="Related Services for Household Setup">
                <p>
                  Energy contracts often overlap with internet, phone, mobile connectivity, moving and rental timelines.
                </p>
              </SectionIntro>
              <div className={cn(sectionStackClass, "grid gap-4 sm:grid-cols-2 xl:grid-cols-3")}>
            ...
            <section id="explore-next" className={sectionClass}>
              <SectionIntro eyebrow="Explore next" title="Plan the Next Step">
                <p>
                  Move from energy discovery into the directories and guides that shape broadband, mobile and practical
                  setup.
                </p>
              </SectionIntro>
            ...
            <footer className="rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-sm leading-relaxed text-foreground-muted shadow-sm">
              ...
              no extra cost to you. Ordering reflects relevance to expat energy discovery and comparison orientation —
              not pay-to-rank placement of energy brands. This is not energy, financial or legal advice.
            </footer>
          </div>
        </Container>
      </main>
