...
export const howPaymentsWorkPageModel = {
  ...
  relatedTools: {
    ...
    cards: [
      { title: "Cash vs card", description: "PIN-first shops, cash pockets, and contactless till culture — everyday payment habits.", href: "/netherlands/money/banking/cash-vs-card/", ctaLabel: "Open guide" },
      { title: "Debit cards", description: "Pinpas, Maestro/Debit Mastercard norms, ATMs, and credit-first habit shifts.", href: "/netherlands/money/banking/debit-cards/", ctaLabel: "Open guide" },
      { title: "Credit cards", description: "When credit helps in the Netherlands — availability, fees orientation, vs debit for shops.", href: "/netherlands/money/banking/credit-cards/", ctaLabel: "Open guide" },
      { title: "Wise vs Revolut", description: "Multi-currency / app banking decision orientation beside a Dutch everyday account.", href: "/netherlands/money/banking/wise-vs-revolut/", ctaLabel: "Open guide" },
  ...
  faq: [
    ...
    { q: "Are credit cards widely accepted in the Netherlands?", a: "Debit is central for many shops and services. Credit cards are used but acceptance varies, especially in smaller shops or some online flows. For product orientation see Credit cards; for till culture see Cash vs card and Debit cards." },
