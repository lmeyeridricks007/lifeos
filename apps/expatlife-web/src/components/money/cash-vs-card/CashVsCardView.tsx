...
const snapshotIcons = [CreditCard, Banknote, Nfc, Smartphone] as const;
const orientationIcons = [Store, Banknote, Nfc, WalletCards] as const;
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-xl font-bold tracking-tight">Four habits for Dutch tills</h3>
...
export function CashVsCardView() {
  return (
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: "Cash vs card", item: new URL(CASH_VS_CARD_PATH, baseUrl).toString() },
        ]}
      />
        ...
        <Container className={cn("w-full max-w-screen-2xl", siteGuideColumnPadYClass)}>
          ...
          <div className={sectionStackClass}>
            ...
            >
              ...
              <ChecklistBlock title="Everyday payments file — keep these together" items={page.safetyFileChecklist} columns={2} />
              <ScenarioTable title="Where shoppers usually start" rows={page.introScenarios} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Snapshot" title="Cash vs card at a glance" fullWidth>
                  <p>Six cards cover everyday Dutch till culture. Deeper sections below expand each theme without ranking products.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              id="pin-first"
              tipsKey="pinFirst"
              visual={page.visuals.pinFirst}
              intro={
                <SectionIntro eyebrow="Shop culture" title={page.pinFirst.heading} fullWidth>
                  <p>{page.pinFirst.lead}</p>
                </SectionIntro>
              }
            >
              <ChecklistBlock title="What to expect at the till" items={page.pinFirst.bullets} columns={2} />
              <div className={guidePremiumCardGridClass(page.pinFirst.cards.length)}>
                {page.pinFirst.cards.map((card, idx) => (
                  <FeatureCard key={card.title} title={card.title} body={card.body} iconIndex={idx} />
                ))}
              </div>
              <div className={guidePremiumCardGridClass(page.pinFirst.crossLinks.length)}>
                {page.pinFirst.crossLinks.map((item, idx) => (
            ...
            <PremiumGuideSection
              id="cash-useful"
              tipsKey="cashUseful"
              visual={page.visuals.cashUseful}
              intro={
                <SectionIntro eyebrow="Cash pockets" title={page.cashUseful.heading} fullWidth>
                  <p>{page.cashUseful.lead}</p>
                </SectionIntro>
              }
            >
              <ChecklistBlock title="Where cash still helps" items={page.cashUseful.bullets} columns={2} />
              <InfoTable
                columns={compareColumns}
                rows={page.cashUseful.rows.map((row) => ({
                  setting: row.setting,
                  cash: row.cash,
                  card: row.card,
                  tip: row.tip,
            ...
            <PremiumGuideSection
              id="contactless"
              tipsKey="contactless"
              visual={page.visuals.contactless}
              intro={
                <SectionIntro eyebrow="Tap to pay" title={page.contactless.heading} fullWidth>
                  <p>{page.contactless.lead}</p>
                </SectionIntro>
              }
            >
              <BulletPanel title="Contactless habits" items={page.contactless.bullets} />
              <Timeline steps={page.contactless.timeline} eyebrow="Tap" />
              <WarningPanel
              ...
              />
              <div className={guidePremiumCardGridClass(page.contactless.crossLinks.length)}>
                {page.contactless.crossLinks.map((item, idx) => (
                  <LinkCard key={`${item.href}-${item.label}`} item={item} iconIndex={idx} />
                ))}
              </div>
            </PremiumGuideSection>
            ...
            >
              <ScenarioTable title="Tourist and expat stories" rows={page.scenarios.rows} />
            </PremiumGuideSection>
            ...
            <PremiumGuideSection
              ...
              visual={page.visuals.cashUseful}
              intro={
                <SectionIntro eyebrow="Getting cash" title={page.atms.heading} fullWidth>
                  <p>{page.atms.lead}</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Avoid" title={page.mistakes.heading} fullWidth>
                  <p>These patterns create avoidable till friction — calm backups beat awkward declines.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Ready for shops" title={page.checklist.heading} fullWidth>
                  <p>Work through this list before your first busy shopping or market day.</p>
                </SectionIntro>
              }
            >
              <ChecklistBlock title="Everyday payments checklist" items={page.checklist.items} columns={2} />
            </PremiumGuideSection>
            ...
            <section id="faq" className={sectionClass}>
              <div className={guidePremiumIntroStackClass}>
                <SectionIntro eyebrow="FAQ" title="Frequently asked questions" fullWidth>
                  <p>Short answers for the searches expats ask most often about cash vs card in Dutch shops.</p>
                </SectionIntro>
              </div>
              <div className={guidePremiumSectionDetailStackClass}>
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Related" title="Related banking guides" fullWidth>
                  <p>Live cluster siblings stay linkable — Debit cards, Credit cards and Wise vs Revolut.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Hub" title="Banking hub and cluster cards" fullWidth>
                  <p>Return to the Banking hub or jump to live cluster peers and the payments culture sibling.</p>
                </SectionIntro>
              }
            >
            ...
            <PremiumGuideSection
              ...
              intro={
                <SectionIntro eyebrow="Explore next" title="Pick your next money step" tone="onDark" fullWidth>
                  <p>Learn payment rails, open an account, shortlist banks, or model costs.</p>
                </SectionIntro>
              }
            >
