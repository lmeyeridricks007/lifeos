...
export const taxAdvisorsPage = {
  ...
  scenarios: [
    ...
    { title: "Filing first Dutch tax return", links: [{ label: "Tax returns", href: "/netherlands/money/tax-return-netherlands/", status: "live" }] },
    ...
    { title: "Working remotely for foreign employer", links: [{ label: "Foreign income", href: "/netherlands/taxes/foreign-income-netherlands/", status: "live" }] },
    { title: "International investments", links: [{ label: "How taxes work (boxes)", href: "/netherlands/money/how-taxes-work-in-the-netherlands/", status: "live" }] },
  ...
  relatedGuides: [
    ...
    { label: "Tax Residency", href: "/netherlands/money/tax-residency-netherlands/", status: "live", description: "Tax residency concepts without case determination." },
    { label: "Tax advisors (editorial guide)", href: "/netherlands/money/taxes/tax-advisors/", status: "live", description: "When to hire help and what to ask." },
    { label: "Official figures 2026", href: "/netherlands/official-figures/", status: "live", description: "Shared statutory citation table." },
