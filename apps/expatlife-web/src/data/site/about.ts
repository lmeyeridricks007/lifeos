/**
 * About Us page content for /about/.
 * Trust-building, editorial, E-E-A-T friendly. Single source for copy and structure.
 * Internal linking: footer and homepage should link to /about/; contact/legal pages can cross-link back.
 */

export const aboutPage = {
  seo: {
    title: "About ExpatCopilot | Practical Relocation Help for Expats Moving to the Netherlands",
    description:
    ...
    keywords: [
      ...
      "expat relocation help netherlands",
      "netherlands relocation platform",
      "moving to netherlands guide website",
      "expat services netherlands",
    ],
  },
  ...
  hero: {
    ...
    primaryCta: { label: "Explore Netherlands Guides", href: "/netherlands/moving-to-the-netherlands/" },
    secondaryCta: { label: "Browse Services", href: "/netherlands/services/" },
  },

  intro: {
    heading: "Why ExpatCopilot Exists",
    paragraphs: [
  ...
  audience: {
    heading: "Who ExpatCopilot Is Designed For",
    paragraphs: [
  ...
  differentiators: {
    heading: "What Makes This Different From a Generic Blog",
    points: [
  ...
  contentApproach: {
    heading: "How We Approach Content and Service Listings",
    paragraphs: [
  ...
  principles: {
    ...
    items: [
      { title: "Practical first", description: "Content and tools that help you do the next thing, not just read about it." },
      { title: "Clear over complicated", description: "We explain processes and options in plain language, with structure." },
      { title: "Trust over hype", description: "Honest positioning, no exaggerated claims. We say what the site does and does not do." },
      { title: "Useful comparisons", description: "Service categories and directories that help you see options and compare sensibly." },
      { title: "Better decisions, fewer surprises", description: "Timelines, checklists, and official links so you know what to expect and where to check." },
      { title: "Strong official-source awareness", description: "We point to government and authority sources so you can verify and stay up to date." },
    ],
  },

  netherlandsFirst: {
    heading: "Why the Platform Starts With the Netherlands",
    paragraphs: [
  ...
  cta: {
    ...
    links: [
      { label: "Netherlands hub", href: "/netherlands/", description: "Overview and entry point for all Netherlands content." },
      { label: "Services for expats", href: "/netherlands/services/", description: "Compare banks, insurance, housing, relocation, and more." },
      { label: "Dutch cities", href: "/netherlands/cities/", description: "City guides and comparison." },
      { label: "After arriving", href: "/netherlands/after-arriving-netherlands/", description: "What to do in your first weeks." },
    ],
  },
