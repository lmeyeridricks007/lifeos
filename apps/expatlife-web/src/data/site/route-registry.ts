...
export const COMING_SOON_ROUTES: Record<string, { title: string; section: RouteSection }> = {
  ...
  "/netherlands/taxes/30-percent-ruling/": { title: "30% ruling in the Netherlands", section: "guides" },
...
const EXTRA_LIVE_PATHS = [
  ...
  /** Flagship health guide — hospitals / secondary care cornerstone for expats. */
  "/netherlands/health/hospitals-netherlands/",
  /** Flagship health guide — emergency healthcare cornerstone for expats. */
  ...
  /** Long-term stay cluster — PR, citizenship, inburgering (scheduled go-live). */
