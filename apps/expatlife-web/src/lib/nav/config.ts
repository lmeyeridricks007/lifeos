...
function isMovingPillarPath(pathname: string): boolean {
  ...
  const movingPrefixes = [
    ...
    "/netherlands/after-arriving-netherlands",
    ...
    sections: [
      {
        ...
        items: [
          ...
          item("Moving documents checklist", "/netherlands/document-readiness-checker/"),
      ...
      },
      {
        title: "Documents",
        items: [
          item("Visa documents", "/netherlands/document-readiness-checker/"),
      ...
      },
      {
        ...
        items: [
          ...
          item("Settling in", "/netherlands/after-arriving-netherlands/"),
