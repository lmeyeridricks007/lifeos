/**
 * Extended editorial + SEO layout for the Spain → Netherlands origin-country guide (EU citizens).
...
const OFFICIAL_NL_EU_ES: Array<{ label: string; href: string }> = [
  {
...
/** Dutch-side guidance on Spanish documents; confirm apostille needs per document type */
const OFFICIAL_ES_DOCS: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Spanish documents for use in the Netherlands",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/spain",
  },
  {
...
const SPAIN_RELATED_INTERNAL = filterLiveInternalLinks([
...
function spainSections(
  ...
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from Spain Need to Know Before Moving to the Netherlands",
      body: [
        "Moving from Spain to the Netherlands is usually simpler on the immigration side than relocating from outside the EU: as a Spanish national you exercise EU free movement rather than applying for an MVV or standard residence permit for ordinary long-term stay.",
        ...
        "Document handling is often more straightforward than for many non-EU origins: Netherlands Worldwide explains that many Spanish documents can be used in the Netherlands immediately, while others need an apostille from the Spanish authorities—and official documents in Spanish do not have to be translated for use in the Netherlands. Rules still depend on document type and who requests them, so verify each case.",
    ...
    {
      id: "eu-visa-basics",
      heading: "Visa and Residence Permit Basics for Spanish Citizens",
      body: [
        "Spanish nationals are EU citizens. Under the applicable EU rules, you can live in the Netherlands without a visa or standard residence permit for ordinary residence based on free movement, provided you meet the conditions for your situation (work, study, self-sufficiency, etc.). The IND and Government.nl explain how EU, EEA, and Swiss citizens stay in the Netherlands.",
        ...
        "That is a different starting point from our guides for non-EU nationals, where MVV and residence permits are often central. For a typical move from Spain, the emphasis shifts to BRP registration, proof of address, insurance, and local services—not a default “visa application” path.",
      ...
      callout: {
        ...
        text: "This page does not describe a standard MVV or residence-permit route for Spanish nationals exercising EU free movement. Confirm your circumstances on Government.nl and the IND.",
      },
      links: [
        {
    ...
    {
      id: "registration-bsn",
      heading: "Registering in the Netherlands After Moving from Spain",
      body: [
        ...
        "Cross-border workers or people who keep their main residence in Spain may follow different rules for registration, tax, and social insurance. If that could be you, check official guidance rather than assuming a standard full-move checklist applies.",
      ],
      bullets: [
    ...
    {
      id: "documents",
      heading: "Documents People Moving from Spain Often Need Before Moving",
      body: [
        "Bring a valid passport or national ID (DNI), your Dutch address proof where you already have it, and civil-status documents (birth, marriage, partnership, divorce) if schools, employers, or the gemeente need them. Multilingual extracts can help when an organisation asks for a standard format.",
        "Netherlands Worldwide’s Spain page explains which Spanish documents can be used immediately in the Netherlands and which need an apostille from the Spanish authorities. Official documents in Spanish do not need to be translated for use in the Netherlands—but the requesting organisation may still have format or recency requirements.",
        "Apostille or legalisation is not the default for every Spanish document; treat it as document-type dependent. Use the “convert foreign documents” guidance when you need a Dutch civil-registry extract equivalent; not every situation is covered by the same rule.",
      ],
      bullets: [
        "Passport or national ID card (DNI)",
        "Rental or purchase proof for your Dutch address",
        "Civil-status documents when relevant (check Spain-specific guidance)",
    ...
    {
      id: "visa-route",
      heading: "Common Spain-to-Netherlands Move Scenarios",
      body: [
      ...
      visaRoutes: {
        commonRoutes: [
          ...
          "Cross-border or bi-national within the EU — if your main home stays in Spain or you split time, social security coordination, tax residency, and registration obligations can differ from a single-country move. Verify against official sources.",
    ...
    {
      id: "costs",
      heading: "What to Budget For When Moving from Spain",
      body: [
        "Spain–Netherlands moves combine international transport with Dutch housing deposits, agency fees, and first-month costs. Use the table as categories to research—not fixed amounts.",
        costsDisclaimer ?? "",
      ].filter(Boolean),
      table: {
        ...
        rows: [
          ...
          ["Apostille or copies", "Per document", "Spanish apostille or certified copies only where Netherlands Worldwide says they are needed."],
        ],
      },
    ...
    },
    {
      ...
      body: [
        ...
        "The after-arrival guide ties these steps together; the links below jump to the pages Spanish movers use most in the first weeks.",
      ],
      bullets: [
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from Spain to the Netherlands",
      body: [
    ...
    {
      id: "cities-spain",
      heading: "Popular Dutch Cities People Moving from Spain Often Consider",
      body: [
        "Many people from Spain weigh international hiring pools in Amsterdam and Rotterdam, centrality in Utrecht, institutions in The Hague, tech and engineering around Eindhoven, or university towns—plus Maastricht and southern cities for proximity to Belgium and Germany, and regional hubs for lifestyle and rent pressure.",
      ],
      links: filterLiveInternalLinks([
    ...
    },
    {
      ...
      heading: "Cross-border logistics from Spain",
      body: [
        "Many people fly direct from Madrid, Barcelona, or other airports; others drive or combine train segments. If you move household goods, plan parking, building access, and gemeente rules in dense Dutch cities.",
      ],
      links: [
    ...
    },
    {
      ...
      body: [
        ...
        "Spain-specific document use and legalisation (Dutch official guidance)",
      ],
      links: [...OFFICIAL_NL_EU_ES, ...OFFICIAL_ES_DOCS],
    },
  ];
}

export function augmentSpainGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    subtitle:
      "Discover the registration rules, document requirements, housing considerations, and practical settlement steps for people moving from Spain to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "Spain to Netherlands Move at a Glance",
    quickAnswers: [
      {
      ...
      },
      {
        ...
        value: "Many Spanish documents usable directly; Spanish often needs no translation; some documents need apostille—verify each case",
      },
      {
        label: "Good fit for",
    ...
    heroCta: {
      title: "Plan your move from Spain",
      supportingText:
    ...
    sections: spainSections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: SPAIN_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from Spain",
    servicesSectionTitle: "Useful Services for People Moving from Spain to the Netherlands",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common Spain-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Each scenario stresses different setup steps. Use the checklist with ?from=spain to keep your origin context.",
    exampleScenarios: [
      {
        title: "Spanish professional moving for work",
        summary:
      ...
      {
        title: "Spanish student moving for study",
        summary:
          "Confirm enrolment and housing; check insurance rules for students. Use Netherlands Worldwide’s Spain page to see whether your civil documents need an apostille.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
      ...
      },
      {
        ...
        summary:
          "If your main residence may stay in Spain or you split time, check registration, insurance, and social-security guidance before assuming a full relocation checklist.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Spanish family preparing civil-status documents",
        summary:
          "Follow Netherlands Worldwide (Spain): some documents are accepted directly; others need an apostille. Spanish originals often need no translation for Dutch authorities—confirm with the requesting body.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Spanish freelancer or remote worker moving for lifestyle",
        summary:
