/**
 * Extended editorial + SEO layout for the Kenya → Netherlands origin-country guide.
 * Non-EU framing: Schengen short stay (in person, VFS Nairobi) vs long-stay MVV/residence permit (embassy Nairobi);
 * Kenyan documents legalised by the Ministry of Foreign Affairs per Netherlands Worldwide.
 */
...
const OFFICIAL_KE_VISA: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — MVV long stay (apply in Kenya)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-kenya",
  },
  {
    label: "Netherlands Worldwide — Schengen visa (apply in Kenya)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-kenya",
  },
  {
    label: "Netherlands Worldwide — Making an appointment (Kenya)",
    href: "https://www.netherlandsworldwide.nl/making-appointment/kenya",
  },
  {
...
const OFFICIAL_KE_LEGAL: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Legalisation: documents from Kenya",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/kenya",
  },
  {
...
const KENYA_RELATED_INTERNAL = filterLiveInternalLinks([
...
function kenyaSections(fromQuery: string, costEstimatorHref: string, costsDisclaimer?: string): GuideSection[] {
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from Kenya Need to Know Before Moving to the Netherlands",
      body: [
    ...
    {
      id: "visa-route",
      heading: "Main Ways to Move from Kenya to the Netherlands",
      body: [
    ...
    },
    {
      ...
      heading: "Visa, MVV and Residence Permit Basics for Moving from Kenya",
      body: [
      ...
      callout: {
        ...
        href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-kenya",
        linkLabel: "Schengen visa from Kenya (Netherlands Worldwide)",
      },
      links: [
        { label: "Visa consultants", href: "/netherlands/services/visa-consultants/" },
        { label: "Immigration lawyers", href: "/netherlands/services/immigration-lawyers/" },
        ...
        {
          label: "MVV long stay — apply in Kenya",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-kenya",
        },
        { label: "IND — MVV exemptions", href: "https://ind.nl/en/mvv-exemptions" },
      ],
    },
    {
      ...
      links: [
        {
          label: "Schengen visa — apply in Kenya",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-kenya",
        },
        {
          label: "MVV long stay — apply in Kenya",
        ...
        {
          label: "Making an appointment (Kenya)",
          href: "https://www.netherlandsworldwide.nl/making-appointment/kenya",
        },
      ],
    },
    {
      id: "documents",
      heading: "Documents People Moving from Kenya Often Need Before Moving",
      body: [
      ...
      links: [
        ...
        { label: "Documents needed to move", href: DOCUMENTS_GUIDE_PATH },
        {
          label: "Legalisation — documents from Kenya",
          href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/kenya",
        },
      ],
    },
    {
      id: "costs",
      heading: "What to Budget For When Moving from Kenya",
      body: [
      ...
      table: {
        ...
        rows: [
          [
            "Visa / permit fees",
            "Route-dependent",
            "Use official IND and Netherlands Worldwide pages; avoid informal estimates.",
          ],
          [
            "Document legalisation",
            "Per document / per step",
            "Kenyan Ministry of Foreign Affairs legalisation; factor courier and repeat visits if needed.",
          ],
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from Kenya to the Netherlands",
      body: [
    ...
    {
      id: "cities-kenya",
      heading: "Popular Dutch Cities People Moving from Kenya Often Consider",
      body: [
    ...
    },
    {
      ...
      links: [...OFFICIAL_NL_IMMIGRATION, ...OFFICIAL_KE_VISA, ...OFFICIAL_KE_LEGAL, ...OFFICIAL_IND_EXTRA],
    },
  ];
}

export function augmentKenyaGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    subtitle:
      "Discover visa routes, MVV and residence-permit steps when they apply, Kenyan document legalisation rules, and practical settlement guidance for moving from Kenya to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "Kenya to Netherlands Move at a Glance",
    quickAnswers: [
      {
      ...
      },
      {
        ...
        value: "Residence-permit planning plus MFA-legalised Kenyan documents when required",
      },
      {
        label: "Common document issue",
        value: "Kenyan documents must be legalised by the Kenyan Ministry of Foreign Affairs; Swahili often needs translation when required",
      },
      {
        label: "Good fit for",
      ...
      },
      {
        ...
        value: "Confirm permit route, legalise documents, book in-person VFS or embassy steps, plan BSN and first-week setup",
      },
      {
        label: "Trade-off to know",
        value: "Permit, legalisation, and appointment timing can add complexity—start early",
      },
    ],
    tocItems: [
    ...
    heroCta: {
      title: "Plan your move from Kenya",
      supportingText:
    ...
    sections: kenyaSections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: KENYA_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from Kenya",
    servicesSectionTitle: "Useful Services for People Moving from Kenya to the Netherlands",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common Kenya-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Each scenario highlights different priorities. Use the checklist tool with ?from=kenya to keep your origin context while you work through tasks.",
    exampleScenarios: [
      {
        title: "Kenyan professional moving for work",
        summary:
          "Coordinate IND timing with your sponsor, MVV collection in Nairobi per Netherlands Worldwide, MFA legalisation on civil documents, housing near work, and BSN-first banking and insurance. Compare highly skilled migrant sponsors if your employer does not run the full process.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Kenyan student moving for university",
        summary:
          "Align admission, study-permit conditions, proof of funds, and housing; complete MFA legalisation and confirm Swahili translation needs if the institution or IND checklist requires them.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Partner or family relocation from Kenya",
        summary:
          "Relationship and civil documents are central; timelines depend on the sponsor’s status. MFA legalisation and translations are common—see our document guides and Netherlands Worldwide’s Kenya legalisation page.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
      ...
      {
        title: "Family preparing legalised Kenyan documents for Dutch use",
        summary:
          "Batch legalisation through the Kenyan Ministry of Foreign Affairs, track Swahili translations where required, and keep originals complete per Netherlands Worldwide before submission windows.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
