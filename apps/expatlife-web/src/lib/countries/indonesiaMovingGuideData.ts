/**
 * Extended editorial + SEO layout for the Indonesia → Netherlands origin-country guide.
 * Non-EU framing: Schengen short stay via VFS Global (Bali, Jakarta, Surabaya) vs long-stay MVV/residence permit;
 * MVV collection at the Dutch embassy in Jakarta when the IND letter applies; Indonesian documents via Ministry of Law apostille.
 */
...
const OFFICIAL_ID_VISA: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — MVV long stay (apply in Indonesia)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-indonesia",
  },
  {
    label: "Netherlands Worldwide — Making an appointment (Indonesia)",
    href: "https://www.netherlandsworldwide.nl/making-appointment/indonesia",
  },
  {
    label: "Netherlands Worldwide — Schengen visa (apply in Indonesia)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-indonesia",
  },
  {
    label: "Netherlands Worldwide — Entry visa (apply in Indonesia)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/entry-visa/apply-indonesia",
  },
  {
  ...
  {
    label: "Netherlands Worldwide — Civic integration exam abroad (Indonesia)",
    href: "https://www.netherlandsworldwide.nl/civic-integration-exam-abroad/indonesia",
  },
  {
...
const OFFICIAL_ID_LEGAL: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Legalisation: documents from Indonesia",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/indonesia",
  },
  {
...
const INDONESIA_RELATED_INTERNAL = filterLiveInternalLinks([
...
function indonesiaSections(fromQuery: string, costEstimatorHref: string, costsDisclaimer?: string): GuideSection[] {
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from Indonesia Need to Know Before Moving to the Netherlands",
      body: [
        "Moving from Indonesia to the Netherlands usually means planning around immigration permission, civil documents, housing, banking, Dutch basic health insurance, and municipal registration—not only booking a flight. Indonesian nationals are not EU, EEA, or Swiss citizens, so stays longer than short visits are normally built around a Dutch residence permit for a recognised purpose.",
        "Short visits and long-term relocation follow different procedures. Schengen short-stay applications from Indonesia (and for applicants living in Timor-Leste) are submitted through VFS Global in Bali, Jakarta, or Surabaya, as described on Netherlands Worldwide. That channel is not a substitute for a residence permit if you intend to live in the Netherlands.",
        ...
        "This guide explains the main pathways, how the MVV often fits into relocation when it applies, what Indonesian document legalisation usually involves (apostille by the Indonesian Ministry of Law, translations when required), and which practical Netherlands guides to open next. It supports planning—it is not legal advice and does not guarantee any outcome.",
      ],
      links: [
    ...
    {
      id: "visa-route",
      heading: "Main Ways to Move from Indonesia to the Netherlands",
      body: [
    ...
    },
    {
      ...
      heading: "Visa, MVV and Residence Permit Basics for Moving from Indonesia",
      body: [
        ...
        "Netherlands Worldwide publishes an Indonesia-specific page for the MVV long-stay visa. You can only apply for the MVV visa sticker at the Dutch embassy in Jakarta when that is stated in your IND positive decision letter. Always follow the current instructions on Netherlands Worldwide’s Indonesia MVV and appointment pages for scheduling, passport rules, and supporting documents.",
        ...
        "This site cannot tell you whether your specific route requires an MVV. Use the official checklist for your permit type, the IND MVV exemption page if relevant, and the Indonesia-specific Netherlands Worldwide pages.",
      ],
      callout: {
        type: "warning",
        ...
        href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-indonesia",
        linkLabel: "Schengen visa from Indonesia (Netherlands Worldwide)",
      },
      links: [
        { label: "Visa consultants", href: "/netherlands/services/visa-consultants/" },
        { label: "Immigration lawyers", href: "/netherlands/services/immigration-lawyers/" },
        ...
        {
          label: "MVV long stay — apply in Indonesia",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-indonesia",
        },
        { label: "IND — MVV exemptions", href: "https://ind.nl/en/mvv-exemptions" },
      ],
    },
    {
      ...
      body: [
        "Short visits to the Schengen area (including the Netherlands) use short-stay Schengen visa rules when a visa is required. Netherlands Worldwide explains that applications for a Netherlands Schengen visa from Indonesia are submitted through VFS Global, with service points in Bali, Jakarta, and Surabaya, and that you can apply there if you live in Indonesia or Timor-Leste.",
        "Long-term relocation normally means a residence permit (and often an MVV) tied to work, study, family, or another recognised basis. Procedures, documents, and embassy steps are explained on IND.nl and the Indonesia-specific Netherlands Worldwide pages for MVV and appointments.",
      ...
      links: [
        {
          label: "Schengen visa — apply in Indonesia",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-indonesia",
        },
        {
    ...
    {
      id: "documents",
      heading: "Documents People Moving from Indonesia Often Need Before Moving",
      body: [
        ...
        "Netherlands Worldwide states that to use a document from Indonesia in the Netherlands it must be legalised with an apostille by the Indonesian Ministry of Law—a simplified legalisation route for use in the Netherlands. Whether you also need certified translation depends on the document and the authority that receives it; cross-check the Indonesia legalisation page on Netherlands Worldwide and our document translation guide for general patterns, then confirm against your IND or sponsor checklist.",
        "Build in buffer time: civil registry steps, Ministry of Law apostille, possible translations, and VFS or embassy appointment scheduling all compete with employer or university deadlines.",
      ],
      bullets: [
        ...
        "Ministry of Law apostille on Indonesian-issued documents intended for Dutch authorities, when legalisation is required",
      ...
      links: [
        ...
        { label: "Documents needed to move", href: DOCUMENTS_GUIDE_PATH },
        {
          label: "Legalisation — documents from Indonesia",
          href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/indonesia",
        },
      ],
    },
    {
      ...
      body: [
        "Some family-based migration routes may require the civic integration exam abroad before arrival. Netherlands Worldwide hosts an Indonesia-specific page for this process, including practical information for eligible applicants.",
        "This step applies only when your official IND checklist and permit category require it—not to every person moving from Indonesia. If your route does not mention the exam, do not assume you must take it.",
      ],
      links: [
        {
          label: "Civic integration exam abroad — Indonesia",
          href: "https://www.netherlandsworldwide.nl/civic-integration-exam-abroad/indonesia",
        },
    ...
    {
      id: "costs",
      heading: "What to Budget For When Moving from Indonesia",
      body: [
      ...
      table: {
        ...
        rows: [
          ...
          [
            ...
            "Ministry of Law apostille in Indonesia; factor courier and repeat visits if needed.",
          ],
    ...
    },
    {
      ...
      body: [
        ...
        "Our after-arrival guide expands the sequence; the links below are the topics Indonesian movers most often open first.",
      ],
      bullets: [
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from Indonesia to the Netherlands",
      body: [
    ...
    {
      id: "cities-indonesia",
      heading: "Popular Dutch Cities People Moving from Indonesia Often Consider",
      body: [
    ...
    },
    {
      ...
      body: [
        "Moves from Indonesia often combine air freight for essentials with sea freight for larger households. Many people book short-term furnished housing in the Netherlands while apostille work, permit decisions, and shipments align.",
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        ...
        "Indonesia — Dutch visa, MVV, appointments, waiting times, and civic integration abroad",
        "Indonesia — document apostille and legalisation",
        "Additional IND references (exemptions, orientation year, partner)",
      ],
      links: [...OFFICIAL_NL_IMMIGRATION, ...OFFICIAL_ID_VISA, ...OFFICIAL_ID_LEGAL, ...OFFICIAL_IND_EXTRA],
    },
  ];
}

export function augmentIndonesiaGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    subtitle:
      "Discover the main visa routes, MVV requirements, document apostille rules, and practical settlement steps for moving from Indonesia to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "Indonesia to Netherlands Move at a Glance",
    quickAnswers: [
      {
      ...
      },
      {
        ...
        value: "Residence-permit planning plus apostilled documents from Indonesia when required",
      },
      {
        label: "Common document issue",
        value: "Indonesian documents need apostille by the Indonesian Ministry of Law for Dutch use when legalisation is required",
      },
      {
        label: "Good fit for",
      ...
      },
      {
        ...
        value: "Determine permit route, prepare documents, plan MVV/embassy steps if applicable, line up registration and first-week setup",
      },
      {
    ...
    tocItems: [
      ...
      { id: "cities-indonesia", label: "Cities" },
    ...
    heroCta: {
      title: "Plan your move from Indonesia",
      supportingText:
    ...
    sections: indonesiaSections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: INDONESIA_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from Indonesia",
    servicesSectionTitle: "Useful Services for People Moving from Indonesia to the Netherlands",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common Indonesia-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Each scenario highlights different priorities. Use the checklist tool with ?from=indonesia to keep your origin context while you work through tasks.",
    exampleScenarios: [
      {
        title: "Indonesian professional moving for work",
        summary:
          "Coordinate IND timing with your sponsor, MVV collection in Jakarta when your letter requires it, Ministry of Law apostille on civil documents, housing near work, and BSN-first banking and insurance. Compare highly skilled migrant sponsors and relocation support if your employer does not run the full process.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Indonesian student moving for university",
        summary:
          "Align admission, study-permit conditions, proof of funds, and housing; complete Ministry of Law apostille on Indonesian civil records and confirm translations if the institution or IND checklist requires them.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Partner or family relocation from Indonesia",
        summary:
          "Relationship and civil documents are central; timelines depend on the sponsor’s status. Check whether the civic integration exam abroad applies on Netherlands Worldwide’s Indonesia page. Apostille and translations are common—see our document guides.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
      ...
      },
      {
        ...
        summary:
          "Work from the Netherlands Worldwide Indonesia legalisation page: Ministry of Law apostille, then confirm translation needs per document. Line up scans and originals before embassy or IND submission windows.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
