/**
 * Extended editorial + SEO layout for the South Korea → Netherlands origin-country guide.
...
const OFFICIAL_KR_NWW: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — MVV long stay (apply in South Korea)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-south-korea",
  },
  {
    label: "Netherlands Worldwide — Making an appointment (South Korea)",
    href: "https://www.netherlandsworldwide.nl/making-appointment/south-korea",
  },
  {
    label: "Netherlands Worldwide — Schengen visa (apply in South Korea)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-south-korea",
  },
  {
    label: "Netherlands Worldwide — Entry visa (apply in South Korea)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/entry-visa/apply-south-korea",
  },
  {
    label: "Netherlands Worldwide — Civic integration exam abroad (South Korea)",
    href: "https://www.netherlandsworldwide.nl/civic-integration-exam-abroad/south-korea",
  },
  {
...
const OFFICIAL_KR_DOCS: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Legalisation of documents from South Korea",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/south-korea",
  },
  {
...
const SOUTH_KOREA_RELATED_INTERNAL = filterLiveInternalLinks([
...
function southKoreaSections(
  ...
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from South Korea Need to Know Before Moving to the Netherlands",
      body: [
        "Moving from South Korea to the Netherlands usually means planning around immigration permission, civil documents, housing, banking, health coverage, and municipal registration—not only booking a flight. South Korea is outside the EU, EEA, and Switzerland, so permit rules are central to most longer stays.",
        ...
        "Not everyone follows the same path: sponsored employment, study, partner or family routes, entrepreneurship where criteria are met, and corporate assignments all have different evidence, sponsors, and timelines. This guide maps the main themes and points you to official Dutch and South Korea–specific consular pages—planning support only, not guaranteed legal advice.",
      ],
      links: [
        { label: "EU vs non-EU moving to the Netherlands", href: "/netherlands/eu-vs-non-eu-moving-to-the-netherlands/" },
    ...
    {
      id: "visa-mvv",
      heading: "Visa, MVV and Residence Permit Basics for Moving from South Korea",
      body: [
        "Short stays: Schengen short-stay rules apply to visits up to 90 days in the Schengen area. Netherlands Worldwide publishes South Korea–specific pages for Schengen visas and entry visas when one is required. Many South Korean passport holders can visit short-term without a Schengen visa under current rules, but your purpose of stay and any unusual circumstances still matter; do not confuse tourism with relocating.",
        ...
        "Procedure: in many long-stay routes, MVV and residence permit steps are linked and handled from abroad with a sponsor or institution. After a positive decision, the IND letter indicates where to collect the MVV sticker. For applicants in South Korea, appointments and collection are often coordinated through the Dutch embassy in Seoul when that applies to you—follow Netherlands Worldwide for South Korea. This is not the same workflow as a short trip.",
      ...
      callout: {
        ...
        href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-south-korea",
        linkLabel: "MVV from South Korea (Netherlands Worldwide)",
      },
      links: [
        ...
        {
          label: "MVV long stay — apply in South Korea",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-south-korea",
        },
        {
          label: "Schengen visa — apply in South Korea",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-south-korea",
        },
      ],
    },
    {
      id: "visa-route",
      heading: "Main Ways to Move from South Korea to the Netherlands",
      body: [
      ...
      visaRoutes: {
        commonRoutes: [
          ...
          "Highly skilled migrant — salary and sponsor rules apply; timelines are often driven by IND processing and MVV collection in South Korea when required.",
        ...
        notes: [
          ...
          "Some family-based routes may involve civic integration requirements; Netherlands Worldwide lists South Korea–specific information for the civic integration exam abroad when it applies.",
        ],
      },
      callout: {
        type: "info",
    ...
    {
      id: "documents",
      heading: "Documents People Moving from South Korea Often Need Before Moving",
      body: [
        "Start with a valid passport and the checklist your sponsor, university, or Netherlands Worldwide provides for your permit type. Civil documents (birth, marriage, family relation registers where used) are common for family and registration steps.",
        "To use many South Korea–issued public documents in the Netherlands, legalisation with a Hague apostille through the competent South Korean authorities is the standard path described on Netherlands Worldwide—this simplified legalisation allows many documents to be used cross-border. Documents in Korean generally need translation into Dutch, English, French, or German for Dutch administrative use; confirm the exact language and sworn-translator rules with the IND, your sponsor, or the gemeente for each document.",
      ...
      bullets: [
        ...
        "Apostille on South Korean public documents when legalisation is required",
        "Certified or sworn translations when Korean originals are requested",
      ...
      links: [
        ...
        { label: "Documents needed to move", href: DOCUMENTS_GUIDE_PATH },
        {
          label: "Netherlands Worldwide — legalisation (South Korea)",
          href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/south-korea",
        },
      ],
    },
    {
      ...
      body: [
        "Short visits fall under Schengen short-stay rules (up to 90 days in any 180-day period in the Schengen area, subject to the official conditions that apply to you). Netherlands Worldwide’s South Korea pages explain when a Schengen visa or entry visa is needed.",
        ...
        "If you are interviewing or scouting housing from South Korea, keep activities aligned with the entry rules that apply to you; a short visit does not authorise work or replace a permit.",
      ],
      links: [
        {
          label: "Schengen visa — apply in South Korea",
    ...
    {
      id: "costs",
      heading: "What to Budget For When Moving from South Korea",
      body: [
      ...
      table: {
        ...
        rows: [
          [
            ...
            "Route-dependent",
            "Check IND and consular fee pages; KRW/EUR moves with exchange rates.",
          ],
          [
            "Apostille / legalisation (South Korean authorities)",
            "Per document",
            "Batch where possible; courier or express options cost more.",
          ],
          [
            "Translation (Korean → Dutch/English/French/German as required)",
            "Per document or page",
            "Match translator credentials to what your sponsor or gemeente requests.",
          ],
          [
            "Flights South Korea–Netherlands",
            "Seasonal",
    ...
    },
    {
      ...
      body: [
        ...
        "Book gemeente slots early in tight markets; keep apostilled documents and accepted translations accessible for any follow-up appointments.",
      ],
      bullets: [
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from South Korea to the Netherlands",
      body: [
        "Non-EU moves from South Korea are often immigration-, translation-, and document-heavy. Many people compare regulated visa consultants, immigration lawyers, relocation agencies, housing platforms, banks, and insurers while still in South Korea. The hubs below match listings used elsewhere on this site; provider cards in “Useful services” draw from the same dataset—compare scope and fees yourself.",
      ],
    ...
    {
      id: "cities-south-korea",
      heading: "Popular Dutch Cities People Moving from South Korea Often Consider",
      body: [
    ...
    },
    {
      ...
      body: [
        "South Korea–to–Europe moves often combine sea freight for household goods with air baggage or courier for essentials. Temporary furnished housing in the Netherlands helps while shipments and MVV-driven travel dates align.",
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        ...
        "South Korea–specific Dutch visa, MVV, appointments, civic integration exam, and processing information:",
        "South Korea document legalisation and Hague apostille context:",
        "Always confirm the latest version on the official site—procedures and fees change.",
      ],
      links: [...OFFICIAL_NL_IMMIGRATION, ...OFFICIAL_KR_NWW, ...OFFICIAL_KR_DOCS],
    },
  ];
}

export function augmentSouthKoreaGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    lastUpdated: "Last updated: 24 April 2026.",
    title: "Moving to the Netherlands from South Korea",
    metaTitle: model.seo.title,
    subtitle:
      "Discover the main visa routes, MVV requirements, document apostille rules, and practical settlement steps for moving from South Korea to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "South Korea to Netherlands Move at a Glance",
    quickAnswers: [
      { label: "Main move routes", value: "Work, study, partner/family, entrepreneur, sponsored relocation" },
      {
        label: "Key admin theme",
        value: "Residence-permit planning plus apostilled and translated documents where required",
      },
      {
        label: "Common document issue",
        value: "South Korean documents need apostille; Korean originals often need translation for Dutch use",
      },
      ...
      },
      {
        ...
        value: "Permit, embassy, apostille, and translation timing can add complexity—start early",
      },
    ],
    tocItems: [
      ...
      { id: "cities-south-korea", label: "Cities" },
    ...
    heroCta: {
      title: "Plan your move from South Korea",
      supportingText:
        "Use the moving hub, regulated services, and tools to sequence MVV and residence steps, apostilles, translations, housing, and first-month admin.",
    ...
    sections: southKoreaSections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: SOUTH_KOREA_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from South Korea",
    servicesSectionTitle: "Useful services when relocating from South Korea",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common South Korea-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Use the checklist tool with ?from=south-korea to keep origin context while you work through tasks.",
    exampleScenarios: [
      {
        title: "South Korean professional moving for work",
        summary:
          "Align sponsor timelines, MVV collection per your IND letter (often via Seoul when applicable), housing within commute range, and BSN-first banking and insurance.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "South Korean student moving for university",
        summary:
          "Match admission to study permit conditions; plan apostilles and translations on academic and civil documents; budget for student housing competition.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Partner or family relocation from South Korea",
        summary:
      ...
      {
        title: "Sponsored corporate transfer from South Korea",
        summary:
      ...
      {
        title: "Family preparing apostilled and translated documents for Dutch use",
        summary:
          "Batch apostille steps, schedule sworn translations into an accepted language, and keep originals organised for gemeente and IND follow-ups.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
