/**
 * Extended editorial + SEO layout for the Italy → Netherlands origin-country guide (EU citizens).
...
const OFFICIAL_NL_EU_IT: Array<{ label: string; href: string }> = [
  {
...
/** Dutch-side guidance on Italian documents; apostille / Hague context from Netherlands Worldwide */
const OFFICIAL_IT_DOCS: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Italian documents for use in the Netherlands",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/italy",
  },
  {
  ...
  {
    label: "Netherlands Worldwide — What is legalisation and apostille?",
...
const ITALY_RELATED_INTERNAL = filterLiveInternalLinks([
...
function italySections(
  ...
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from Italy Need to Know Before Moving to the Netherlands",
      body: [
        "Moving from Italy to the Netherlands is usually simpler on the immigration side than relocating from outside the EU: as an Italian national you exercise EU free movement rather than applying for an MVV or standard residence permit for ordinary long-term stay.",
        ...
        "Document handling is often more straightforward than for many non-EU origins: Netherlands Worldwide explains that many Italian documents can be used in the Netherlands immediately, while others need an apostille from the Italian authorities—and official documents in Italian do not have to be translated for use in the Netherlands. Rules still depend on document type and who requests them, so verify each case.",
        "This guide maps the usual sequence and points to official Dutch sources. It supports planning only; it is not legal advice.",
      ],
      links: [
        { label: "EU vs non-EU moving to the Netherlands", href: "/netherlands/eu-vs-non-eu-moving-to-netherlands/" },
    ...
    {
      id: "eu-visa-basics",
      heading: "Visa and Residence Permit Basics for Italian Citizens",
      body: [
        "Italian nationals are EU citizens. Under the applicable EU rules, you can live in the Netherlands without a visa or standard residence permit for ordinary residence based on free movement, provided you meet the conditions for your situation (work, study, self-sufficiency, etc.). The IND and Government.nl explain how EU, EEA, and Swiss citizens stay in the Netherlands.",
        "For short stays, EU, EEA, and Swiss citizens can generally remain in the Netherlands for up to three months with a valid travel document, without additional formalities beyond what applies to short visits; longer stays follow the EU rules for residence. Always confirm your situation on Government.nl and the IND.",
        "That is a different starting point from our guides for non-EU nationals, where MVV and residence permits are often central. For a typical move from Italy, the emphasis shifts to BRP registration, proof of address, insurance, and local services—not a default “visa application” path.",
      ...
      callout: {
        ...
        text: "This page does not describe a standard MVV or residence-permit route for Italian nationals exercising EU free movement. Confirm your circumstances on Government.nl and the IND.",
      },
      links: [
        {
    ...
    {
      id: "registration-bsn",
      heading: "Registering in the Netherlands After Moving from Italy",
      body: [
        ...
        "Cross-border workers or people who keep their main residence in Italy may follow different rules for registration, tax, and social insurance. If that could be you, check official guidance rather than assuming a standard full-move checklist applies.",
      ],
      bullets: [
    ...
    {
      id: "documents",
      heading: "Documents People Moving from Italy Often Need Before Moving",
      body: [
        "Bring a valid passport or Italian national ID (carta d'identità) where accepted, your Dutch address proof where you already have it, and civil-status documents (birth, marriage, partnership, divorce) if schools, employers, or the gemeente need them. Multilingual extracts can help when an organisation asks for a standard format.",
        "Netherlands Worldwide’s Italy page explains which Italian documents can be used immediately in the Netherlands and which need an apostille from the Italian authorities. Official documents in Italian do not need to be translated for use in the Netherlands—but the requesting organisation may still have format or recency requirements.",
        "Apostille or legalisation is not the default for every Italian document; treat it as document-type dependent. Use the “convert foreign documents” guidance when you need a Dutch civil-registry extract equivalent; not every situation is covered by the same rule.",
      ],
      bullets: [
        "Passport or carta d'identità (where accepted for your procedure)",
        "Rental or purchase proof for your Dutch address",
        "Civil-status documents when relevant (check Italy-specific guidance)",
    ...
    {
      id: "visa-route",
      heading: "Common Italy-to-Netherlands Move Scenarios",
      body: [
      ...
      visaRoutes: {
        commonRoutes: [
          ...
          "Moving as a student — enrolment, housing near campus, student insurance rules, and civil-status documents if the institution or gemeente asks for them. Check whether specific extracts need an apostille per Netherlands Worldwide.",
          ...
          "Cross-border or bi-national within the EU — if your main home stays in Italy or you split time, social security coordination, tax residency, and registration obligations can differ from a single-country move. Verify against official sources.",
    ...
    {
      id: "costs",
      heading: "What to Budget For When Moving from Italy",
      body: [
        "Italy–Netherlands moves combine international transport with Dutch housing deposits, agency fees, and first-month costs. Use the table as categories to research—not fixed amounts.",
        costsDisclaimer ?? "",
      ].filter(Boolean),
      table: {
        headers: ["Category", "How costs usually behave", "Planning notes"],
        rows: [
          ["Transport and removal", "Mode-dependent", "Flights, road, or movers; peak dates and volume change totals."],
          ...
          ["Apostille or copies", "Per document", "Italian apostille or certified copies only where Netherlands Worldwide says they are needed."],
        ],
      },
    ...
    },
    {
      ...
      body: [
        ...
        "The after-arrival guide ties these steps together; the links below jump to the pages Italian movers use most in the first weeks.",
      ],
      bullets: [
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from Italy to the Netherlands",
      body: [
    ...
    {
      id: "cities-italy",
      heading: "Popular Dutch Cities People Moving from Italy Often Consider",
      body: [
        "Many people from Italy weigh international hiring pools in Amsterdam and Rotterdam, centrality in Utrecht, institutions in The Hague, tech and engineering around Eindhoven, or university towns—plus Maastricht and southern Dutch cities for proximity to the rest of the EU, and regional hubs for lifestyle and rent pressure.",
      ],
      links: filterLiveInternalLinks([
        { label: "Amsterdam — broad international opportunity", href: "/netherlands/amsterdam/" },
        { label: "Rotterdam — port city and diverse employers", href: "/netherlands/rotterdam/" },
    ...
    },
    {
      ...
      heading: "Cross-border logistics from Italy",
      body: [
        "Many people fly from Rome, Milan, or other Italian airports; others drive over the Alps or combine long-distance trains. If you move household goods, plan parking, building access, and gemeente rules in dense Dutch cities.",
      ],
      links: [
    ...
    },
    {
      ...
      body: [
        "Relocation and EU stay — Netherlands Worldwide checklist, IND, and Government.nl",
        "Registration and BRP — when to register and how the BSN is issued",
        "Italy-issued documents — Netherlands Worldwide country page and conversion guidance",
        "Apostille background — what an apostille is and Hague Convention context (Netherlands Worldwide)",
      ],
      links: [...OFFICIAL_NL_EU_IT, ...OFFICIAL_IT_DOCS],
    },
  ];
}

export function augmentItalyGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    subtitle:
      "Discover the registration rules, document requirements, housing considerations, and practical settlement steps for people moving from Italy to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "Italy to Netherlands Move at a Glance",
    quickAnswers: [
      {
      ...
      },
      {
        ...
        value: "Many Italian documents usable directly; Italian often needs no translation; some documents need apostille—verify each case",
      },
      {
        label: "Good fit for",
    ...
    heroCta: {
      title: "Plan your move from Italy",
      supportingText:
    ...
    sections: italySections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: ITALY_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from Italy",
    servicesSectionTitle: "Useful Services for People Moving from Italy to the Netherlands",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common Italy-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Each scenario stresses different setup steps. Use the checklist with ?from=italy to keep your origin context.",
    exampleScenarios: [
      {
        title: "Italian professional moving for work",
        summary:
      ...
      {
        title: "Italian student moving for study",
        summary:
          "Confirm enrolment and housing; check insurance rules for students. Use Netherlands Worldwide’s Italy page to see whether your civil documents need an apostille.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Partner or family relocating within the EU",
        summary:
      ...
      {
        title: "Cross-border EU mover needing practical registration guidance",
        summary:
          "If your main residence may stay in Italy or you split time, check registration, insurance, and social-security guidance before assuming a full relocation checklist.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Italian family preparing civil-status documents",
        summary:
          "Follow Netherlands Worldwide’s Italy country page: some documents are accepted directly; others need an apostille. Italian originals often need no translation for Dutch authorities—confirm with the requesting body.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Italian freelancer or remote worker moving for lifestyle",
        summary:
      ...
      {
        title: "Choosing a regional Dutch city instead of Amsterdam",
        summary:
          "Cities like Utrecht, Eindhoven, Breda, or Groningen can offer different housing pressure and commute trade-offs. Compare employers, transit, and quality of life using our city guides.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
    ],
