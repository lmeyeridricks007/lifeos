/**
 * Extended editorial + SEO layout for the Nigeria → Netherlands origin-country guide.
 * Non-EU framing: short-stay Schengen vs long-stay MVV/residence permit; Nigeria-specific TLScontact and consular steps.
 */
...
const OFFICIAL_NG_VISA: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — MVV long stay (apply in Nigeria)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-nigeria",
  },
  {
    label: "Netherlands Worldwide — Making an appointment (Nigeria)",
    href: "https://www.netherlandsworldwide.nl/making-appointment/nigeria",
  },
  {
    label: "Netherlands Worldwide — Schengen visa (apply in Nigeria)",
    href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-nigeria",
  },
  {
...
const OFFICIAL_NG_LEGAL: Array<{ label: string; href: string }> = [
  {
    label: "Netherlands Worldwide — Legalisation: documents from Nigeria",
    href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/nigeria",
  },
  {
...
const NIGERIA_RELATED_INTERNAL = filterLiveInternalLinks([
...
function nigeriaSections(fromQuery: string, costEstimatorHref: string, costsDisclaimer?: string): GuideSection[] {
  return [
    {
      id: "intro-overview",
      heading: "What People Moving from Nigeria Need to Know Before Moving to the Netherlands",
      body: [
    ...
    {
      id: "visa-route",
      heading: "Main Ways to Move from Nigeria to the Netherlands",
      body: [
      ...
      visaRoutes: {
        commonRoutes: [
          ...
          "Highly skilled migrant — employer must be a recognized IND sponsor; salary and role requirements apply.",
    ...
    },
    {
      ...
      heading: "Visa, MVV and Residence Permit Basics for Moving from Nigeria",
      body: [
      ...
      callout: {
        ...
        href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-nigeria",
        linkLabel: "Schengen visa from Nigeria (Netherlands Worldwide)",
      },
      links: [
        ...
        {
          label: "MVV long stay — apply in Nigeria",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/mvv-long-stay/apply-nigeria",
        },
        { label: "IND — MVV exemptions", href: "https://ind.nl/en/mvv-exemptions" },
      ],
    },
    {
      ...
      links: [
        {
          label: "Schengen visa — apply in Nigeria",
          href: "https://www.netherlandsworldwide.nl/visa-the-netherlands/schengen-visa/apply-nigeria",
        },
        {
    ...
    {
      id: "documents",
      heading: "Documents People Moving from Nigeria Often Need Before Moving",
      body: [
      ...
      links: [
        ...
        { label: "Documents needed to move", href: DOCUMENTS_GUIDE_PATH },
        {
          label: "Legalisation — documents from Nigeria",
          href: "https://www.netherlandsworldwide.nl/legalisation/foreign-documents/nigeria",
        },
      ],
    },
    {
      id: "costs",
      heading: "What to Budget For When Moving from Nigeria",
      body: [
      ...
      table: {
        ...
        rows: [
          ...
          [
            ...
            "Nigerian Ministry of Foreign Affairs legalisation; factor courier and repeat visits if needed.",
          ],
    ...
    {
      id: "service-hubs",
      heading: "Useful Services for People Moving from Nigeria to the Netherlands",
      body: [
    ...
    {
      id: "cities-nigeria",
      heading: "Popular Dutch Cities People Moving from Nigeria Often Consider",
      body: [
...
export function augmentNigeriaGuideData(model: CountryPageModel, base: GuideData): GuideData {
  ...
  return {
    ...
    subtitle:
      "Discover the main visa routes, MVV requirements, document legalisation rules, and practical settlement steps for moving from Nigeria to the Netherlands.",
    description: model.seo.description,
    quickAnswersTitle: "Nigeria to Netherlands Move at a Glance",
    quickAnswers: [
      {
      ...
      },
      {
        ...
        value: "Residence-permit planning plus legalised Nigerian documents",
      },
      {
        label: "Common document issue",
        value: "Nigerian documents must be legalised by the Nigerian Ministry of Foreign Affairs for Dutch use",
      },
      {
        label: "Good fit for",
      ...
      },
      {
        ...
        value: "Determine permit route, prepare documents, plan registration and first-week setup",
      },
      {
        label: "Trade-off to know",
        value: "Permit and legalisation timing can add complexity—start early",
      },
    ],
    tocItems: [
      ...
      { id: "cities-nigeria", label: "Cities" },
    ...
    heroCta: {
      title: "Plan your move from Nigeria",
      supportingText:
    ...
    sections: nigeriaSections(fromQuery, costEstimatorHref, model.costs.disclaimer),
    internalLinks: {
      ...base.internalLinks,
      related: NIGERIA_RELATED_INTERNAL,
    },
    relatedGuidesSectionTitle: "Related Guides Before Moving from Nigeria",
    servicesSectionTitle: "Useful Services for People Moving from Nigeria to the Netherlands",
    servicesIntro:
    ...
    scenariosSectionTitle: "Common Nigeria-to-Netherlands Relocation Scenarios",
    scenariosSectionIntro:
      "Each scenario highlights different priorities. Use the checklist tool with ?from=nigeria to keep your origin context while you work through tasks.",
    exampleScenarios: [
      {
        title: "Nigerian professional relocating for a Dutch job offer",
        summary:
          "Focus on sponsor timelines, MVV and residence steps if applicable, legalised civil documents, housing near work, and BSN-first banking and insurance. Compare highly skilled migrant sponsors and relocation support if your employer does not run the full process.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Nigerian student starting a degree in the Netherlands",
        summary:
          "Confirm admission and study-permit conditions, housing near campus, proof-of-funds expectations, and insurance rules. Plan Nigerian document legalisation and translations early.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Partner or family relocation from Nigeria",
        summary:
          "Relationship and civil documents are central; timelines depend on the sponsor’s status. Legalisation at the Nigerian Ministry of Foreign Affairs and translations are common—see our document guides.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
      ...
      },
      {
        ...
        summary:
          "Align with employer immigration counsel, MVV timing, housing near the assignment location, and schooling if children relocate.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
        title: "Family preparing legalised Nigerian documents for Dutch authorities",
        summary:
          "Batch legalisation through the Nigerian Ministry of Foreign Affairs, track translations, and keep copies for gemeente, IND, and employer bundles.",
        href: checklistHref,
        ctaLabel: "Open checklist for this path",
      },
      {
